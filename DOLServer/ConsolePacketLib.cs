...
namespace DOLGameServerConsole
{
    ...
    public class ConsolePacketLib : IPacketLib
    {
        ...
        public void SendLoginGranted(GameClient client) { }
        ...
        public void SendQuestSubscribeCommand(GameObject invitingObject, ushort questid, string inviteMessage) { }
        public void SendQuestOfferWindow(GameObject questObject, GamePlayer player, RewardQuest quest) { }
        public void SendQuestRewardWindow(GameObject questObject, GamePlayer player, RewardQuest quest) { }
        public void SendQuestOfferWindow(GameObject questObject, GamePlayer player, DataQuest quest) { }
        public void SendQuestRewardWindow(GameObject questObject, GamePlayer player, DataQuest quest) { }
        public void SendQuestAbortCommand(GameObject questObject, ushort questid, string abortMessage) { }

...
namespace DOLConfig
{
	public partial class DolConfig : Form
	{
		...
		private void loadConfig()
		{
            ...
            this.WorldTimerTextBox.Text = currentConfig.WorldTimerInterval.ToString();
		...
		private void saveConfig()
		{
            ...
            //Auto World timer interval
            if (this.WorldTimerTextBox.Text.Length == 0 || Convert.ToInt32(this.WorldTimerTextBox.Text) == 0)
            {
                addWrongValueErrorHandler(this.WorldTimerTextBox, "The value of \"World Timer Interval\" is not allowed.");
                return;
            }
            currentConfig.WorldTimerInterval = Convert.ToInt32(this.WorldTimerTextBox.Text);
        ...
        private void WorldTimerTextBox_MouseEnter(object sender, EventArgs e)
        {
            this.toolstripStatusLabelValue = "The interval (in minutes) in which the World Timer Event should start automatically.";
        }
        ...
        private void WorldTimerTextBox_TextChanged(object sender, EventArgs e)
        {

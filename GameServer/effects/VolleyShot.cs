...
{
    /// <summary>
    /// The helper effect for volley shot
    /// </summary>
    public class VolleyEffect : StaticEffect, IGameEffect
    {
        /// <summary>
        ...
        /// Name of the effect
        /// </summary>
        public override string Name { get { return LanguageMgr.GetTranslation(((GamePlayer)Owner).Client, "Effects.VolleyEffect.Name"); } }

        /// <summary>
        /// Icon to show on players, can be id
        /// </summary>
        public override ushort Icon { get { return 4044; } }
    }
}
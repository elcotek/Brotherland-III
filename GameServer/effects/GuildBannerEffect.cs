...
namespace DOL.GS.Effects
{
    ...
    public abstract class GuildBannerEffect : TimedEffect
	{
        ...
        #region Properties
        readonly double m_effectiveness;
		/// <summary>
		...
		public override IList<string> DelveInfo(GamePlayer player)
        {
			
			{
                ...
                list.AddRange(base.DelveInfo(player));
	...
	public class BannerOfWardingEffect : GuildBannerEffect
	{
		...
		public override string Name
		{
			get
			{
				return LanguageMgr.GetTranslation(((GamePlayer)Owner).Client.Account.Language, "Effects.BannerOfWardingEffect.Name");
			}
		}

		protected override string Description
		{
			get { return LanguageMgr.GetTranslation(((GamePlayer)Owner).Client.Account.Language, "Effects.BannerOfWardingEffect.Description"); }
		}
	...
	public class BannerOfShieldingEffect : GuildBannerEffect
	{
		...
		public override string Name
		{
			get
			{
				return LanguageMgr.GetTranslation(((GamePlayer)Owner).Client.Account.Language, "Effects.BannerOfShieldingEffect.Name");
			}
		}

		protected override string Description
		{
			get { return LanguageMgr.GetTranslation(((GamePlayer)Owner).Client.Account.Language, "Effects.BannerOfShieldingEffect.Description"); }
		}
	...
	public class BannerOfFreedomEffect : GuildBannerEffect
	{
		...
		public override string Name
		{
			get
			{
				return LanguageMgr.GetTranslation(((GamePlayer)Owner).Client.Account.Language, "Effects.BannerOfFreedomEffect.Name");
			}
		}

		protected override string Description
		{
			get { return LanguageMgr.GetTranslation(((GamePlayer)Owner).Client.Account.Language, "Effects.BannerOfFreedomEffect.Description"); }
		}
	...
	public class BannerOfBesiegingEffect : GuildBannerEffect
	{
		...
		public override string Name
		{
			get
			{
				return LanguageMgr.GetTranslation(((GamePlayer)Owner).Client.Account.Language, "Effects.BannerOfBesiegingEffect.Name");
			}
		}

		protected override string Description
		{
			get { return LanguageMgr.GetTranslation(((GamePlayer)Owner).Client.Account.Language, "Effects.BannerOfBesiegingEffect.Description"); }
		}

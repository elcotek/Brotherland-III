...
namespace DOL.GS.Effects
{
    ...
    public class ProtectEffect : StaticEffect, IGameEffect
	{
		...
		public void Start(GamePlayer protectSource, GamePlayer protectTarget)
		{
			...
			{
				protectSource.Out.SendMessage(LanguageMgr.GetTranslation(protectSource.Client.Account.Language, "Effects.ProtectEffect.YouProtectingYBut", protectTarget.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
				protectTarget.Out.SendMessage(LanguageMgr.GetTranslation(protectTarget.Client.Account.Language, "Effects.ProtectEffect.XProtectingYouBut", protectSource.GetName(0, true)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
			}
			else
			{
				protectSource.Out.SendMessage(LanguageMgr.GetTranslation(protectSource.Client.Account.Language, "Effects.ProtectEffect.YouProtectingY", protectTarget.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
				protectTarget.Out.SendMessage(LanguageMgr.GetTranslation(protectTarget.Client.Account.Language, "Effects.ProtectEffect.XProtectingYou", protectSource.GetName(0, true)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
			}
		}
		...
		public override void Cancel(bool playerCancel)
		{
			...
			m_protectSource.Out.SendMessage(LanguageMgr.GetTranslation(m_protectSource.Client.Account.Language, "Effects.ProtectEffect.YouNoProtectY", m_protectTarget.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
			m_protectTarget.Out.SendMessage(LanguageMgr.GetTranslation(m_protectTarget.Client.Account.Language, "Effects.ProtectEffect.XNoProtectYou", m_protectSource.GetName(0, true)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
		...
		public override string Name
		{
			...
			get
			{
				if (m_protectSource != null && m_protectTarget != null)
					return LanguageMgr.GetTranslation(((GamePlayer)Owner).Client.Account.Language, "Effects.ProtectEffect.ProtectByName", m_protectTarget.GetName(0, false), m_protectSource.GetName(0, false));
				return LanguageMgr.GetTranslation(((GamePlayer)Owner).Client.Account.Language, "Effects.ProtectEffect.Name");
			}
		}
		...
		public override IList<string> DelveInfo(GamePlayer player)
        {
			
			{
                ...
                {
                    LanguageMgr.GetTranslation(player.Client.Account.Language, "Effects.ProtectEffect.InfoEffect"),
                    " ",
                    LanguageMgr.GetTranslation(player.Client.Account.Language, "Effects.ProtectEffect.XProtectingY", ProtectSource.GetName(0, true), ProtectTarget.GetName(0, false))
                };

...
namespace DOL.GS.Effects
{
    ...
    public class SureShotEffect : StaticEffect, IGameEffect
	{
		...
		public void Start(GamePlayer player)
		{
			...
			m_player.Out.SendMessage(LanguageMgr.GetTranslation(m_player.Client.Account.Language, "Effects.SureShotEffect.YouSwitchToSSMode"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
		}
		...
		/// Name of the effect
		/// </summary>
		public override string Name { get { return LanguageMgr.GetTranslation(m_player.Client.Account.Language, "Effects.SureShotEffect.Name"); } }
		...
		/// </summary>
        public override ushort Icon { get { return 4029; } }

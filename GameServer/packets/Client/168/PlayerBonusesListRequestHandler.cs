...
namespace DOL.GS.PacketHandler.Client.v168
{
    ...
    public class PlayerBonusesListRequestHandler : IPacketHandler
    {
        ...
        public void HandlePacket(GameClient client, GSPacketIn packet)
        {
            ...
            new RegionTimerAction<GamePlayer>(client.Player, p => p.Out.SendCustomTextWindow(LanguageMgr.GetTranslation(client.Account.Language, "PlayerBonusesListRequestHandler.HandlePacket.Bonuses"), new List<string>(client.Player.GetBonuses()))).Start(1);

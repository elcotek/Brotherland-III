...
namespace DOL.GS.PacketHandler.Client.v168
{
    ...
    /// </summary>
    [PacketHandler(PacketHandlerType.TCP, eClientPackets.PlayerTarget, eClientStatus.PlayerInGame)]
        ...
        protected class ChangeTargetAction : RegionAction
        {
            ...
            protected override void OnTick()
            {
                ...
                if (myTarget != null)
                {
                    ...
                    if ((player.IsCasting && player.IsCharcterClass(eCharacterClass.Minstrel) == false) && !m_targetInView)
                    {

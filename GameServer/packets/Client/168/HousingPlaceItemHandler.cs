    ...
    public class HousingPlaceItemHandler : IPacketHandler
    {
        ...
        public void HandlePacket(GameClient client, GSPacketIn packet)
        {
            try
            {
                    ...
                    orgitem.Id_nb.Contains("villa_deed") || orgitem.Id_nb.Contains("mansion_deed"))
                {
                    ...
                    ChatUtil.SendSystemMessage(client, "You cannot upgrade before remove the old House. You must first use the [house removal deed] Scroll from House Market!");
                    //client.Player.TempProperties.setProperty(DeedWeak, new WeakRef(orgitem));
                    //client.Player.TempProperties.setProperty(TargetHouse, house);
                ...
                if (house.CanChangeInterior(client.Player, DecorationPermissions.Remove))
                {
                    if (orgitem.Name == "interior banner removal")
                    {
                        ...
                        (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.InteriorBannersRemoved"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                        return;
                    }
                    ...
                    if (orgitem.Name == "interior shield removal")
                    {
                        ...
                        (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.InteriorShieldsRemoved"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                        return;
                    }
                    ...
                    if (orgitem.Name == "carpet removal")
                    {
                        ...
                        (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.CarpetsRemoved"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                        return;
                    }
                }
                ...
                if (house.CanChangeExternalAppearance(client.Player))
                {
                    if (orgitem.Name == "exterior banner removal")
                    {
                        ...
                        (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.OutdoorBannersRemoved"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                        return;
                    }
                    ...
                    if (orgitem.Name == "exterior shield removal")
                    {
                        ...
                        (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.OutdoorShieldsRemoved"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                        return;
                    }
                }
                ...
                else if (objType >= 59 && objType <= 64) // Outdoor Roof/Wall/Door/Porch/Wood/Shutter/awning Material item type
                {
                    ...
                    (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.HouseUseMaterials"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    return;
                }
                else if (objType == 56 || objType == 52 || (objType >= 69 && objType <= 71)) // Indoor carpets 1-4
                {
                    ...
                    (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.HouseUseCarpets"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    return;
                }
                    ...
                    case 1: // GARDEN OBJECT
                        {
                            ...
                            if (house.OutdoorItems.Count >= Properties.MAX_OUTDOOR_HOUSE_ITEMS)
                            {
                                ...
                                (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.GardenMaxObjects"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                client.Out.SendInventorySlotsUpdate(new[] { slot });
                            ...
                            (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.GardenItemPlaced", Properties.MAX_OUTDOOR_HOUSE_ITEMS - house.OutdoorItems.Count), eChatType.CT_System, eChatLoc.CL_SystemWindow);

                            (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.GardenItemPlacedName", orgitem.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    ...
                    case 3: // FLOOR OBJECT
                        {
                            ...
                            {
                                (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.NotWallObject"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            ...
                            {
                                (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.NotFloorObject"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            ...
                            {
                                (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.IndoorMaxItems"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            ...
                            var iitem = new IndoorItem
                            {
                                ...
                                X = xpos,
                                Y = ypos,
                                Size = 80, //orgitem.DPS_AF > 3 ? orgitem.DPS_AF : 100, // max size is 255 //elcotek nun feste size = 80
                                Position = _position,
                            ...
                            if (objType == 50 || objType == 51)
                            {
                                ...
                                if (orgitem.Id_nb.Contains("GuildBanner"))
                                {
                                    ...
                                    iitem.Size = 80; // Banners have to be reduced in size //elcotek von 50 auf 80 erhöht
                                }
                                else
                                {
                            ...
                            (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.IndoorItemPlaced", (GetMaxIndoorItemsForHouse(house.Model) - house.IndoorItems.Count)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            switch (method)
                            {
                                case 2:
                                    //ChatUtil.SendSystemMessage(client, "Scripts.Player.Housing.IndoorWallPlaced", orgitem.Name);
                                    (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.IndoorWallPlaced", orgitem.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                    break;
                                case 3:
                                    //ChatUtil.SendSystemMessage(client, "Scripts.Player.Housing.IndoorFloorPlaced", orgitem.Name);
                                    (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.IndoorFloorPlaced", orgitem.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                    break;
                            }
                    ...
                    case 4: // PORCH
                        {
                            ...
                            switch (orgitem.Id_nb)
                            {
                                case "10_gold_rent_token":
                                    ...
                                    InventoryItem orgitem2 = client.Player.Inventory.GetItem((eInventorySlot)slot);

                                    long moneyToAdd2 = 1000;

                                    moneyToAdd2 *= 100;//10g

                                    //InventoryLogging.LogInventoryAction(client.Player, "(HOUSE;" + housenumber + ")", eInventoryActionType.Other, orgitem2.Template, orgitem2.Count);

                                    client.Player.TempProperties.setProperty(HousingConstants.MoneyForHouseRent, moneyToAdd2);
                                    client.Player.TempProperties.setProperty(HousingConstants.HouseForHouseRent, house);
                                    client.Player.Out.SendInventorySlotsUpdate(null);
                                    client.Player.Out.SendHousePayRentDialog("Housing07");
                                    if (client.Player.RemoveMoney(moneyToAdd2))
                                        // add the payed money back to Player
                                        client.Player.AddMoney(moneyToAdd2);
                                    client.Player.Inventory.RemoveItem(orgitem2);
                                    client.Player.AddMoney(moneyToAdd2);
                                    long BackGold10 = moneyToAdd2 / 10000;
                                    client.Player.Out.SendMessage(client.Player.Name + " has become " + BackGold10 + " gold back for the token!",
                                ...
                                case "20_gold_rent_token":
                                    ...
                                    InventoryItem orgitem3 = client.Player.Inventory.GetItem((eInventorySlot)slot);

                                    long moneyToAdd3 = 2000;

                                    moneyToAdd3 *= 100;//20g

                                    //InventoryLogging.LogInventoryAction(client.Player, "(HOUSE;" + housenumber + ")", eInventoryActionType.Other, orgitem3.Template, orgitem3.Count);

                                    client.Player.TempProperties.setProperty(HousingConstants.MoneyForHouseRent, moneyToAdd3);
                                    client.Player.TempProperties.setProperty(HousingConstants.HouseForHouseRent, house);
                                    client.Player.Out.SendInventorySlotsUpdate(null);
                                    client.Player.Out.SendHousePayRentDialog("Housing07");
                                    if (client.Player.RemoveMoney(moneyToAdd3))
                                    {
                                        // add the payed money back to Player
                                        client.Player.AddMoney(moneyToAdd3);
                                    }

                                    client.Player.Inventory.RemoveItem(orgitem3);
                                    client.Player.AddMoney(moneyToAdd3);
                                    long BackGold20 = moneyToAdd3 / 10000;
                                    client.Player.Out.SendMessage(client.Player.Name + " has become " + BackGold20 + " gold back for the token!",
                                       eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    client.Player.Out.SendUpdatePlayer();
                                    client.Player.SaveIntoDatabase();
                                    return;
                                ...
                                case "50_gold_rent_token":
                                    ...
                                    InventoryItem orgitem4 = client.Player.Inventory.GetItem((eInventorySlot)slot);

                                    long moneyToAdd4 = 5000;

                                    moneyToAdd4 *= 100;//50g

                                    //InventoryLogging.LogInventoryAction(client.Player, "(HOUSE;" + housenumber + ")", eInventoryActionType.Other, orgitem4.Template, orgitem4.Count);

                                    client.Player.TempProperties.setProperty(HousingConstants.MoneyForHouseRent, moneyToAdd4);
                                    client.Player.TempProperties.setProperty(HousingConstants.HouseForHouseRent, house);
                                    client.Player.Out.SendInventorySlotsUpdate(null);
                                    client.Player.Out.SendHousePayRentDialog("Housing07");
                                    if (client.Player.RemoveMoney(moneyToAdd4))
                                    {
                                        // add the payed money back to Player
                                        client.Player.AddMoney(moneyToAdd4);
                                    }

                                    client.Player.Inventory.RemoveItem(orgitem4);
                                    client.Player.AddMoney(moneyToAdd4);
                                    long BackGold50 = moneyToAdd4 / 10000;
                                    client.Player.Out.SendMessage(client.Player.Name + " has become " + BackGold50 + " gold back for the token!",
                                       eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    client.Player.Out.SendUpdatePlayer();
                                    client.Player.SaveIntoDatabase();
                                    return;

                                case "100_gold_rent_token":
                                    if (!house.CanPayRent(client.Player))
                                    {
                                        client.Out.SendMessage(LanguageMgr.GetTranslation(client, "Scripts.Players.Bountyrent.NoPayRentPerm"),
                                            eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                    ...
                                    InventoryItem orgitem5 = client.Player.Inventory.GetItem((eInventorySlot)slot);
                                    long moneyToAdd5 = 10000;

                                    moneyToAdd5 *= 100;//100g

                                    //InventoryLogging.LogInventoryAction(client.Player, "(HOUSE;" + housenumber + ")", eInventoryActionType.Other, orgitem5.Template, orgitem5.Count);

                                    client.Player.TempProperties.setProperty(HousingConstants.MoneyForHouseRent, moneyToAdd5);
                                    client.Player.TempProperties.setProperty(HousingConstants.HouseForHouseRent, house);
                                    client.Player.Out.SendInventorySlotsUpdate(null);
                                    client.Player.Out.SendHousePayRentDialog("Housing07");
                                    if (client.Player.RemoveMoney(moneyToAdd5))
                                    {
                                        // add the payed money back to Player
                                        client.Player.AddMoney(moneyToAdd5);
                                    }

                                    client.Player.Inventory.RemoveItem(orgitem5);
                                    client.Player.AddMoney(moneyToAdd5);
                                    long BackGold100 = moneyToAdd5 / 10000;
                                    client.Player.Out.SendMessage(client.Player.Name + " has become " + BackGold100 + " gold back for the token!",
                                       eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    client.Player.Out.SendUpdatePlayer();
                                    client.Player.SaveIntoDatabase();
                                    return;
                                ...
                                case "housing_porch_deed":
                                    ...
                                    else
                                    {
                                        ...
                                        (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.PorchAlready"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                        client.Out.SendInventorySlotsUpdate(new[] { slot });
                                    }
                                    return;
                                case "housing_porch_remove_deed":
                                    ...
                                    else
                                    {
                                        ...
                                        (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.PorchNone"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                        client.Out.SendInventorySlotsUpdate(new[] { slot });
                                    }
                                    return;
                                ...
                                default:
                                    ...
                                    (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.PorchNotItem"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                    client.Out.SendInventorySlotsUpdate(new[] { slot });
                                    return;
                            }
                        }
                    case 5: // HOOKPOINT
                        {
                            ...
                            if (house.GetHookpointLocation((uint)_position) == null)
                            {
                                ...
                                if (client.Account.PrivLevel == (int)ePrivLevel.Admin)
                                {
                                    if (client.Player.TempProperties.getProperty<bool>(HousingConstants.AllowAddHouseHookpoint, false))
                                    {
                                        ...
                                        (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.HookPointID", +_position), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                        //ChatUtil.SendSystemMessage(client, "Scripts.Player.Housing.HookPointCloser", null);
                                        (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.HookPointCloser"), eChatType.CT_System, eChatLoc.CL_SystemWindow);

                                        client.Player.Out.SendCustomDialog(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.HookPointLogLoc"), LogLocation);
                                        // (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.HookPointLogLoc", LogLocation), eChatType.CT_Say, eChatLoc.CL_SystemWindow);
                                    }
                                    else
                                    {
                            ...
                            else if (house.GetHookpointLocation((uint)_position) != null)
                            {
                                ...
                                foreach (var hpitem in GameServer.Database.SelectObjects<DBHouseHookpointItem>("`HouseNumber` = @HouseNumber", new QueryParameter("@HouseNumber", house.HouseNumber)))
                                {
                                    if (hpitem.HookpointID == point.HookpointID)
                                    {
                                        ...
                                        (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.HookPointAlready"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                        client.Out.SendInventorySlotsUpdate(new[] { slot });
                                        return;
                                    }
                                }
                                ...
                                (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.HookPointAdded"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                // save the house
                                house.SaveIntoDatabase();
                            }
                            else
                            {
                                ...
                                (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.HookPointNot"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                client.Out.SendInventorySlotsUpdate(new[] { slot });
                            }
                    ...
                    case 6:
                        {
                            ...
                            if (objType == 57) // We have outdoor banner
                            {
                                ...
                                (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.OutdoorBannersAdded"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                client.Player.Inventory.RemoveItem(orgitem);
                                //InventoryLogging.LogInventoryAction(client.Player, "(HOUSE;" + housenumber + ")", eInventoryActionType.Other, orgitem.Template, orgitem.Count);
                            }
                            else if (objType == 58) // We have outdoor shield
                            {
                                ...
                                (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.OutdoorShieldsAdded"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                client.Player.Inventory.RemoveItem(orgitem);
                                //InventoryLogging.LogInventoryAction(client.Player, "(HOUSE;" + housenumber + ")", eInventoryActionType.Other, orgitem.Template, orgitem.Count);
                            }
                            else if (objType == 66) // We have indoor banner
                            {
                                ...
                                (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.InteriorBannersAdded"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                client.Player.Inventory.RemoveItem(orgitem);
                                //InventoryLogging.LogInventoryAction(client.Player, "(HOUSE;" + housenumber + ")", eInventoryActionType.Other, orgitem.Template, orgitem.Count);
                            }
                            else if (objType == 67) // We have indoor shield
                            {
                                ...
                                (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.InteriorShieldsAdded"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                client.Player.Inventory.RemoveItem(orgitem);
                                //InventoryLogging.LogInventoryAction(client.Player, "(HOUSE;" + housenumber + ")", eInventoryActionType.Other, orgitem.Template, orgitem.Count);
                            }
                            else
                            {
                                ...
                                (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.BadShieldBanner"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                client.Out.SendInventorySlotsUpdate(new[] { slot });
                            }
                    ...
                    case 7: // House vault.
                        {
                            ...
                            if (house.GetHookpointLocation((uint)_position) == null)
                            {
                                ...
                                if (client.Account.PrivLevel == (int)ePrivLevel.Admin)
                                {
                                    if (client.Player.TempProperties.getProperty<bool>(HousingConstants.AllowAddHouseHookpoint, false))
                                    {
                                        (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.HookPointID"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                        //ChatUtil.SendSystemMessage(client, "Scripts.Player.Housing.HookPointID", +_position);
                                        (client.Player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((client.Player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.HookPointCloser"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                        // ChatUtil.SendSystemMessage(client, "Scripts.Player.Housing.HookPointCloser", null);
        ...
        private void LogLocation(GamePlayer player, byte response)
        {
            ...
            if (GameServer.Database.AddObject(a) && House.AddNewOffset(a))
            {
                ...
                (player as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((player as GamePlayer).Client.Account.Language, "Scripts.Player.Housing.HookPointLogged"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
        ...
        private static void HouseRemovalDialog(GamePlayer player, byte response)
        {
            ...
            switch (house.Model)
            {
                ...
                case 1: // "housing_alb_cottage_deed":
                    OLDHouseIDNB = "housing_alb_cottage_deed";
                    break;
                case 2: // "housing_alb_house_deed":
                    OLDHouseIDNB = "housing_alb_house_deed";
                    break;
                case 3: // "housing_alb_villa_deed":
                    OLDHouseIDNB = "housing_alb_villa_deed";
                    break;
                case 4: // "housing_alb_mansion_deed":
                    OLDHouseIDNB = "housing_alb_mansion_deed";
                    break;
                case 5: // "housing_mid_cottage_deed":
                    OLDHouseIDNB = "housing_mid_cottage_deed";
                    break;
                case 6: // "housing_mid_house_deed":
                    OLDHouseIDNB = "housing_mid_house_deed";
                    break;
                case 7: // "housing_mid_villa_deed":
                    OLDHouseIDNB = "housing_mid_villa_deed";
                    break;
                case 8: // "housing_mid_mansion_deed":
                    OLDHouseIDNB = "housing_mid_mansion_deed";
                    break;
                case 9:// "housing_hib_cottage_deed":
                    OLDHouseIDNB = "housing_hib_cottage_deed";
                    break;
                case 10: // "housing_hib_house_deed":
                    OLDHouseIDNB = "housing_hib_house_deed";
                    break;
                case 11: // "housing_hib_villa_deed":
                    OLDHouseIDNB = "housing_hib_villa_deed";
                    break;
                case 12: // "housing_hib_mansion_deed":
                    OLDHouseIDNB = "housing_hib_mansion_deed";
                    break;
            ...
            if (!string.IsNullOrEmpty(OLDHouseIDNB))
            {
                HouseTempl = GameServer.Database.FindObjectByKey<ItemTemplate>(OLDHouseIDNB);
            }
            ...
            //Recive Money back for the removed Items
            if (HouseTempl != null && HouseTempl.Price > 0)
            {
                if (house.Consignment)
                {
                    //Platin for the Consignment Merchant
                    long consgnPlatin = 1 * 100 * 100 * 1000;
                    player.AddMoney(consgnPlatin);

                    ChatUtil.SendSystemMessage(player, "You recive back " + 1 + " Platin from the removed Consignment Merchant!");
                }

                if (house.Porch)
                {
                    //Gold for the Porch
                    long porchGold = 500 * 100 * 100;
                    player.AddMoney(porchGold);

                    ChatUtil.SendSystemMessage(player, "You recive back " + 500 + " Gold from the porch!");
                }

                //Platin for the House
                player.AddMoney(HouseTempl.Price);
                ChatUtil.SendSystemMessage(player, "You recive back " + HouseTempl.Price / 10000 / 1000 + " Platin form the removed House!");

                //Gold for the Lot
                long lotGold = 300 * 100 * 100;
                player.AddMoney(lotGold);
                ChatUtil.SendSystemMessage(player, "You recive back " + 300 + " Gold from the Lot!");

...
namespace DOL.GS.PacketHandler
{
	...
	public class PacketLib194 : PacketLib193
	{
		...
		public override void SendQuestOfferWindow(GameObject questObject, GamePlayer player, DataQuest quest)
		{
			SendQuestWindow(questObject, player, quest, true);
		}

		public override void SendQuestRewardWindow(GameObject questObject, GamePlayer player, DataQuest quest)
		{
        ...
        protected override void SendQuestWindow(GameObject questObject, GamePlayer player, DataQuest quest, bool offer)
        {
        ...
        protected override void SendQuestWindow(GameObject questObject, GamePlayer player, RewardQuest quest, bool offer)
        {
            using (GSTCPPacketOut pak = new GSTCPPacketOut(GetPacketCode(eServerPackets.Dialog)))
            {

...
namespace DOL.GS.PacketHandler
{
    ...
    public enum eClientPackets : byte
    {
        ...
        PlayerPickupHouseItem = 0x0D,          ///neu
        //PlayerMoveItem = 0x75 ^ 168,
        PlayerMoveItem = 0xDD,				// 0x75 ^ 168 //neu
    ...
    public interface IPacketLib
    {
        ...
        void SendLoginGranted(GameClient client);
        ...
        void SendQuestOfferWindow(GameObject questObject, GamePlayer player, RewardQuest quest);
        void SendQuestRewardWindow(GameObject questObject, GamePlayer player, RewardQuest quest);
        void SendQuestOfferWindow(GameObject questObject, GamePlayer player, DataQuest quest);
        void SendQuestRewardWindow(GameObject questObject, GamePlayer player, DataQuest quest);
        void SendQuestSubscribeCommand(GameObject questObject, ushort questid, string inviteMessage);
        void SendQuestAbortCommand(GameObject questObject, ushort questid, string abortMessage);
        ...
        void SendKeepComponentRemove(GameKeepComponent keepComponent);

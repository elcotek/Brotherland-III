...
namespace DOL.GS.PacketHandler
{
    ...
    public class PacketLib187 : PacketLib186
    {
        ...
        public override void SendQuestOfferWindow(GameObject questObject, GamePlayer player, RewardQuest quest)
        {
            SendQuestWindow(questObject, player, quest, true);
        }

        public override void SendQuestRewardWindow(GameObject questObjectC, GamePlayer player, RewardQuest quest)
        {
            SendQuestWindow(questObjectC, player, quest, false);
        }

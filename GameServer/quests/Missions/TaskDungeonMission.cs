...
namespace DOL.GS.Quests
{
    public class TaskDungeonMission : AbstractMission
    {
        ...
        private readonly eDungeonType m_dungeonType = eDungeonType.Melee;
        public eDungeonType DungeonType
        {
            get { return m_dungeonType; }
        }

        private readonly eTDMissionType m_missionType;
        public eTDMissionType TDMissionType
        {
            get { return m_missionType; }
        }

        private readonly TaskDungeonInstance m_taskRegion;
        ...
        private readonly long m_total = 0;
        public long Total
        {
            get { return m_total; }
        }

        private readonly string m_bossName = String.Empty;
        public string BossName
        {
            get { return m_bossName; }
        }

        private readonly string m_targetName = String.Empty;
        public string TargetName
        {
            get { return m_targetName; }
        }

        private readonly bool[] m_mobIsAlive;
            ...
            : base(owner)
        {
            ...
            //random region id (rid) wird im moment nicht benutzt
            TaskDungeonInstance instance = (TaskDungeonInstance)WorldMgr.CreateInstance(rid, typeof(TaskDungeonInstance));//benutze region 48
            ...
            //log.ErrorFormat("keyname = {0} ", keyname);
        ...
        //Burial Tomb
        private static readonly ushort[] burial_tomb_long = new ushort[] { 295, 400, 402, 404 };
        private static readonly ushort[] burial_tomb_laby = new ushort[] { 293, 294, 401, 403 };
        //Forgotten Mines
        private static readonly ushort[] forgotten_mines_long = new ushort[] { 256, 257, 258, };
        private static readonly ushort[] forgotten_mines_laby = new ushort[] { 410, 411, 412, 413, 414 };
        //Desecrated Ground
        private static readonly ushort[] desecrated_grounds_long = new ushort[] { 297, 298, 409 };
        private static readonly ushort[] desecrated_grounds_laby = new ushort[] { 296, 405, 406, 407, 408 };
        //Funerary Hall
        private static readonly ushort[] funerary_hall_long = new ushort[] { 379, 382, 383, 419 };
        private static readonly ushort[] funerary_hall_laby = new ushort[] { 415, 416, 417, 418 };
        //Sundered Tombs
        private static readonly ushort[] sundered_tombs_long = new ushort[] { 386, 387, 388, };
        private static readonly ushort[] sundered_tombs_laby = new ushort[] { 420, 421, 422, 423, 424 };
        #endregion
        #region Midgard Task Instances
        //Damp Cavern
        private static readonly ushort[] damp_cavern_long = new ushort[] { 278, 279, 280, 301 };
        private static readonly ushort[] damp_cavern_laby = new ushort[] { 300, 302, 303, 304 };
        //Forgotten Sepulchre
        private static readonly ushort[] forgotten_sepulchre_long = new ushort[] { 281, 282, 283, 307 };
        private static readonly ushort[] forgotten_sepulchre_laby = new ushort[] { 305, 306, 308, 309 };
        //The Concealed Guardhouse
        private static readonly ushort[] the_concealed_guardhouse_long = new ushort[] { 284, 285, 286 };
        private static readonly ushort[] the_concealed_guardhouse_laby = new ushort[] { 310, 311, 312, 313, 314 };
        //The Gossamer Grotto
        private static readonly ushort[] the_gossamer_grotto_long = new ushort[] { 287, 288, 289 };
        private static readonly ushort[] the_gossamer_grotto_laby = new ushort[] { 315, 316, 317, 318, 319 };
        //Underground Tunnel
        private static readonly ushort[] underground_tunnel_long = new ushort[] { 290, 291, 292 };
        private static readonly ushort[] underground_tunnel_laby = new ushort[] { 320, 321, 322, 323, 324 };
        #endregion
        #region Hibernia Task Instances
        //The Cursed Barrow
        /*
        private static readonly ushort[] the_cursed_barrow_long = new ushort[] { 427, 428, 431, 454 };
        private static readonly ushort[] the_cursed_barrow_laby = new ushort[] { 450, 451, 452, 453 };
        //Dismal Grotto
        private static readonly ushort[] dismal_grotto_long = new ushort[] { 432, 441, 444, 459 };
        private static readonly ushort[] dismal_grotto_laby = new ushort[] { 455, 456, 457, 458 };
        //The Accursed Caves
        private static readonly ushort[] the_accursed_caves_long = new ushort[] { 464, 477, 478, 481 };
        private static readonly ushort[] the_accursed_caves_laby = new ushort[] { 460, 461, 462, 463 };
        //Dark Cavern
        private static readonly ushort[] dark_cavern_long = new ushort[] { 445, 448, 449 };
        private static readonly ushort[] dark_cavern_laby = new ushort[] { 465, 466, 467, 468, 469 };
         */
        //Unused Mine
        private static readonly ushort[] unused_mine_long = new ushort[] { 474, 482, 485, 486 };
       
        private static readonly ushort[] unused_mine_laby = new ushort[] { 048, 471, 472, 473 };
        #endregion

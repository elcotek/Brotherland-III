...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerMaulerHibQuest : BaseQuest
	{
		/// <summary>
		...
		* Constructor
		*/
		public DragonslayerMaulerHibQuest() : base()
		{
		}

		public DragonslayerMaulerHibQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerMaulerHibQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

        public DragonslayerMaulerHibQuest(GamePlayer questingPlayer, DBQuest dbQuest)
            : base(questingPlayer, dbQuest)
	{
		...
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerMaulerHibQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerMaulerHibQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == Lirazal.Name && gArgs.Item.Id_nb == Asiintath_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerMaulerHibQuest), null);
						...
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerMaulerHibQuest), null);
	...
	GameNPC[] npcs;
		...
		Asiintath_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Asiintath_Head");
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerMaulerHibQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerMaulerHibQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerMaulerHibQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerMaulerHibQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerMaulerHibQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerMaulerHibQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", Lirazal);
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerMaulerHibQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Asiintath I shall pay you well!", Lirazal);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerMaulerHibQuest), Lirazal);
            AddBehaviour(a);
			...
			if (Lirazal!=null) {
                Lirazal.AddQuestToGive(typeof(DragonslayerMaulerHibQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
            ...
            Lirazal.RemoveQuestToGive(typeof(DragonslayerMaulerHibQuest));
		}
		...
		*/
		...
		{		
            ...
            if (player.IsDoingQuest(typeof(DragonslayerMaulerHibQuest)) != null)
				return true;

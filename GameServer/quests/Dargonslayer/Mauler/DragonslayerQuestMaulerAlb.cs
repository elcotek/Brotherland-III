...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerMaulerAlbQuest : BaseQuest
	{
		/// <summary>
		...
		* Constructor
		*/
		public DragonslayerMaulerAlbQuest() : base()
		{
		}

		public DragonslayerMaulerAlbQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerMaulerAlbQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerMaulerAlbQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerMaulerAlbQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerMaulerAlbQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == Elia.Name && gArgs.Item.Id_nb == Runicaath_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerMaulerAlbQuest), null);
						...
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerMaulerAlbQuest), null);
	...
	GameNPC[] npcs;
		...
		Runicaath_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Runicaath_Head");
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerMaulerAlbQuest), Elia);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerMaulerAlbQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerMaulerAlbQuest), Elia);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerMaulerAlbQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerMaulerAlbQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(Elia, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerMaulerAlbQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", Elia);
            AddBehaviour(a);

            a = builder.CreateBehaviour(Elia, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerMaulerAlbQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Runicaath I shall pay you well!", Elia);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerMaulerAlbQuest), Elia);
            AddBehaviour(a);
			...
			if (Elia!=null) {
                Elia.AddQuestToGive(typeof(DragonslayerMaulerAlbQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
            ...
            Elia.RemoveQuestToGive(typeof(DragonslayerMaulerAlbQuest));
		}
		...
		*/
		...
		{		
            ...
            if (player.IsDoingQuest(typeof(DragonslayerMaulerAlbQuest)) != null)
				return true;

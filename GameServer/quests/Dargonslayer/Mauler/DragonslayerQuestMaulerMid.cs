...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerMaulerMidQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerMaulerQuest";
		...
		* Constructor
		*/
		public DragonslayerMaulerMidQuest() : base()
		{
		}

		public DragonslayerMaulerMidQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerMaulerMidQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

        public DragonslayerMaulerMidQuest(GamePlayer questingPlayer, DBQuest dbQuest)
            : base(questingPlayer, dbQuest)
	{
		...
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerMaulerMidQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerMaulerMidQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == AmarasavaDas.Name && gArgs.Item.Id_nb == Jarkkonith_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerMaulerMidQuest), null);
						...
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerMaulerMidQuest), null);
	...
	GameNPC[] npcs;
		...
		#region defineQuestParts
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerMaulerMidQuest), AmarasavaDas);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerMaulerMidQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerMaulerMidQuest), AmarasavaDas);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerMaulerMidQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerMaulerMidQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(AmarasavaDas, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerMaulerMidQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", AmarasavaDas);
            AddBehaviour(a);

            a = builder.CreateBehaviour(AmarasavaDas, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerMaulerMidQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Jarkkonith I shall pay you well!", AmarasavaDas);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerMaulerMidQuest), AmarasavaDas);
            AddBehaviour(a);
			...
			if (AmarasavaDas!=null) {
                AmarasavaDas.AddQuestToGive(typeof(DragonslayerMaulerMidQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
            ...
            AmarasavaDas.RemoveQuestToGive(typeof(DragonslayerMaulerMidQuest));
		}
		...
		*/
		...
		{		
            ...
            if (player.IsDoingQuest(typeof(DragonslayerMaulerMidQuest)) != null)
				return true;

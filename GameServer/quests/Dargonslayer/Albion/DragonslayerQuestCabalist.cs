...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerCabalisQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerCabalistQuest";
		...
		* Constructor
		*/
		public DragonslayerCabalisQuest() : base()
		{
		}

		public DragonslayerCabalisQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerCabalisQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerCabalisQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerCabalisQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerCabalisQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == Elia.Name && gArgs.Item.Id_nb == Runicaath_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerCabalisQuest), null);
						...
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerCabalisQuest), null);
	...
	GameNPC[] npcs;
		...
		Runicaath_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Runicaath_Head");
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerCabalisQuest), Elia);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerCabalisQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerCabalisQuest), Elia);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerCabalisQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerCabalisQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(Elia, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerCabalisQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", Elia);
            AddBehaviour(a);

            a = builder.CreateBehaviour(Elia, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerCabalisQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Runicaath I shall pay you well!", Elia);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerCabalisQuest), Elia);
            AddBehaviour(a);
			...
			if (Elia!=null) {
				Elia.AddQuestToGive(typeof (DragonslayerCabalisQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			Elia.RemoveQuestToGive(typeof (DragonslayerCabalisQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerCabalisQuest)) != null)
				return true;

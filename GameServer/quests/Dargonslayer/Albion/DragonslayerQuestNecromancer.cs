...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerNecromancerQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerNecromancerQuest";
		...
		private static ItemTemplate Dragonslayer_Cloth_Gloves = null;
		
		private static ItemTemplate Dragonslayer_Cloth_Sleeves = null;
		
		private static ItemTemplate Dragonslayer_Cloth_Breeches = null;
		
		private static ItemTemplate Dragonslayer_Cloth_Robes = null;
		...
		* Constructor
		*/
		public DragonslayerNecromancerQuest() : base()
		{
		}

		public DragonslayerNecromancerQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerNecromancerQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerNecromancerQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerNecromancerQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerNecromancerQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == Elia.Name && gArgs.Item.Id_nb == Runicaath_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerNecromancerQuest), null);
						...
						a.AddAction(eActionType.GiveItem, Dragonslayer_Cloth_Gloves, Elia);
						a.AddAction(eActionType.GiveItem, Dragonslayer_Cloth_Sleeves, Elia);
						a.AddAction(eActionType.GiveItem, Dragonslayer_Cloth_Breeches, Elia);
						a.AddAction(eActionType.GiveItem, Dragonslayer_Cloth_Robes, Elia);
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerNecromancerQuest), null);
	...
	GameNPC[] npcs;
		...
		Runicaath_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Runicaath_Head");
			...
			Dragonslayer_Cloth_Gloves = GameServer.Database.FindObjectByKey<ItemTemplate>("Dragonslayer_Cloth_Gloves");
			if (Dragonslayer_Cloth_Gloves == null)
			{
				Dragonslayer_Cloth_Gloves = new ItemTemplate();
				Dragonslayer_Cloth_Gloves.Name = "Dragonslayer Cloth Gloves";
				if (log.IsWarnEnabled)
					log.Warn("Could not find " + Dragonslayer_Cloth_Gloves.Name + ", creating it ...");
				Dragonslayer_Cloth_Gloves.Level = 51;
				Dragonslayer_Cloth_Gloves.Weight = 8;
				Dragonslayer_Cloth_Gloves.Model = 4018;
				Dragonslayer_Cloth_Gloves.Object_Type = 32;
				Dragonslayer_Cloth_Gloves.Item_Type = 22;
				Dragonslayer_Cloth_Gloves.Id_nb = "Dragonslayer_Cloth_Gloves";
				Dragonslayer_Cloth_Gloves.Hand = 0;
				Dragonslayer_Cloth_Gloves.IsPickable = true;
				Dragonslayer_Cloth_Gloves.IsDropable = true;
				Dragonslayer_Cloth_Gloves.IsTradable = true;
				Dragonslayer_Cloth_Gloves.CanDropAsLoot = true;
				Dragonslayer_Cloth_Gloves.Color = 0;
				Dragonslayer_Cloth_Gloves.Bonus = 35; // default bonus				
				Dragonslayer_Cloth_Gloves.Bonus1 = 5;
				Dragonslayer_Cloth_Gloves.Bonus1Type = (int) 12;
				Dragonslayer_Cloth_Gloves.Bonus2 = 5;
				Dragonslayer_Cloth_Gloves.Bonus2Type = (int) 18;
				Dragonslayer_Cloth_Gloves.Bonus3 = 40;
				Dragonslayer_Cloth_Gloves.Bonus3Type = (int) 10;
				Dragonslayer_Cloth_Gloves.Bonus4 = 5;
				Dragonslayer_Cloth_Gloves.Bonus4Type = (int) 15;
				Dragonslayer_Cloth_Gloves.Bonus5 = 3;
				Dragonslayer_Cloth_Gloves.Bonus5Type = (int) 163;
				Dragonslayer_Cloth_Gloves.Bonus6 = 40;
				Dragonslayer_Cloth_Gloves.Bonus6Type = (int) 210;
				Dragonslayer_Cloth_Gloves.Bonus7 = 6;
				Dragonslayer_Cloth_Gloves.Bonus7Type = (int) 196;
				Dragonslayer_Cloth_Gloves.Bonus8 = 0;
				Dragonslayer_Cloth_Gloves.Bonus8Type = (int) 0;
				Dragonslayer_Cloth_Gloves.Bonus9 = 0;
				Dragonslayer_Cloth_Gloves.Bonus9Type = (int) 0;
				Dragonslayer_Cloth_Gloves.Bonus10 = 0;
				Dragonslayer_Cloth_Gloves.Bonus10Type = (int) 0;
				Dragonslayer_Cloth_Gloves.ExtraBonus = 0;
				Dragonslayer_Cloth_Gloves.ExtraBonusType = (int) 0;
				Dragonslayer_Cloth_Gloves.Effect = 0;
				Dragonslayer_Cloth_Gloves.Emblem = 0;
				Dragonslayer_Cloth_Gloves.Charges = 0;
				Dragonslayer_Cloth_Gloves.MaxCharges = 0;
				Dragonslayer_Cloth_Gloves.SpellID = 0;
				Dragonslayer_Cloth_Gloves.ProcSpellID = 31001;
				Dragonslayer_Cloth_Gloves.Type_Damage = 0;
				Dragonslayer_Cloth_Gloves.Realm = 0;
				Dragonslayer_Cloth_Gloves.MaxCount = 1;
				Dragonslayer_Cloth_Gloves.PackSize = 1;
				Dragonslayer_Cloth_Gloves.Extension = 5;
				Dragonslayer_Cloth_Gloves.Quality = 100;				
				Dragonslayer_Cloth_Gloves.Condition = 50000;
				Dragonslayer_Cloth_Gloves.MaxCondition = 50000;
				Dragonslayer_Cloth_Gloves.Durability = 50000;
				Dragonslayer_Cloth_Gloves.MaxDurability = 0;
				Dragonslayer_Cloth_Gloves.PoisonCharges = 0;
				Dragonslayer_Cloth_Gloves.PoisonMaxCharges = 0;
				Dragonslayer_Cloth_Gloves.PoisonSpellID = 0;
				Dragonslayer_Cloth_Gloves.ProcSpellID1 = 40006;
				Dragonslayer_Cloth_Gloves.SpellID1 = 0;
				Dragonslayer_Cloth_Gloves.MaxCharges1 = 0;
				Dragonslayer_Cloth_Gloves.Charges1 = 0;
				
				//You don't have to store the created item in the db if you don't want,
				//it will be recreated each time it is not found, just comment the following
				//line if you rather not modify your database
				if (SAVE_INTO_DATABASE)
					GameServer.Database.AddObject(Dragonslayer_Cloth_Gloves);
				}
			...
			Dragonslayer_Cloth_Breeches = GameServer.Database.FindObjectByKey<ItemTemplate>("Dragonslayer_Cloth_Breeches");
			if (Dragonslayer_Cloth_Breeches == null)
			{
				Dragonslayer_Cloth_Breeches = new ItemTemplate();
				Dragonslayer_Cloth_Breeches.Name = "Dragonslayer Cloth Breeches";
				if (log.IsWarnEnabled)
					log.Warn("Could not find " + Dragonslayer_Cloth_Breeches.Name + ", creating it ...");
				Dragonslayer_Cloth_Breeches.Level = 51;
				Dragonslayer_Cloth_Breeches.Weight = 14;
				Dragonslayer_Cloth_Breeches.Model = 4016;
				Dragonslayer_Cloth_Breeches.Object_Type = 32;
				Dragonslayer_Cloth_Breeches.Item_Type = 27;
				Dragonslayer_Cloth_Breeches.Id_nb = "Dragonslayer_Cloth_Breeches";
				Dragonslayer_Cloth_Breeches.Hand = 0;
				Dragonslayer_Cloth_Breeches.IsPickable = true;
				Dragonslayer_Cloth_Breeches.IsDropable = true;
				Dragonslayer_Cloth_Breeches.IsTradable = true;
				Dragonslayer_Cloth_Breeches.CanDropAsLoot = true;
				Dragonslayer_Cloth_Breeches.Color = 0;
				Dragonslayer_Cloth_Breeches.Bonus = 35; // default bonus				
				Dragonslayer_Cloth_Breeches.Bonus1 = 22;
				Dragonslayer_Cloth_Breeches.Bonus1Type = (int) 2;
				Dragonslayer_Cloth_Breeches.Bonus2 = 40;
				Dragonslayer_Cloth_Breeches.Bonus2Type = (int) 10;
				Dragonslayer_Cloth_Breeches.Bonus3 = 5;
				Dragonslayer_Cloth_Breeches.Bonus3Type = (int) 12;
				Dragonslayer_Cloth_Breeches.Bonus4 = 5;
				Dragonslayer_Cloth_Breeches.Bonus4Type = (int) 15;
				Dragonslayer_Cloth_Breeches.Bonus5 = 5;
				Dragonslayer_Cloth_Breeches.Bonus5Type = (int) 18;
				Dragonslayer_Cloth_Breeches.Bonus6 = 1;
				Dragonslayer_Cloth_Breeches.Bonus6Type = (int) 191;
				Dragonslayer_Cloth_Breeches.Bonus7 = 5;
				Dragonslayer_Cloth_Breeches.Bonus7Type = (int) 202;
				Dragonslayer_Cloth_Breeches.Bonus8 = 0;
				Dragonslayer_Cloth_Breeches.Bonus8Type = (int) 0;
				Dragonslayer_Cloth_Breeches.Bonus9 = 0;
				Dragonslayer_Cloth_Breeches.Bonus9Type = (int) 0;
				Dragonslayer_Cloth_Breeches.Bonus10 = 0;
				Dragonslayer_Cloth_Breeches.Bonus10Type = (int) 0;
				Dragonslayer_Cloth_Breeches.ExtraBonus = 0;
				Dragonslayer_Cloth_Breeches.ExtraBonusType = (int) 0;
				Dragonslayer_Cloth_Breeches.Effect = 0;
				Dragonslayer_Cloth_Breeches.Emblem = 0;
				Dragonslayer_Cloth_Breeches.Charges = 0;
				Dragonslayer_Cloth_Breeches.MaxCharges = 0;
				Dragonslayer_Cloth_Breeches.SpellID = 0;
				Dragonslayer_Cloth_Breeches.ProcSpellID = 31001;
				Dragonslayer_Cloth_Breeches.Type_Damage = 0;
				Dragonslayer_Cloth_Breeches.Realm = 0;
				Dragonslayer_Cloth_Breeches.MaxCount = 1;
				Dragonslayer_Cloth_Breeches.PackSize = 1;
				Dragonslayer_Cloth_Breeches.Extension = 5;
				Dragonslayer_Cloth_Breeches.Quality = 100;				
				Dragonslayer_Cloth_Breeches.Condition = 50000;
				Dragonslayer_Cloth_Breeches.MaxCondition = 50000;
				Dragonslayer_Cloth_Breeches.Durability = 50000;
				Dragonslayer_Cloth_Breeches.MaxDurability = 0;
				Dragonslayer_Cloth_Breeches.PoisonCharges = 0;
				Dragonslayer_Cloth_Breeches.PoisonMaxCharges = 0;
				Dragonslayer_Cloth_Breeches.PoisonSpellID = 0;
				Dragonslayer_Cloth_Breeches.ProcSpellID1 = 40006;
				Dragonslayer_Cloth_Breeches.SpellID1 = 0;
				Dragonslayer_Cloth_Breeches.MaxCharges1 = 0;
				Dragonslayer_Cloth_Breeches.Charges1 = 0;
				
				//You don't have to store the created item in the db if you don't want,
				//it will be recreated each time it is not found, just comment the following
				//line if you rather not modify your database
				if (SAVE_INTO_DATABASE)
					GameServer.Database.AddObject(Dragonslayer_Cloth_Breeches);
				}
			Dragonslayer_Cloth_Robes = GameServer.Database.FindObjectByKey<ItemTemplate>("Dragonslayer_Cloth_Robes");
			if (Dragonslayer_Cloth_Robes == null)
			{
				Dragonslayer_Cloth_Robes = new ItemTemplate();
				Dragonslayer_Cloth_Robes.Name = "Dragonslayer Cloth Robes";
				if (log.IsWarnEnabled)
					log.Warn("Could not find " + Dragonslayer_Cloth_Robes.Name + ", creating it ...");
				Dragonslayer_Cloth_Robes.Level = 51;
				Dragonslayer_Cloth_Robes.Weight = 20;
				Dragonslayer_Cloth_Robes.Model = 4020;
				Dragonslayer_Cloth_Robes.Object_Type = 32;
				Dragonslayer_Cloth_Robes.Item_Type = 25;
				Dragonslayer_Cloth_Robes.Id_nb = "Dragonslayer_Cloth_Robes";
				Dragonslayer_Cloth_Robes.Hand = 0;
				Dragonslayer_Cloth_Robes.IsPickable = true;
				Dragonslayer_Cloth_Robes.IsDropable = true;
				Dragonslayer_Cloth_Robes.IsTradable = true;
				Dragonslayer_Cloth_Robes.CanDropAsLoot = true;
				Dragonslayer_Cloth_Robes.Color = 0;
				Dragonslayer_Cloth_Robes.Bonus = 35; // default bonus				
				Dragonslayer_Cloth_Robes.Bonus1 = 22;
				Dragonslayer_Cloth_Robes.Bonus1Type = (int) 2;
				Dragonslayer_Cloth_Robes.Bonus2 = 5;
				Dragonslayer_Cloth_Robes.Bonus2Type = (int) 12;
				Dragonslayer_Cloth_Robes.Bonus3 = 5;
				Dragonslayer_Cloth_Robes.Bonus3Type = (int) 18;
				Dragonslayer_Cloth_Robes.Bonus4 = 5;
				Dragonslayer_Cloth_Robes.Bonus4Type = (int) 15;
				Dragonslayer_Cloth_Robes.Bonus5 = 22;
				Dragonslayer_Cloth_Robes.Bonus5Type = (int) 156;
				Dragonslayer_Cloth_Robes.Bonus6 = 5;
				Dragonslayer_Cloth_Robes.Bonus6Type = (int) 202;
				Dragonslayer_Cloth_Robes.Bonus7 = 2;
				Dragonslayer_Cloth_Robes.Bonus7Type = (int) 191;
				Dragonslayer_Cloth_Robes.Bonus8 = 5;
				Dragonslayer_Cloth_Robes.Bonus8Type = (int) 209;
				Dragonslayer_Cloth_Robes.Bonus9 = 0;
				Dragonslayer_Cloth_Robes.Bonus9Type = (int) 0;
				Dragonslayer_Cloth_Robes.Bonus10 = 0;
				Dragonslayer_Cloth_Robes.Bonus10Type = (int) 0;
				Dragonslayer_Cloth_Robes.ExtraBonus = 0;
				Dragonslayer_Cloth_Robes.ExtraBonusType = (int) 0;
				Dragonslayer_Cloth_Robes.Effect = 0;
				Dragonslayer_Cloth_Robes.Emblem = 0;
				Dragonslayer_Cloth_Robes.Charges = 0;
				Dragonslayer_Cloth_Robes.MaxCharges = 0;
				Dragonslayer_Cloth_Robes.SpellID = 0;
				Dragonslayer_Cloth_Robes.ProcSpellID = 31001;
				Dragonslayer_Cloth_Robes.Type_Damage = 0;
				Dragonslayer_Cloth_Robes.Realm = 0;
				Dragonslayer_Cloth_Robes.MaxCount = 1;
				Dragonslayer_Cloth_Robes.PackSize = 1;
				Dragonslayer_Cloth_Robes.Extension = 5;
				Dragonslayer_Cloth_Robes.Quality = 100;				
				Dragonslayer_Cloth_Robes.Condition = 50000;
				Dragonslayer_Cloth_Robes.MaxCondition = 50000;
				Dragonslayer_Cloth_Robes.Durability = 50000;
				Dragonslayer_Cloth_Robes.MaxDurability = 0;
				Dragonslayer_Cloth_Robes.PoisonCharges = 0;
				Dragonslayer_Cloth_Robes.PoisonMaxCharges = 0;
				Dragonslayer_Cloth_Robes.PoisonSpellID = 0;
				Dragonslayer_Cloth_Robes.ProcSpellID1 = 40006;
				Dragonslayer_Cloth_Robes.SpellID1 = 0;
				Dragonslayer_Cloth_Robes.MaxCharges1 = 0;
				Dragonslayer_Cloth_Robes.Charges1 = 0;
				
				//You don't have to store the created item in the db if you don't want,
				//it will be recreated each time it is not found, just comment the following
				//line if you rather not modify your database
				if (SAVE_INTO_DATABASE)
					GameServer.Database.AddObject(Dragonslayer_Cloth_Robes);
				}
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerNecromancerQuest), Elia);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerNecromancerQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerNecromancerQuest), Elia);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerNecromancerQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerNecromancerQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(Elia, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerNecromancerQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", Elia);
            AddBehaviour(a);

            a = builder.CreateBehaviour(Elia, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerNecromancerQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Runicaath I shall pay you well!", Elia);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerNecromancerQuest), Elia);
            AddBehaviour(a);
			...
			if (Elia!=null) {
				Elia.AddQuestToGive(typeof (DragonslayerNecromancerQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			Elia.RemoveQuestToGive(typeof (DragonslayerNecromancerQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerNecromancerQuest)) != null)
				return true;

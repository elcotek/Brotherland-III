...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerWizardQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerWizardQuest";
		...
		* Constructor
		*/
		public DragonslayerWizardQuest() : base()
		{
		}

		public DragonslayerWizardQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerWizardQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerWizardQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerWizardQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerWizardQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == Elia.Name && gArgs.Item.Id_nb == Runicaath_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerWizardQuest), null);
						...
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerWizardQuest), null);
	...
	GameNPC[] npcs;
		...
		Runicaath_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Runicaath_Head");
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerWizardQuest), Elia);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerWizardQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerWizardQuest), Elia);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerWizardQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerWizardQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(Elia, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerWizardQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", Elia);
            AddBehaviour(a);

            a = builder.CreateBehaviour(Elia, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerWizardQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Runicaath I shall pay you well!", Elia);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerWizardQuest), Elia);
            AddBehaviour(a);
			...
			if (Elia!=null) {
				Elia.AddQuestToGive(typeof (DragonslayerWizardQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			Elia.RemoveQuestToGive(typeof (DragonslayerWizardQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerWizardQuest)) != null)
				return true;

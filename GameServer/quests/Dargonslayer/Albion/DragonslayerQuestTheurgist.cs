...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerTheurgistQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerTheurgistQuest";
		...
		* Constructor
		*/
		public DragonslayerTheurgistQuest() : base()
		{
		}

		public DragonslayerTheurgistQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerTheurgistQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerTheurgistQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerTheurgistQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerTheurgistQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == Elia.Name && gArgs.Item.Id_nb == Runicaath_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerTheurgistQuest), null);
						...
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerTheurgistQuest), null);
	...
	GameNPC[] npcs;
		...
		Runicaath_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Runicaath_Head");
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerTheurgistQuest), Elia);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerTheurgistQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerTheurgistQuest), Elia);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerTheurgistQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerTheurgistQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(Elia, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerTheurgistQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", Elia);
            AddBehaviour(a);

            a = builder.CreateBehaviour(Elia, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerTheurgistQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Runicaath I shall pay you well!", Elia);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerTheurgistQuest), Elia);
            AddBehaviour(a);
			...
			if (Elia!=null) {
				Elia.AddQuestToGive(typeof (DragonslayerTheurgistQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			Elia.RemoveQuestToGive(typeof (DragonslayerTheurgistQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerTheurgistQuest)) != null)
				return true;

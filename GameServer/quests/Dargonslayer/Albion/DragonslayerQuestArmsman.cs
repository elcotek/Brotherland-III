...
namespace DOL.GS.Quests {
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerArmsmanQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerArmsmanQuest";
		...
		* Constructor
		*/
		public DragonslayerArmsmanQuest() : base()
		{
		}

		public DragonslayerArmsmanQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerArmsmanQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerArmsmanQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerArmsmanQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerArmsmanQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
					...
					if (gArgs.Target.Name == Elia.Name && gArgs.Item.Id_nb == Runicaath_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerArmsmanQuest), null);
						...
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerArmsmanQuest), null);
	...
	GameNPC[] npcs;
		...
		#region defineQuestParts
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerArmsmanQuest), Elia);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerArmsmanQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerArmsmanQuest), Elia);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerArmsmanQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerArmsmanQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(Elia, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerArmsmanQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", Elia);
            AddBehaviour(a);

            a = builder.CreateBehaviour(Elia, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerArmsmanQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Runicaath I shall pay you well!", Elia);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerArmsmanQuest), Elia);
            AddBehaviour(a);
			...
			if (Elia!=null) {
				Elia.AddQuestToGive(typeof (DragonslayerArmsmanQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			Elia.RemoveQuestToGive(typeof (DragonslayerArmsmanQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerArmsmanQuest)) != null)
				return true;
			...
			player.CharacterClass.ID != (byte) eCharacterClass.Armsman && 
				true) {
				return false;			
			}

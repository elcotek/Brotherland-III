...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerSavageQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerSavageQuest";
		...
		private static ItemTemplate Dragonslayer_Savage_Starkaskodd_Jerkin = null;
		...
		* Constructor
		*/
		public DragonslayerSavageQuest() : base()
		{
		}

		public DragonslayerSavageQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerSavageQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerSavageQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerSavageQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerSavageQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == AmarasavaDas.Name && gArgs.Item.Id_nb == Jarkkonith_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerSavageQuest), null);
						a.AddAction(eActionType.GiveItem, Dragonslayer_Savage_Starkaskodd_Jerkin, AmarasavaDas);
						...
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerSavageQuest), null);
	...
	GameNPC[] npcs;
		...
		Jarkkonith_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Jarkkonith_Head");
			...
			Dragonslayer_Savage_Starkaskodd_Jerkin = GameServer.Database.FindObjectByKey<ItemTemplate>("Dragonslayer_Savage_Starkaskodd_Jerkin");
			if (Dragonslayer_Savage_Starkaskodd_Jerkin == null)
			{
				Dragonslayer_Savage_Starkaskodd_Jerkin = new ItemTemplate();
				Dragonslayer_Savage_Starkaskodd_Jerkin.Name = "Dragonslayer Savage Starkaskodd Jerkin";
				if (log.IsWarnEnabled)
					log.Warn("Could not find " + Dragonslayer_Savage_Starkaskodd_Jerkin.Name + ", creating it ...");
				Dragonslayer_Savage_Starkaskodd_Jerkin.Level = 51;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Weight = 22;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Model = 4041;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Object_Type = 34;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Item_Type = 25;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Id_nb = "Dragonslayer_Savage_Starkaskodd_Jerkin";
				Dragonslayer_Savage_Starkaskodd_Jerkin.Hand = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.IsPickable = true;
				Dragonslayer_Savage_Starkaskodd_Jerkin.IsDropable = true;
				Dragonslayer_Savage_Starkaskodd_Jerkin.IsTradable = true;
				Dragonslayer_Savage_Starkaskodd_Jerkin.CanDropAsLoot = true;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Color = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus = 35; // default bonus				
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus1 = 22;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus1Type = (int) 1;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus2 = 22;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus2Type = (int) 2;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus3 = 5;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus3Type = (int) 12;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus4 = 5;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus4Type = (int) 18;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus5 = 5;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus5Type = (int) 15;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus6 = 4;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus6Type = (int) 173;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus7 = 4;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus7Type = (int) 200;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus8 = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus8Type = (int) 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus9 = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus9Type = (int) 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus10 = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Bonus10Type = (int) 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.ExtraBonus = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.ExtraBonusType = (int) 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Effect = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Emblem = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Charges = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.MaxCharges = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.SpellID = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.ProcSpellID = 31001;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Type_Damage = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Realm = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.MaxCount = 1;
				Dragonslayer_Savage_Starkaskodd_Jerkin.PackSize = 1;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Extension = 5;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Quality = 100;				
				Dragonslayer_Savage_Starkaskodd_Jerkin.Condition = 50000;
				Dragonslayer_Savage_Starkaskodd_Jerkin.MaxCondition = 50000;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Durability = 50000;
				Dragonslayer_Savage_Starkaskodd_Jerkin.MaxDurability = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.PoisonCharges = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.PoisonMaxCharges = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.PoisonSpellID = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.ProcSpellID1 = 40006;
				Dragonslayer_Savage_Starkaskodd_Jerkin.SpellID1 = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.MaxCharges1 = 0;
				Dragonslayer_Savage_Starkaskodd_Jerkin.Charges1 = 0;
				
				//You don't have to store the created item in the db if you don't want,
				//it will be recreated each time it is not found, just comment the following
				//line if you rather not modify your database
				if (SAVE_INTO_DATABASE)
					GameServer.Database.AddObject(Dragonslayer_Savage_Starkaskodd_Jerkin);
				}
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerSavageQuest), AmarasavaDas);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerSavageQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerSavageQuest), AmarasavaDas);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerSavageQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerSavageQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(AmarasavaDas, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerSavageQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", AmarasavaDas);
            AddBehaviour(a);

            a = builder.CreateBehaviour(AmarasavaDas, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerSavageQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Jarkkonith I shall pay you well!", AmarasavaDas);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerSavageQuest), AmarasavaDas);
            AddBehaviour(a);
			...
			if (AmarasavaDas!=null) {
				AmarasavaDas.AddQuestToGive(typeof (DragonslayerSavageQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			AmarasavaDas.RemoveQuestToGive(typeof (DragonslayerSavageQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerSavageQuest)) != null)
				return true;

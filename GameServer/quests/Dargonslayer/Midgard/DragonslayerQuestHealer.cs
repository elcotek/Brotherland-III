...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerHealerQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerHealerQuest";
		...
		* Constructor
		*/
		public DragonslayerHealerQuest() : base()
		{
		}

		public DragonslayerHealerQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerHealerQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerHealerQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		...
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerHealerQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerHealerQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == AmarasavaDas.Name && gArgs.Item.Id_nb == Jarkkonith_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerHealerQuest), null);
						...
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerHealerQuest), null);
	...
	GameNPC[] npcs;
		...
		Jarkkonith_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Jarkkonith_Head");
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerHealerQuest), AmarasavaDas);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerHealerQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerHealerQuest), AmarasavaDas);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerHealerQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerHealerQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(AmarasavaDas, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerHealerQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", AmarasavaDas);
            AddBehaviour(a);

            a = builder.CreateBehaviour(AmarasavaDas, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerHealerQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Jarkkonith I shall pay you well!", AmarasavaDas);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerHealerQuest), AmarasavaDas);
            AddBehaviour(a);
			...
			if (AmarasavaDas!=null) {
				AmarasavaDas.AddQuestToGive(typeof (DragonslayerHealerQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			AmarasavaDas.RemoveQuestToGive(typeof (DragonslayerHealerQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerHealerQuest)) != null)
				return true;

...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerThaneQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerThaneQuest";
		...
		private static ItemTemplate Dragonslayer_Odin_Starkakedja_Chausses = null;
		
		private static ItemTemplate Dragonslayer_Odin_Starkakedja_Hauberk = null;
		
		private static ItemTemplate Dragonslayer_Storm_Starkakedja_Gloves = null;
		...
		* Constructor
		*/
		public DragonslayerThaneQuest() : base()
		{
		}

		public DragonslayerThaneQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerThaneQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerThaneQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerThaneQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerThaneQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == AmarasavaDas.Name && gArgs.Item.Id_nb == Jarkkonith_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerThaneQuest), null);
						...
						a.AddAction(eActionType.GiveItem, Dragonslayer_Odin_Starkakedja_Chausses, AmarasavaDas);
						a.AddAction(eActionType.GiveItem, Dragonslayer_Odin_Starkakedja_Hauberk, AmarasavaDas);
						a.AddAction(eActionType.GiveItem, Dragonslayer_Storm_Starkakedja_Gloves, AmarasavaDas);
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerThaneQuest), null);
	...
	GameNPC[] npcs;
		...
		Jarkkonith_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Jarkkonith_Head");
			...
			Dragonslayer_Odin_Starkakedja_Chausses = GameServer.Database.FindObjectByKey<ItemTemplate>("Dragonslayer_Odin_Starkakedja_Chausses");
			if (Dragonslayer_Odin_Starkakedja_Chausses == null)
			{
				Dragonslayer_Odin_Starkakedja_Chausses = new ItemTemplate();
				Dragonslayer_Odin_Starkakedja_Chausses.Name = "Dragonslayer Odin Starkakedja Chausses";
				if (log.IsWarnEnabled)
					log.Warn("Could not find " + Dragonslayer_Odin_Starkakedja_Chausses.Name + ", creating it ...");
				Dragonslayer_Odin_Starkakedja_Chausses.Level = 51;
				Dragonslayer_Odin_Starkakedja_Chausses.Weight = 22;
				Dragonslayer_Odin_Starkakedja_Chausses.Model = 4027;
				Dragonslayer_Odin_Starkakedja_Chausses.Object_Type = 35;
				Dragonslayer_Odin_Starkakedja_Chausses.Item_Type = 27;
				Dragonslayer_Odin_Starkakedja_Chausses.Id_nb = "Dragonslayer_Odin_Starkakedja_Chausses";
				Dragonslayer_Odin_Starkakedja_Chausses.Hand = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.IsPickable = true;
				Dragonslayer_Odin_Starkakedja_Chausses.IsDropable = true;
				Dragonslayer_Odin_Starkakedja_Chausses.IsTradable = true;
				Dragonslayer_Odin_Starkakedja_Chausses.CanDropAsLoot = true;
				Dragonslayer_Odin_Starkakedja_Chausses.Color = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus = 35; // default bonus				
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus1 = 22;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus1Type = (int) 2;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus2 = 5;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus2Type = (int) 12;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus3 = 5;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus3Type = (int) 18;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus4 = 40;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus4Type = (int) 10;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus5 = 5;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus5Type = (int) 15;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus6 = 1;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus6Type = (int) 155;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus7 = 5;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus7Type = (int) 202;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus8 = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus8Type = (int) 0;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus9 = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus9Type = (int) 0;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus10 = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.Bonus10Type = (int) 0;
				Dragonslayer_Odin_Starkakedja_Chausses.ExtraBonus = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.ExtraBonusType = (int) 0;
				Dragonslayer_Odin_Starkakedja_Chausses.Effect = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.Emblem = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.Charges = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.MaxCharges = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.SpellID = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.ProcSpellID = 31001;
				Dragonslayer_Odin_Starkakedja_Chausses.Type_Damage = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.Realm = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.MaxCount = 1;
				Dragonslayer_Odin_Starkakedja_Chausses.PackSize = 1;
				Dragonslayer_Odin_Starkakedja_Chausses.Extension = 5;
				Dragonslayer_Odin_Starkakedja_Chausses.Quality = 100;				
				Dragonslayer_Odin_Starkakedja_Chausses.Condition = 50000;
				Dragonslayer_Odin_Starkakedja_Chausses.MaxCondition = 50000;
				Dragonslayer_Odin_Starkakedja_Chausses.Durability = 50000;
				Dragonslayer_Odin_Starkakedja_Chausses.MaxDurability = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.PoisonCharges = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.PoisonMaxCharges = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.PoisonSpellID = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.ProcSpellID1 = 40006;
				Dragonslayer_Odin_Starkakedja_Chausses.SpellID1 = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.MaxCharges1 = 0;
				Dragonslayer_Odin_Starkakedja_Chausses.Charges1 = 0;
				
				//You don't have to store the created item in the db if you don't want,
				//it will be recreated each time it is not found, just comment the following
				//line if you rather not modify your database
				if (SAVE_INTO_DATABASE)
					GameServer.Database.AddObject(Dragonslayer_Odin_Starkakedja_Chausses);
				}
			Dragonslayer_Odin_Starkakedja_Hauberk = GameServer.Database.FindObjectByKey<ItemTemplate>("Dragonslayer_Odin_Starkakedja_Hauberk");
			if (Dragonslayer_Odin_Starkakedja_Hauberk == null)
			{
				Dragonslayer_Odin_Starkakedja_Hauberk = new ItemTemplate();
				Dragonslayer_Odin_Starkakedja_Hauberk.Name = "Dragonslayer Odin Starkakedja Hauberk";
				if (log.IsWarnEnabled)
					log.Warn("Could not find " + Dragonslayer_Odin_Starkakedja_Hauberk.Name + ", creating it ...");
				Dragonslayer_Odin_Starkakedja_Hauberk.Level = 51;
				Dragonslayer_Odin_Starkakedja_Hauberk.Weight = 22;
				Dragonslayer_Odin_Starkakedja_Hauberk.Model = 4026;
				Dragonslayer_Odin_Starkakedja_Hauberk.Object_Type = 35;
				Dragonslayer_Odin_Starkakedja_Hauberk.Item_Type = 25;
				Dragonslayer_Odin_Starkakedja_Hauberk.Id_nb = "Dragonslayer_Odin_Starkakedja_Hauberk";
				Dragonslayer_Odin_Starkakedja_Hauberk.Hand = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.IsPickable = true;
				Dragonslayer_Odin_Starkakedja_Hauberk.IsDropable = true;
				Dragonslayer_Odin_Starkakedja_Hauberk.IsTradable = true;
				Dragonslayer_Odin_Starkakedja_Hauberk.CanDropAsLoot = true;
				Dragonslayer_Odin_Starkakedja_Hauberk.Color = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus = 35; // default bonus				
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus1 = 15;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus1Type = (int) 1;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus2 = 15;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus2Type = (int) 2;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus3 = 5;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus3Type = (int) 12;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus4 = 5;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus4Type = (int) 18;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus5 = 5;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus5Type = (int) 15;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus6 = 4;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus6Type = (int) 153;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus7 = 4;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus7Type = (int) 198;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus8 = 4;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus8Type = (int) 200;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus9 = 4;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus9Type = (int) 173;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus10 = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.Bonus10Type = (int) 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.ExtraBonus = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.ExtraBonusType = (int) 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.Effect = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.Emblem = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.Charges = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.MaxCharges = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.SpellID = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.ProcSpellID = 31001;
				Dragonslayer_Odin_Starkakedja_Hauberk.Type_Damage = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.Realm = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.MaxCount = 1;
				Dragonslayer_Odin_Starkakedja_Hauberk.PackSize = 1;
				Dragonslayer_Odin_Starkakedja_Hauberk.Extension = 5;
				Dragonslayer_Odin_Starkakedja_Hauberk.Quality = 100;				
				Dragonslayer_Odin_Starkakedja_Hauberk.Condition = 50000;
				Dragonslayer_Odin_Starkakedja_Hauberk.MaxCondition = 50000;
				Dragonslayer_Odin_Starkakedja_Hauberk.Durability = 50000;
				Dragonslayer_Odin_Starkakedja_Hauberk.MaxDurability = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.PoisonCharges = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.PoisonMaxCharges = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.PoisonSpellID = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.ProcSpellID1 = 40006;
				Dragonslayer_Odin_Starkakedja_Hauberk.SpellID1 = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.MaxCharges1 = 0;
				Dragonslayer_Odin_Starkakedja_Hauberk.Charges1 = 0;
				
				//You don't have to store the created item in the db if you don't want,
				//it will be recreated each time it is not found, just comment the following
				//line if you rather not modify your database
				if (SAVE_INTO_DATABASE)
					GameServer.Database.AddObject(Dragonslayer_Odin_Starkakedja_Hauberk);
				}
			Dragonslayer_Storm_Starkakedja_Gloves = GameServer.Database.FindObjectByKey<ItemTemplate>("Dragonslayer_Storm_Starkakedja_Gloves");
			if (Dragonslayer_Storm_Starkakedja_Gloves == null)
			{
				Dragonslayer_Storm_Starkakedja_Gloves = new ItemTemplate();
				Dragonslayer_Storm_Starkakedja_Gloves.Name = "Dragonslayer Storm Starkakedja Gloves";
				if (log.IsWarnEnabled)
					log.Warn("Could not find " + Dragonslayer_Storm_Starkakedja_Gloves.Name + ", creating it ...");
				Dragonslayer_Storm_Starkakedja_Gloves.Level = 51;
				Dragonslayer_Storm_Starkakedja_Gloves.Weight = 22;
				Dragonslayer_Storm_Starkakedja_Gloves.Model = 4029;
				Dragonslayer_Storm_Starkakedja_Gloves.Object_Type = 35;
				Dragonslayer_Storm_Starkakedja_Gloves.Item_Type = 22;
				Dragonslayer_Storm_Starkakedja_Gloves.Id_nb = "Dragonslayer_Storm_Starkakedja_Gloves";
				Dragonslayer_Storm_Starkakedja_Gloves.Hand = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.IsPickable = true;
				Dragonslayer_Storm_Starkakedja_Gloves.IsDropable = true;
				Dragonslayer_Storm_Starkakedja_Gloves.IsTradable = true;
				Dragonslayer_Storm_Starkakedja_Gloves.CanDropAsLoot = true;
				Dragonslayer_Storm_Starkakedja_Gloves.Color = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus = 35; // default bonus				
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus1 = 22;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus1Type = (int) 1;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus2 = 40;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus2Type = (int) 10;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus3 = 5;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus3Type = (int) 12;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus4 = 5;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus4Type = (int) 15;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus5 = 5;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus5Type = (int) 18;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus6 = 5;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus6Type = (int) 201;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus7 = 1;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus7Type = (int) 155;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus8 = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus8Type = (int) 0;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus9 = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus9Type = (int) 0;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus10 = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.Bonus10Type = (int) 0;
				Dragonslayer_Storm_Starkakedja_Gloves.ExtraBonus = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.ExtraBonusType = (int) 0;
				Dragonslayer_Storm_Starkakedja_Gloves.Effect = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.Emblem = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.Charges = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.MaxCharges = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.SpellID = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.ProcSpellID = 31001;
				Dragonslayer_Storm_Starkakedja_Gloves.Type_Damage = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.Realm = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.MaxCount = 1;
				Dragonslayer_Storm_Starkakedja_Gloves.PackSize = 1;
				Dragonslayer_Storm_Starkakedja_Gloves.Extension = 5;
				Dragonslayer_Storm_Starkakedja_Gloves.Quality = 100;				
				Dragonslayer_Storm_Starkakedja_Gloves.Condition = 50000;
				Dragonslayer_Storm_Starkakedja_Gloves.MaxCondition = 50000;
				Dragonslayer_Storm_Starkakedja_Gloves.Durability = 50000;
				Dragonslayer_Storm_Starkakedja_Gloves.MaxDurability = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.PoisonCharges = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.PoisonMaxCharges = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.PoisonSpellID = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.ProcSpellID1 = 40006;
				Dragonslayer_Storm_Starkakedja_Gloves.SpellID1 = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.MaxCharges1 = 0;
				Dragonslayer_Storm_Starkakedja_Gloves.Charges1 = 0;
				
				//You don't have to store the created item in the db if you don't want,
				//it will be recreated each time it is not found, just comment the following
				//line if you rather not modify your database
				if (SAVE_INTO_DATABASE)
					GameServer.Database.AddObject(Dragonslayer_Storm_Starkakedja_Gloves);
				}
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerThaneQuest), AmarasavaDas);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerThaneQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerThaneQuest), AmarasavaDas);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerThaneQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerThaneQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(AmarasavaDas, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerThaneQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", AmarasavaDas);
            AddBehaviour(a);

            a = builder.CreateBehaviour(AmarasavaDas, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerThaneQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Jarkkonith I shall pay you well!", AmarasavaDas);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerThaneQuest), AmarasavaDas);
            AddBehaviour(a);
			...
			if (AmarasavaDas!=null) {
				AmarasavaDas.AddQuestToGive(typeof (DragonslayerThaneQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			AmarasavaDas.RemoveQuestToGive(typeof (DragonslayerThaneQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerThaneQuest)) != null)
				return true;

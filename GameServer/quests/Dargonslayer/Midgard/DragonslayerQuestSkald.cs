...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerSkaldQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerSkaldQuest";
		...
		private static ItemTemplate Dragonslayer_Bragi_Starkakedja_Hauberk = null;
		...
		* Constructor
		*/
		public DragonslayerSkaldQuest() : base()
		{
		}

		public DragonslayerSkaldQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerSkaldQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerSkaldQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerSkaldQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerSkaldQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == AmarasavaDas.Name && gArgs.Item.Id_nb == Jarkkonith_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerSkaldQuest), null);
						...
						a.AddAction(eActionType.GiveItem, Dragonslayer_Bragi_Starkakedja_Hauberk, AmarasavaDas);
						a.AddAction(eActionType.GiveItem, Dragonslayer_Starkakedja_Gauntlets, AmarasavaDas);
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerSkaldQuest), null);
	...
	GameNPC[] npcs;
		...
		Jarkkonith_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Jarkkonith_Head");
			...
			Dragonslayer_Bragi_Starkakedja_Hauberk = GameServer.Database.FindObjectByKey<ItemTemplate>("Dragonslayer_Bragi_Starkakedja_Hauberk");
			if (Dragonslayer_Bragi_Starkakedja_Hauberk == null)
			{
				Dragonslayer_Bragi_Starkakedja_Hauberk = new ItemTemplate();
				Dragonslayer_Bragi_Starkakedja_Hauberk.Name = "Dragonslayer Bragi Starkakedja Hauberk";
				if (log.IsWarnEnabled)
					log.Warn("Could not find " + Dragonslayer_Bragi_Starkakedja_Hauberk.Name + ", creating it ...");
				Dragonslayer_Bragi_Starkakedja_Hauberk.Level = 51;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Weight = 22;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Model = 4026;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Object_Type = 35;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Item_Type = 25;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Id_nb = "Dragonslayer_Bragi_Starkakedja_Hauberk";
				Dragonslayer_Bragi_Starkakedja_Hauberk.Hand = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.IsPickable = true;
				Dragonslayer_Bragi_Starkakedja_Hauberk.IsDropable = true;
				Dragonslayer_Bragi_Starkakedja_Hauberk.IsTradable = true;
				Dragonslayer_Bragi_Starkakedja_Hauberk.CanDropAsLoot = true;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Color = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus = 35; // default bonus				
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus1 = 15;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus1Type = (int) 1;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus2 = 5;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus2Type = (int) 12;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus3 = 5;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus3Type = (int) 18;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus4 = 5;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus4Type = (int) 15;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus5 = 15;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus5Type = (int) 156;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus6 = 4;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus6Type = (int) 173;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus7 = 4;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus7Type = (int) 200;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus8 = 4;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus8Type = (int) 198;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus9 = 4;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus9Type = (int) 153;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus10 = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Bonus10Type = (int) 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.ExtraBonus = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.ExtraBonusType = (int) 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Effect = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Emblem = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Charges = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.MaxCharges = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.SpellID = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.ProcSpellID = 31001;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Type_Damage = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Realm = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.MaxCount = 1;
				Dragonslayer_Bragi_Starkakedja_Hauberk.PackSize = 1;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Extension = 5;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Quality = 100;				
				Dragonslayer_Bragi_Starkakedja_Hauberk.Condition = 50000;
				Dragonslayer_Bragi_Starkakedja_Hauberk.MaxCondition = 50000;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Durability = 50000;
				Dragonslayer_Bragi_Starkakedja_Hauberk.MaxDurability = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.PoisonCharges = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.PoisonMaxCharges = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.PoisonSpellID = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.ProcSpellID1 = 40006;
				Dragonslayer_Bragi_Starkakedja_Hauberk.SpellID1 = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.MaxCharges1 = 0;
				Dragonslayer_Bragi_Starkakedja_Hauberk.Charges1 = 0;
				
				//You don't have to store the created item in the db if you don't want,
				//it will be recreated each time it is not found, just comment the following
				//line if you rather not modify your database
				if (SAVE_INTO_DATABASE)
					GameServer.Database.AddObject(Dragonslayer_Bragi_Starkakedja_Hauberk);
				}
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerSkaldQuest), AmarasavaDas);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerSkaldQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerSkaldQuest), AmarasavaDas);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerSkaldQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerSkaldQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(AmarasavaDas, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerSkaldQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", AmarasavaDas);
            AddBehaviour(a);

            a = builder.CreateBehaviour(AmarasavaDas, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerSkaldQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Jarkkonith I shall pay you well!", AmarasavaDas);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerSkaldQuest), AmarasavaDas);
            AddBehaviour(a);
			...
			if (AmarasavaDas!=null) {
				AmarasavaDas.AddQuestToGive(typeof (DragonslayerSkaldQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			AmarasavaDas.RemoveQuestToGive(typeof (DragonslayerSkaldQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerSkaldQuest)) != null)
				return true;

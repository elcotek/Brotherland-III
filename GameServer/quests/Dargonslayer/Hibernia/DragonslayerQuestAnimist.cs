...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerAnimistQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerAnimistQuest";
		...
		* Constructor
		*/
		public DragonslayerAnimistQuest() : base()
		{
		}

		public DragonslayerAnimistQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerAnimistQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerAnimistQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerAnimistQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerAnimistQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == Lirazal.Name && gArgs.Item.Id_nb == Asiintath_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerAnimistQuest), null);
						...
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerAnimistQuest), null);
	...
	GameNPC[] npcs;
		...
		QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerAnimistQuest));
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerAnimistQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerAnimistQuest), null, (eComparator)5);
            ...
            AddBehaviour(a);
            //a.AddAction(eActionType.GiveQuest,typeof(DragonslayerAnimistQuest),Lirazal);
			//AddBehaviour(a);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerAnimistQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerAnimistQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerAnimistQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerAnimistQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", Lirazal);
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerAnimistQuest));
			...
			if (Lirazal!=null) {
				Lirazal.AddQuestToGive(typeof (DragonslayerAnimistQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			Lirazal.RemoveQuestToGive(typeof (DragonslayerAnimistQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerAnimistQuest)) != null)
				return true;

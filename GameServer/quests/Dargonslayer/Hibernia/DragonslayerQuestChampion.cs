...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerChampionQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerChampionQuest";
		...
		private static ItemTemplate dragonslayer_defiant_osnadurtha_vest = null;
		...
		* Constructor
		*/
		public DragonslayerChampionQuest() : base()
		{
		}

		public DragonslayerChampionQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerChampionQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerChampionQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerChampionQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerChampionQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == Lirazal.Name && gArgs.Item.Id_nb == Asiintath_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerChampionQuest), null);
						...
						a.AddAction(eActionType.GiveItem, dragonslayer_defiant_osnadurtha_vest, Lirazal);
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerChampionQuest), null);
	...
	GameNPC[] npcs;
		...
		Asiintath_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Asiintath_Head");
			...
			dragonslayer_defiant_osnadurtha_vest = GameServer.Database.FindObjectByKey<ItemTemplate>("dragonslayer_defiant_osnadurtha_vest");
			if (dragonslayer_defiant_osnadurtha_vest == null)
			{
				dragonslayer_defiant_osnadurtha_vest = new ItemTemplate();
				dragonslayer_defiant_osnadurtha_vest.Name = "Dragonslayer Defiant Osnadurtha Vest";
				if (log.IsWarnEnabled)
					log.Warn("Could not find " + dragonslayer_defiant_osnadurtha_vest.Name + ", creating it ...");
				dragonslayer_defiant_osnadurtha_vest.Level = 51;
				dragonslayer_defiant_osnadurtha_vest.Weight = 80;
				dragonslayer_defiant_osnadurtha_vest.Model = 4089;
				dragonslayer_defiant_osnadurtha_vest.Object_Type = 38;
				dragonslayer_defiant_osnadurtha_vest.Item_Type = 25;
				dragonslayer_defiant_osnadurtha_vest.Id_nb = "dragonslayer_defiant_osnadurtha_vest";
				dragonslayer_defiant_osnadurtha_vest.Hand = 0;
				dragonslayer_defiant_osnadurtha_vest.IsPickable = true;
				dragonslayer_defiant_osnadurtha_vest.IsDropable = true;
				dragonslayer_defiant_osnadurtha_vest.IsTradable = true;
				dragonslayer_defiant_osnadurtha_vest.CanDropAsLoot = true;
				dragonslayer_defiant_osnadurtha_vest.Color = 0;
				dragonslayer_defiant_osnadurtha_vest.Bonus = 35; // default bonus				
				dragonslayer_defiant_osnadurtha_vest.Bonus1 = 15;
				dragonslayer_defiant_osnadurtha_vest.Bonus1Type = (int) 1;
				dragonslayer_defiant_osnadurtha_vest.Bonus2 = 15;
				dragonslayer_defiant_osnadurtha_vest.Bonus2Type = (int) 4;
				dragonslayer_defiant_osnadurtha_vest.Bonus3 = 5;
				dragonslayer_defiant_osnadurtha_vest.Bonus3Type = (int) 12;
				dragonslayer_defiant_osnadurtha_vest.Bonus4 = 5;
				dragonslayer_defiant_osnadurtha_vest.Bonus4Type = (int) 18;
				dragonslayer_defiant_osnadurtha_vest.Bonus5 = 5;
				dragonslayer_defiant_osnadurtha_vest.Bonus5Type = (int) 15;
				dragonslayer_defiant_osnadurtha_vest.Bonus6 = 4;
				dragonslayer_defiant_osnadurtha_vest.Bonus6Type = (int) 173;
				dragonslayer_defiant_osnadurtha_vest.Bonus7 = 4;
				dragonslayer_defiant_osnadurtha_vest.Bonus7Type = (int) 198;
				dragonslayer_defiant_osnadurtha_vest.Bonus8 = 4;
				dragonslayer_defiant_osnadurtha_vest.Bonus8Type = (int) 200;
				dragonslayer_defiant_osnadurtha_vest.Bonus9 = 4;
				dragonslayer_defiant_osnadurtha_vest.Bonus9Type = (int) 153;
				dragonslayer_defiant_osnadurtha_vest.Bonus10 = 0;
				dragonslayer_defiant_osnadurtha_vest.Bonus10Type = (int) 0;
				dragonslayer_defiant_osnadurtha_vest.ExtraBonus = 0;
				dragonslayer_defiant_osnadurtha_vest.ExtraBonusType = (int) 0;
				dragonslayer_defiant_osnadurtha_vest.Effect = 0;
				dragonslayer_defiant_osnadurtha_vest.Emblem = 0;
				dragonslayer_defiant_osnadurtha_vest.Charges = 0;
				dragonslayer_defiant_osnadurtha_vest.MaxCharges = 0;
				dragonslayer_defiant_osnadurtha_vest.SpellID = 0;
				dragonslayer_defiant_osnadurtha_vest.ProcSpellID = 31001;
				dragonslayer_defiant_osnadurtha_vest.Type_Damage = 0;
				dragonslayer_defiant_osnadurtha_vest.Realm = 0;
				dragonslayer_defiant_osnadurtha_vest.MaxCount = 1;
				dragonslayer_defiant_osnadurtha_vest.PackSize = 1;
				dragonslayer_defiant_osnadurtha_vest.Extension = 5;
				dragonslayer_defiant_osnadurtha_vest.Quality = 100;				
				dragonslayer_defiant_osnadurtha_vest.Condition = 50000;
				dragonslayer_defiant_osnadurtha_vest.MaxCondition = 50000;
				dragonslayer_defiant_osnadurtha_vest.Durability = 50000;
				dragonslayer_defiant_osnadurtha_vest.MaxDurability = 0;
				dragonslayer_defiant_osnadurtha_vest.PoisonCharges = 0;
				dragonslayer_defiant_osnadurtha_vest.PoisonMaxCharges = 0;
				dragonslayer_defiant_osnadurtha_vest.PoisonSpellID = 0;
				dragonslayer_defiant_osnadurtha_vest.ProcSpellID1 = 40006;
				dragonslayer_defiant_osnadurtha_vest.SpellID1 = 0;
				dragonslayer_defiant_osnadurtha_vest.MaxCharges1 = 0;
				dragonslayer_defiant_osnadurtha_vest.Charges1 = 0;
				
				//You don't have to store the created item in the db if you don't want,
				//it will be recreated each time it is not found, just comment the following
				//line if you rather not modify your database
				if (SAVE_INTO_DATABASE)
					GameServer.Database.AddObject(dragonslayer_defiant_osnadurtha_vest);
				}
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerChampionQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerChampionQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerChampionQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerChampionQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerChampionQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerChampionQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", Lirazal);
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerChampionQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Asiintath I shall pay you well!", Lirazal);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerChampionQuest), Lirazal);
            AddBehaviour(a);
			...
			if (Lirazal!=null) {
				Lirazal.AddQuestToGive(typeof (DragonslayerChampionQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			Lirazal.RemoveQuestToGive(typeof (DragonslayerChampionQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerChampionQuest)) != null)
				return true;
			...
			player.CharacterClass.ID != (byte) eCharacterClass.Champion && 
				true) {
				return false;			
			}

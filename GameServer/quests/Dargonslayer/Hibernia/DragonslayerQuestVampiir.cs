...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerVampiirQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerVampiirQuest";
		...
		* Constructor
		*/
		public DragonslayerVampiirQuest() : base()
		{
		}

		public DragonslayerVampiirQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerVampiirQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerVampiirQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerVampiirQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerVampiirQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == Lirazal.Name && gArgs.Item.Id_nb == Asiintath_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerVampiirQuest), null);
						...
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerVampiirQuest), null);
	...
	GameNPC[] npcs;
		...
		Asiintath_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Asiintath_Head");
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerVampiirQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerVampiirQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerVampiirQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerVampiirQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerVampiirQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerVampiirQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", Lirazal);
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerVampiirQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Asiintath I shall pay you well!", Lirazal);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerVampiirQuest), Lirazal);
            AddBehaviour(a);
			...
			if (Lirazal!=null) {
				Lirazal.AddQuestToGive(typeof (DragonslayerVampiirQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			Lirazal.RemoveQuestToGive(typeof (DragonslayerVampiirQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerVampiirQuest)) != null)
				return true;

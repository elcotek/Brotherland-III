...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerBlademasterQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerBlademasterQuest";
		...
		private static ItemTemplate dragonslayer_cailiocht_jerkin = null;
		...
		* Constructor
		*/
		public DragonslayerBlademasterQuest() : base()
		{
		}

		public DragonslayerBlademasterQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerBlademasterQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerBlademasterQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerBlademasterQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerBlademasterQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == Lirazal.Name && gArgs.Item.Id_nb == Asiintath_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerBlademasterQuest), null);
						...
						a.AddAction(eActionType.GiveItem, dragonslayer_cailiocht_jerkin, Lirazal);
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerBlademasterQuest), null);
	...
	GameNPC[] npcs;
		...
		Asiintath_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Asiintath_Head");
            ...
            dragonslayer_cailiocht_jerkin = GameServer.Database.FindObjectByKey<ItemTemplate>("Dragonslayer_Cailiocht_Jerkin");
			if (dragonslayer_cailiocht_jerkin == null)
			{
				dragonslayer_cailiocht_jerkin = new ItemTemplate();
                dragonslayer_cailiocht_jerkin.Name = "Dragonslayer Cailiocht Jerkin";
				if (log.IsWarnEnabled)
                    log.Warn("Could not find " + dragonslayer_cailiocht_jerkin + ", creating it ...");
				dragonslayer_cailiocht_jerkin.Level = 51;
				dragonslayer_cailiocht_jerkin.Weight = 38;
				dragonslayer_cailiocht_jerkin.Model = 4094;
				dragonslayer_cailiocht_jerkin.Object_Type = 37;
				dragonslayer_cailiocht_jerkin.Item_Type = 25;
                dragonslayer_cailiocht_jerkin.Id_nb = "Dragonslayer_Cailiocht_Jerkin";
				dragonslayer_cailiocht_jerkin.Hand = 0;
				dragonslayer_cailiocht_jerkin.IsPickable = true;
				dragonslayer_cailiocht_jerkin.IsDropable = true;
				dragonslayer_cailiocht_jerkin.IsTradable = true;
				dragonslayer_cailiocht_jerkin.CanDropAsLoot = true;
				dragonslayer_cailiocht_jerkin.Color = 0;
				dragonslayer_cailiocht_jerkin.Bonus = 35; // default bonus				
				dragonslayer_cailiocht_jerkin.Bonus1 = 22;
				dragonslayer_cailiocht_jerkin.Bonus1Type = (int) 1;
				dragonslayer_cailiocht_jerkin.Bonus2 = 22;
				dragonslayer_cailiocht_jerkin.Bonus2Type = (int) 4;
				dragonslayer_cailiocht_jerkin.Bonus3 = 5;
				dragonslayer_cailiocht_jerkin.Bonus3Type = (int) 11;
				dragonslayer_cailiocht_jerkin.Bonus4 = 5;
				dragonslayer_cailiocht_jerkin.Bonus4Type = (int) 15;
				dragonslayer_cailiocht_jerkin.Bonus5 = 5;
				dragonslayer_cailiocht_jerkin.Bonus5Type = (int) 13;
				dragonslayer_cailiocht_jerkin.Bonus6 = 4;
				dragonslayer_cailiocht_jerkin.Bonus6Type = (int) 164;
				dragonslayer_cailiocht_jerkin.Bonus7 = 5;
				dragonslayer_cailiocht_jerkin.Bonus7Type = (int) 200;
				dragonslayer_cailiocht_jerkin.Bonus8 = 0;
				dragonslayer_cailiocht_jerkin.Bonus8Type = (int) 0;
				dragonslayer_cailiocht_jerkin.Bonus9 = 0;
				dragonslayer_cailiocht_jerkin.Bonus9Type = (int) 0;
				dragonslayer_cailiocht_jerkin.Bonus10 = 0;
				dragonslayer_cailiocht_jerkin.Bonus10Type = (int) 0;
				dragonslayer_cailiocht_jerkin.ExtraBonus = 0;
				dragonslayer_cailiocht_jerkin.ExtraBonusType = (int) 0;
				dragonslayer_cailiocht_jerkin.Effect = 0;
				dragonslayer_cailiocht_jerkin.Emblem = 0;
				dragonslayer_cailiocht_jerkin.Charges = 0;
				dragonslayer_cailiocht_jerkin.MaxCharges = 0;
				dragonslayer_cailiocht_jerkin.SpellID = 0;
				dragonslayer_cailiocht_jerkin.ProcSpellID = 49022;
				dragonslayer_cailiocht_jerkin.Type_Damage = 0;
				dragonslayer_cailiocht_jerkin.Realm = 0;
				dragonslayer_cailiocht_jerkin.MaxCount = 1;
				dragonslayer_cailiocht_jerkin.PackSize = 1;
				dragonslayer_cailiocht_jerkin.Extension = 5;
				dragonslayer_cailiocht_jerkin.Quality = 100;				
				dragonslayer_cailiocht_jerkin.Condition = 50000;
				dragonslayer_cailiocht_jerkin.MaxCondition = 50000;
				dragonslayer_cailiocht_jerkin.Durability = 50000;
				dragonslayer_cailiocht_jerkin.MaxDurability = 0;
				dragonslayer_cailiocht_jerkin.PoisonCharges = 0;
				dragonslayer_cailiocht_jerkin.PoisonMaxCharges = 0;
				dragonslayer_cailiocht_jerkin.PoisonSpellID = 0;
				dragonslayer_cailiocht_jerkin.ProcSpellID1 = 30026;
				dragonslayer_cailiocht_jerkin.SpellID1 = 0;
				dragonslayer_cailiocht_jerkin.MaxCharges1 = 0;
				dragonslayer_cailiocht_jerkin.Charges1 = 0;
				
				//You don't have to store the created item in the db if you don't want,
				//it will be recreated each time it is not found, just comment the following
				//line if you rather not modify your database
				if (SAVE_INTO_DATABASE)
					GameServer.Database.AddObject(dragonslayer_cailiocht_jerkin);
				}
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerBlademasterQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerBlademasterQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerBlademasterQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerBlademasterQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerBlademasterQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerBlademasterQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", Lirazal);
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerBlademasterQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Asiintath I shall pay you well!", Lirazal);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerBlademasterQuest), Lirazal);
            AddBehaviour(a);
			...
			if (Lirazal!=null) {
				Lirazal.AddQuestToGive(typeof (DragonslayerBlademasterQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			Lirazal.RemoveQuestToGive(typeof (DragonslayerBlademasterQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerBlademasterQuest)) != null)
				return true;
			...
			player.CharacterClass.ID != (byte) eCharacterClass.Blademaster && 
				true) {
				return false;			
			}

...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerMentalistQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerMentalistQuest";
		...
		* Constructor
		*/
		public DragonslayerMentalistQuest() : base()
		{
		}

		public DragonslayerMentalistQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerMentalistQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerMentalistQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerMentalistQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerMentalistQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == Lirazal.Name && gArgs.Item.Id_nb == Asiintath_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerMentalistQuest), null);
						...
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerMentalistQuest), null);
	...
	GameNPC[] npcs;
		...
		Asiintath_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Asiintath_Head");
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerMentalistQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerMentalistQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerMentalistQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerMentalistQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerMentalistQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerMentalistQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", Lirazal);
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerMentalistQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Asiintath I shall pay you well!", Lirazal);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerMentalistQuest), Lirazal);
            AddBehaviour(a);
			...
			if (Lirazal!=null) {
				Lirazal.AddQuestToGive(typeof (DragonslayerMentalistQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			Lirazal.RemoveQuestToGive(typeof (DragonslayerMentalistQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerMentalistQuest)) != null)
				return true;

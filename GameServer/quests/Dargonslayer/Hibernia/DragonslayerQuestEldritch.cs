...
using DOL.AI.Brain;
	 ...
	 * BaseQuest	  	 
	 */
	public class DragonslayerEldritchQuest : BaseQuest
	{
		/// <summary>
		...
		*/
		...
		protected const string questTitle = "DragonslayerEldritchQuest";
		...
		* Constructor
		*/
		public DragonslayerEldritchQuest() : base()
		{
		}

		public DragonslayerEldritchQuest(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public DragonslayerEldritchQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonslayerEldritchQuest(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			QuestBehaviour a;
			QuestBuilder builder = QuestMgr.getBuilder(typeof(DragonslayerEldritchQuest));

			GamePlayer player = sender as GamePlayer;

			if (player == null || player.IsDoingQuest(typeof(DragonslayerEldritchQuest)) == null)
				return;
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == Lirazal.Name && gArgs.Item.Id_nb == Asiintath_Head.Id_nb)
				{
					...
					if (player.Inventory.IsSlotsFree(6, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
					{
						...
						a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerEldritchQuest), null);
						...
						a.AddAction(eActionType.FinishQuest, typeof(DragonslayerEldritchQuest), null);
	...
	GameNPC[] npcs;
		...
		Asiintath_Head = GameServer.Database.FindObjectByKey<ItemTemplate>("Asiintath_Head");
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerEldritchQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerEldritchQuest), null, (eComparator)5);
            ...
            a.AddRequirement(eRequirementType.QuestGivable, typeof(DragonslayerEldritchQuest), Lirazal);
            a.AddRequirement(eRequirementType.QuestPending, typeof(DragonslayerEldritchQuest), null, (eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(DragonslayerEldritchQuest), "Helen has offered you the Dragonslayer quest.?Do you accept?");
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.DeclineQuest, null, typeof(DragonslayerEldritchQuest));
            a.AddAction(eActionType.Talk, "No problem. See you", Lirazal);
            AddBehaviour(a);

            a = builder.CreateBehaviour(Lirazal, -1);
            a.AddTrigger(eTriggerType.AcceptQuest, null, typeof(DragonslayerEldritchQuest));
            a.AddAction(eActionType.Talk, "If you bring me the head of Asiintath I shall pay you well!", Lirazal);
            a.AddAction(eActionType.GiveQuest, typeof(DragonslayerEldritchQuest), Lirazal);
            AddBehaviour(a);
			...
			if (Lirazal!=null) {
				Lirazal.AddQuestToGive(typeof (DragonslayerEldritchQuest));
			}
			if (log.IsInfoEnabled)
		...
		{			
			...
			Lirazal.RemoveQuestToGive(typeof (DragonslayerEldritchQuest));
		}
		...
		*/
		...
		{		
			...
			if (player.IsDoingQuest(typeof (DragonslayerEldritchQuest)) != null)
				return true;

...
{
    public class BrokenTabletToMid : BaseQuest
    {
        /// <summary>
        ...
        // Constructors
        public BrokenTabletToMid()
            : base()
        {
        }

        public BrokenTabletToMid(GamePlayer questingPlayer)
            : base(questingPlayer)
        {
        }

        public BrokenTabletToMid(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public BrokenTabletToMid(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            GameNPC[] npcs = WorldMgr.GetNPCsByName("Glycon", eRealm.Midgard);
            ...
            if (npcs.Length == 0)
            {
                ...
                npcsGlycon.Realm = eRealm.Midgard;
                npcsGlycon.CurrentRegionID = 30;
                npcsGlycon.Size = 50;
                npcsGlycon.Level = 46;
                npcsGlycon.X = 344202;
                npcsGlycon.Y = 559207;
            ...
            npcs = WorldMgr.GetNPCsByName("Alyciana", eRealm.Midgard);
            ...
            if (npcs.Length == 0)
            {
                ...
                npcsAlyciana.Realm = eRealm.Midgard;
                npcsAlyciana.CurrentRegionID = 30;
            ...
            if (npcs.Length == 0)
            {
                ...
                MelosBladeWarrior.CurrentRegionID = 30;
            ...
            if (npcs.Length == 0)
            {
                ...
                NaxosMarrowMage.CurrentRegionID = 30;
            ...
            if (npcs.Length == 0)
            {
                ...
                npcsBryseia.CurrentRegionID = 30;
                npcsBryseia.Size = 54;
            ...
            npcsGlycon.AddQuestToGive(typeof(BrokenTabletToMid));
        ...
        public static void ScriptUnloaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            npcsGlycon.RemoveQuestToGive(typeof(BrokenTabletToMid));
        }
        ...
        protected static void TalkToGlycon(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (npcsGlycon.CanGiveQuest(typeof(BrokenTabletToMid), player) <= 0)
                return;

            //We also check if the player is already doing the quest
            BrokenTabletToMid quest = player.IsDoingQuest(typeof(BrokenTabletToMid)) as BrokenTabletToMid;
            ...
            else if (e == GameLivingEvent.WhisperReceive)
            {
                ...
                if (quest == null)
                {
                    ...
                    {
                        case "Alyciana":
                            player.Out.SendQuestSubscribeCommand(npcsGlycon, QuestMgr.GetIDForQuestType(typeof(BrokenTabletToMid)), "Will you help Alyciana [Quest Broken Tablet of Atlantis level 45-48]?");
                            break;
                    }
                }
                else
        ...
        protected static void TalkToAlyciana(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (player.IsDoingQuest(typeof(BrokenTabletToMid)) == null)
                return;
        ...
        protected static void SubscribeQuest(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(BrokenTabletToMid)))
                return;
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            else
            {
                ...
                if (!npcsGlycon.GiveQuest(typeof(BrokenTabletToMid), player, 1))
                    return;
               ...
               */
                ...
                if (npcsAlyciana.CanGiveQuest(typeof(BrokenTabletToMid), player) <= 0)
                    return;
                ...
                {
                    //Check if we can add the quest!
                    if (!npcsAlyciana.GiveQuest(typeof(BrokenTabletToMid), player, 2))
                        return;
        ...
        public override void Notify(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (player == null || player.IsDoingQuest(typeof(BrokenTabletToMid)) == null)
                return;

	...
	GameNPC[] npcs;
		...
		bronze_short_sword = GameServer.Database.FindObjectByKey<ItemTemplate>("bronze_short_sword");
			...
			if (sveabone_hilt_sword == null)
			{
                ...
                sveabone_hilt_sword.DPS_AF = 18;
                sveabone_hilt_sword.SPD_ABS = 30;
				...
				sveabone_hilt_sword.Bonus = 5; // default bonus				
        ...
        a = builder.CreateBehaviour(Gridash,-1);
				a.AddTrigger(eTriggerType.EnemyKilled,"young sveawolf",null);
		...
		*/
		public override string Description
		{
			...
			switch (Step)
			{
					...
					case 2:
                        return "[Step #2] Kill a or more young sveawolf's and return to Gridash with it's tooth.";

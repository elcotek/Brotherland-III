...
namespace DOL.GS.Quests.Midgard
{
    ...
    public class StolenEggs : BaseDalikorQuest
    {
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
			...
			*/
            ...
            if (npcs.Length == 0)
            {
                ...
                {
                    Model = 9,
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE, "Mid.StolenEggs.NPCVikingHyndla")
                };
            ...
            if (npcs.Length == 0)
            {
                ...
                {
                    Model = 158,
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE, "Mid.StolenEggs.NPCGriffinHandlerNjiedi")
                };
                if (log.IsWarnEnabled)
            ...
            if (npcs.Length == 0)
            {
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE, "Mid.StolenEggs.NPCAskefruerTrainer"),
                    X = GameLocation.ConvertLocalXToGlobalX(54739, 100),
                    Y = GameLocation.ConvertLocalYToGlobalY(18264, 100),
                    Z = 5195,
                    Heading = 79,
                    Model = 678,
            ...
            if (recruitsVest == null)
            {
                ...
                {
                    Name = "Recruit's Studded Vest (Mid)"
                };
                if (log.IsWarnEnabled)
        ...
        protected void InitGrifflet()
        {
            ...
            {
                Model = 1236,
                Name = LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE, "Mid.StolenEggs.InitGrifflet.NPCGrifflet")
            };

...
namespace DOL.GS.Quests.Midgard
{
    ...
    public class ImportantDelivery : BaseDalikorQuest
    {
        ...
        public ImportantDelivery()
            : base()
        {
        }

        public ImportantDelivery(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public ImportantDelivery(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public ImportantDelivery(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            ticketToHaggerfel = CreateTicketTo("Haggerfel", "HS_Mularn_Haggerfel");
            ticketToVasudheim = CreateTicketTo("Vasudheim", "HS_Haggerfel_Vasudheim_Delivery");
        ...
        public override string Description
        {
            get
            {
                switch (Step)
                {
                    ...
                    case 7:
                        return "[Step #7] Give the Stablemaster in Mularn your Ticket and then in Vasudheim hand Harlfug the Crate of Vegetables. If you prefer, you may right click to interact with him first.";
                    case 8:
        ...
        public override void FinishQuest()
        {
            ...
            long money = Money.GetMoney(0, 0, 0, 50, Util.Random(50));

    ...
    public class Nuisances : BaseDalikorQuest
    {
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (recruitsShortSword == null)
            {
                ...
                {
                    Name = "Recruit's Short Sword (Mid)"
                };
                if (log.IsWarnEnabled)
        ...
        protected virtual void CreateAskefruer()
        {
            ...
            {
                Model = 678,
                Name = "Fallen Askefruer",
                GuildName = "Part of " + questTitle + " Quest",
                Realm = eRealm.None,
                CurrentRegionID = askefruerLocation.RegionID,
                Size = 50,
                Level = 4,
                X = askefruerLocation.X + Util.Random(-150, 150),
                Y = askefruerLocation.Y + Util.Random(-150, 150),
                Z = askefruerLocation.Z,
                Heading = askefruerLocation.Heading
            };

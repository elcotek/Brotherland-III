...
namespace DOL.GS.Quests.Midgard
{
    ...
    public class Culmination : BaseDalikorQuest
    {
        ...
        private readonly GameNPC[] recruits = new GameNPC[4];
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                {
                    Name = "Queen Vuuna",
                    X = GameLocation.ConvertLocalXToGlobalX(47071, 100),
                    Y = GameLocation.ConvertLocalYToGlobalY(38934, 100),
                    Z = 4747,
                    Heading = 50,
                    Model = 678,
            ...
            for (int i = 0; i < askefruerSorceress.Length; i++)
            {
                if (askefruerSorceress[i] == null)
                {
                    ...
                    askefruerSorceress[i] = new GameNPC
                    {
                        ...
                        Size = 35,
                        Level = 5,
                        X = queenVuuna.X + Util.Random(30, 150),
                        Y = queenVuuna.Y + Util.Random(30, 150),
                        Z = queenVuuna.Z
                    };
            ...
            if (recruitsGauntlets == null)
            {
                ...
                {
                    Name = "Recruit's Studded Gauntles (Mid)"
                };
                if (log.IsWarnEnabled)
            ...
            if (recruitsJewel == null)
            {
                ...
                {
                    Name = "Recruit's Tarnished Bauble"
                };
                if (log.IsWarnEnabled)
        ...
        protected void CreateBriediClone()
        {
            ...
            if (briediClone == null)
            {
                briediClone = new GameNPC
                {
                    ...
                    Size = 50,
                    Level = 45,
                    X = GameLocation.ConvertLocalXToGlobalX(45394, 100),
                    Y = GameLocation.ConvertLocalYToGlobalY(39768, 100),
                    Z = 4709,
                    Heading = 107
                };
            ...
            for (int i = 0; i < recruits.Length; i++)
            {
                recruits[i] = new GameNPC
                {
                    ...
                    GuildName = "Part of " + questTitle + " Quest",
                    Realm = eRealm.Midgard,
                    CurrentRegionID = briediClone.CurrentRegionID,

                    Size = 50,
                    Level = 6,
                    X = briediClone.X + Util.Random(-150, 150),
                    Y = briediClone.Y + Util.Random(-150, 150),
        ...
        public override void Notify(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (Step == 2 && e == GameLivingEvent.EnemyKilled)
            {
                ...
                if (gArgs.Target.Name.IndexOf(queenVuuna.Name) >= 0)
                {

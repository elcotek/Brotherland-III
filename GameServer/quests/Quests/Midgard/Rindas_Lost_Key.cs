...
namespace DOL.GS.Quests.Midgard
{
    ...
    */
    public class rindaslostkey : BaseQuest
    {
        ...
        * Constructor
        */
        public rindaslostkey()
            : base()
        {
        }

        public rindaslostkey(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public rindaslostkey(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public rindaslostkey(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            a.AddTrigger(eTriggerType.EnemyKilled, "hobgoblin snake-finder", null);

...
namespace DOL.GS.Quests.Midgard
{
    public class childsplay : BaseQuest
    {
        ...
        private static readonly GameLocation Mid_Statue = new GameLocation("Childs Play (Mid)", 489, 27580, 40006, 14483);
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            GameNPC[] npcs = WorldMgr.GetNPCsByName("Charles", (eRealm)2);
            if (npcs.Length == 0)
            {
        ...
        protected static void TalkToCharles(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (e == GameObjectEvent.Interact)
            {
                ...
                if (quest.Step == 2)
                {
                    ...
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "ChildsPlay.TalkToCharles.Text3", questTitle), eChatType.CT_ScreenCenter, eChatLoc.CL_SystemWindow);
            ...
            else if (e == GameLivingEvent.WhisperReceive)
            {
                ...
                if (quest == null)
                {
                    ...
                    {
                        player.Out.SendCustomDialog(LanguageMgr.GetTranslation(player.Client.Account.Language, "ChildsPlay.TalkToCharles.Text7"), new CustomDialogResponse(CheckPlayerAbortQuest));
                    }
                }
            }
        }

    ...
    public class Frontiers : BaseDalikorQuest
    {
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                {
                    Model = 227,
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE, "Mid.Frontiers.NPCScryerIdora"),
                    GuildName = "Part of " + questTitle + " Quest",
                    Realm = eRealm.Midgard,
                    CurrentRegionID = 234,
                    Size = 52,
            ...
            ticketToSvasudFaste = CreateTicketTo("Svasud Faste", "HS_Ticket_to_Svasud_Faste_Frontiers");
            ...
            if (npcs.Length == 0)
            {
                ...
                {
                    Model = 158,
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE, "Mid.Frontiers.NPCGriffinHandlerNjiedi")
                };
            ...
            if (griffin == null)
            {
                ...
                {
                    Model = 1236, // //819;
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE, "Mid.Frontiers.NPCGryphon")
                };
            ...
            if (translatedPlans == null)
            {
                ...
                {
                    Name = "Translated Askefruer Plans"
                };
                if (log.IsWarnEnabled)
            ...
            if (recruitsLegs == null)
            {
                ...
                {
                    Name = "Recruit's Studded Legs (Mid)"
                };
                if (log.IsWarnEnabled)

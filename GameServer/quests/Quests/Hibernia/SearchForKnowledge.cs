	...
	public class SearchForKnowledge : RewardQuest
	{
		...
		private void Init()
		{
			...
			if (RecruitsCloak == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Hib.SearchForKnowledge.Init.Text1")
                };
			...
			if (LetterToEpona == null)
			{
                LetterToEpona = new ItemTemplate
                {
                    ...
                    Model = 499,
                    Extension = 1,
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Hib.SearchForKnowledge.Init.Text2"),
                    Id_nb = "letter_to_epona"
                };

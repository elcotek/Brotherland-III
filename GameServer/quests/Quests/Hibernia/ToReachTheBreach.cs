...
namespace DOL.GS.Quests.Hibernia
{
	public class ToReachTheBreach : RewardQuest
	{
		...
		private static readonly GameLocation Demons_Breach = new GameLocation("Demon's Breach", 200, 354760, 486115, 5973);
		...
		private void Init()
		{
			...
			if (RecruitsIntelligentBelt == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Hib.ToReachTheBreach.Init.Text1"),
			...
			if (RecruitsMightyBelt == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Hib.ToReachTheBreach.Init.Text2"),
                    ...
                    Bonus2 = 3,
                    Bonus2Type = (int)eProperty.Constitution,
                    Bonus3 = 1,
			...
			if (RecruitsPiousBelt == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Hib.ToReachTheBreach.Init.Text3"),
                    ...
                    Bonus1Type = (int)eProperty.Acuity,
                    Bonus2 = 1,
                    Bonus2Type = (int)eProperty.Strength,
                    Bonus3 = 3,

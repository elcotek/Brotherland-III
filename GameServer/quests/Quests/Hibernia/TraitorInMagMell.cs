...
namespace DOL.GS.Quests.Hibernia
{
    ...
    public class TraitorInMagMell : BaseAddrirQuest
    {
        ...
        private static readonly GameLocation legadaEnd = new GameLocation("Lady Legada", 200, 200, 12235, 8713, 5304, 218);
        private static readonly GameLocation legadaStart = new GameLocation("Lady Legada", 200, 330877, 492742, 5439, 2657);
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                ladyLegada = new GameNPC
                {
                    ...
                    Realm = eRealm.None,
                    CurrentRegionID = legadaStart.RegionID,
                    Size = 50,
                    Level = 30,
                    X = legadaStart.X,
                    Y = legadaStart.Y,
                    Z = legadaStart.Z,
                    Heading = legadaStart.Heading
                };
            ...
            if (necklaceOfDoppelganger == null)
            {
                ...
                {
                    Name = "Necklace of the Doppelganger",
                    Level = 2,
                    Weight = 2,
                    Model = 101,

                    Object_Type = (int)eObjectType.Magical,
                    Item_Type = (int)eEquipmentItems.NECK,
                    Id_nb = "necklace_of_the_doppelganger",
                    Price = 0,
                    IsPickable = true,
                    IsDropable = false,
            ...
            if (recruitsBoots == null)
            {
                ...
                {
                    Name = "Recruit's Cailiocht Boots",
                    Level = 7,

                    Weight = 24,
                    Model = 84, // studded Boots

                    DPS_AF = 12, // Armour
                    SPD_ABS = 19, // Absorption

                    Object_Type = (int)eObjectType.Reinforced,
                    Item_Type = (int)eEquipmentItems.FEET,
                    Id_nb = "recruits_cailiocht_boots",
                    Price = Money.GetMoney(0, 0, 0, 10, 0),
                    IsPickable = true,
                    IsDropable = true,
                    Color = 13, // green leather
                ...
                if (item != null && item.Id_nb == necklaceOfDoppelganger.Id_nb)
                {
                    if (player.IsWithinRadius(legadaEnd, 2500))
                    {
                        ...
                        if (!ladyLegada.IsAlive || ladyLegada.ObjectState != GameObject.eObjectState.Active)
                        {
                            ...
                            ladyLegada.PathTo(legadaEnd.X, legadaEnd.Y, legadaEnd.Z, ladyLegada.MaxSpeed);
                        }
                        quest.Step = 3;
                    }
                }

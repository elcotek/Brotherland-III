...
{
    public class WicoessasPropositionToAHIB : BaseQuest
	{
		/// <summary>
        ...
        private static QuestSearchArea searchArea = new QuestSearchArea(typeof(WicoessasPropositionToAHIB), 1, "Use /search to look near the loose stones.", 130, 274096, 527534, 3877);
        /// /excavate command for Hib
        //private static QuestSearchArea searchArea2 = new QuestSearchArea(typeof(WicoessasPropositionToAHIB), 2, "Use /search to look near the loose stones.", 130, 268342, 526566, 3832);
        /// /excavate command for Hib
       // private static QuestSearchArea searchArea3 = new QuestSearchArea(typeof(WicoessasPropositionToAHIB), 2, "Use /search to look near the loose stones.", 130, 290817, 537851, 3467);
        /// /excavate command for Hib
       // private static QuestSearchArea searchArea4 = new QuestSearchArea(typeof(WicoessasPropositionToAHIB), 2, "Use /search to look near the loose stones.", 130, 291497, 527842, 4188);
		...
		// Constructors
		public WicoessasPropositionToAHIB() : base()
		{
            InitializeQuest(null);
		}

        public WicoessasPropositionToAHIB(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
            InitializeQuest(questingPlayer);
        }

		public WicoessasPropositionToAHIB(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
            InitializeQuest(questingPlayer);
		}

        public WicoessasPropositionToAHIB(GamePlayer questingPlayer, DBQuest dbQuest)
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
            ...
            GameNPC[] npcs = WorldMgr.GetNPCsByName("Wicoessa", eRealm.Hibernia);
			...
			if (npcs.Length == 0)
			{
                ...
                npcsWicoessa.Realm = eRealm.Hibernia;
                npcsWicoessa.CurrentRegionID = 130;
           ...
           npcsWicoessa.AddQuestToGive(typeof(WicoessasPropositionToAHIB));
		...
		public static void ScriptUnloaded(DOLEvent e, object sender, EventArgs args)
		{
            ...
            npcsWicoessa.RemoveQuestToGive(typeof(WicoessasPropositionToAHIB));
		}
        ...
        protected static void TalkToWicoessa(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (npcsWicoessa.CanGiveQuest(typeof(WicoessasPropositionToAHIB), player) <= 0)
                return;

            //We also check if the player is already doing the quest
            WicoessasPropositionToAHIB quest = player.IsDoingQuest(typeof(WicoessasPropositionToAHIB)) as WicoessasPropositionToAHIB;
            ...
            else if (e == GameLivingEvent.WhisperReceive)
            {
                ...
                if (quest == null)
                {
                    ...
                    {
                        case "Help":
                            player.Out.SendQuestSubscribeCommand(npcsWicoessa, QuestMgr.GetIDForQuestType(typeof(WicoessasPropositionToAHIB)), "Oh good! please use /search at the the Ruins not far from here.");
                            break;
                    }
                }
                else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
            ...
            if (player.IsDoingQuest(typeof(WicoessasPropositionToAHIB)) != null)
				return true;
		...
		protected static void SubscribeQuest(DOLEvent e, object sender, EventArgs args)
		{
            ...
            if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(WicoessasPropositionToAHIB)))
				return;
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            else
            {
                ...
                if (!npcsWicoessa.GiveQuest(typeof(WicoessasPropositionToAHIB), player, 1))
                    return;
                //step 2
        ...
        public override void Notify(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (player == null || player.IsDoingQuest(typeof(WicoessasPropositionToAHIB)) == null)
                return;
            /*

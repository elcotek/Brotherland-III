	...
	public class MagicalBacklash : RewardQuest
	{
		...
		private void Init()
		{
			...
			if (RecruitsShortSword == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Hib.MagicalBacklash.Init.Text1")
                };
			...
			if (RecruitsDirk == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Hib.MagicalBacklash.Init.Text2")
                };
                if (log.IsWarnEnabled)
			...
			if (RecruitsClub == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Hib.MagicalBacklash.Init.Text3")
                };
                if (log.IsWarnEnabled)
			...
			if (RecruitsStaff == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Hib.MagicalBacklash.Init.Text4")
                };
                if (log.IsWarnEnabled)
            ...
            ItemTemplate nipperwing = new ItemTemplate
            {
                ...
                Model = 551,
                Extension = 1,
                Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Hib.MagicalBacklash.Init.Text5")
            };

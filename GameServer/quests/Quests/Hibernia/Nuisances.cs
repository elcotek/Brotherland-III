...
namespace DOL.GS.Quests.Hibernia
{
    ...
    public class Nuisances : BaseAddrirQuest
    {
        ...
        private static readonly GameLocation sluaghLocation = new GameLocation("sluagh Location", 200, 200, 27416, 4129, 5221, 310);
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (emptyMagicBox == null)
            {
                ...
                {
                    Name = "Empty Wodden Magic Box",

                    Weight = 5,
                    Model = 602,

                    Object_Type = (int)eObjectType.GenericItem,
                    Id_nb = "empty_wodden_magic_box",
            ...
            if (recruitsShortSword == null)
            {
                ...
                {
                    Name = "Recruit's Short Sword (Hib)",
                    Level = 4,

                    Weight = 18,
                    Model = 3, // studded Boots

                    DPS_AF = 24, // Armour
                    SPD_ABS = 30, // Absorption

                    Type_Damage = (int)eDamageType.Slash,
                    Object_Type = (int)eObjectType.Blades,
                    Item_Type = (int)eEquipmentItems.LEFT_HAND,
                    Id_nb = "recruits_short_sword_hib",
                    Price = Money.GetMoney(0, 0, 0, 2, 0),
                    IsPickable = true,
                    IsDropable = true,
                    Color = 46, // green metal
        ...
        protected virtual void CreateSluagh()
        {
            ...
            {
                Model = 603,
                Name = "Sluagh Footsoldier",
                GuildName = "Part of " + questTitle + " Quest",
                Realm = eRealm.None,
                CurrentRegionID = 200,
                Size = 50,
                Level = 4,
                X = sluaghLocation.X + Util.Random(-150, 150),
                Y = sluaghLocation.Y + Util.Random(-150, 150),
                Z = sluaghLocation.Z,
                Heading = sluaghLocation.Heading
            };

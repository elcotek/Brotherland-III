...
namespace DOL.GS.Quests.Albion
{
	...
	public class Collection : BaseFrederickQuest
	{
		...
		private static readonly GameNPC[] general = new GameNPC[3];
		private static readonly String[] generalNames = {"Palearis", "Bohad", "Fluvale"};
		private static readonly GameLocation[] generalLocations = new GameLocation[3];
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			*/
			...
			for (int i = 0; i < general.Length; i++)
			{
				...
				else
				{
                    ...
                    general[i] = new GameNPC
                    {
                        ...
                        Name = generalNames[i],
                        X = generalLocations[i].X,
                        Y = generalLocations[i].Y,
                        Z = generalLocations[i].Z,
                        Heading = generalLocations[i].Heading,

                        GuildName = "Part of " + questTitle + " Quest",
                        Realm = eRealm.None,
                        CurrentRegionID = generalLocations[i].RegionID,
			...
			if (recruitsSleeves == null)
			{
                ...
                {
                    Name = "Recruit's Quilted Sleeves"
                };
                if (log.IsWarnEnabled)

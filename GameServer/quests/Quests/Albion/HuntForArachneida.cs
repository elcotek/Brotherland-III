    ...
    public class HuntForArachneida : BaseQuest
    {
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
			...
			*/
            ...
            if (ringedSpiderChitinTunic == null)
            {
                ...
                {
                    Name = "Ringed Spider Chitin Tunic"
                };
                if (log.IsWarnEnabled)
            ...
            if (bloatedFang == null)
            {
                ...
                bloatedFang = new ItemTemplate
                {
                    ...
                    Weight = 10,
                    Id_nb = "bloated_spider_fang",
                    Name = "Bloated spider fang",
                    Model = 106,
                    IsDropable = false,
                    IsPickable = false
                };
            ...
            if (spiderChitin == null)
            {
                ...
                spiderChitin = new ItemTemplate
                {
                    Object_Type = (int)eObjectType.GenericItem,
                    Weight = 25,
                    Id_nb = "arachneida_spider_chitin",
                    Name = "Arachneida's Chitin",
                    Model = 108,
                    IsDropable = false,
                    IsPickable = false
                };
        ...
        public override void Notify(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (Step == 1 && e == GameLivingEvent.EnemyKilled)
            {
                ...
                if (gArgs.Target.Name.IndexOf("bloated spider") >= 0)
                {
                    if (Util.Chance(50))
                    {
            ...
            if (Step == 2 && e == GameLivingEvent.EnemyKilled)
            {
                ...
                if (gArgs.Target.Name.IndexOf(arachneida.Name) >= 0)

		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			*/
			...
			for (int i = 0; i < fairySorceress.Length; i++)
			{
				if (fairySorceress[i] == null)
				{
                    ...
                    fairySorceress[i] = new GameNPC
                    {
                        ...
                        Size = 35,
                        Level = 5,
                        X = queenTatiana.X + Util.Random(30, 150),
                        Y = queenTatiana.Y + Util.Random(30, 150),
                        Z = queenTatiana.Z
                    };
			...
			if (recruitsGauntlets == null)
			{
                ...
                {
                    Name = "Recruit's Studded Gauntles"
                };
                if (log.IsWarnEnabled)
		...
		protected void CreateDunwynClone()
		{
			...
			if (dunwynClone == null)
			{
                dunwynClone = new GameNPC
                {
                    ...
                    X = GameLocation.ConvertLocalXToGlobalX(8602, 0) + Util.Random(-150, 150),
                    Y = GameLocation.ConvertLocalYToGlobalY(47193, 0) + Util.Random(-150, 150),
                    Z = 2409,
                    Heading = 342
                };
		...
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			...
			if (Step == 2 && e == GameLivingEvent.EnemyKilled)
			{
				...
				//if (gArgs.Target.Name == queenTatiana.Name)
                 if (gArgs.Target.Name.IndexOf(queenTatiana.Name) >= 0)

...
namespace DOL.GS.Quests.Albion
{
    ...
    public class AidingGuardAlakyrr : BaseQuest
    {
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            GameNPC[] npcs = WorldMgr.GetNPCsByName("Guard Alakyrr", eRealm.Albion);
            ...
            if (npcs.Length == 0)
            {
                ...
                //GuardAlakyrr.EquipmentTemplateID = "gxhqz132-554f-k55v-z1b8-f9xhoney1250";
            ...
            if (enchantedtenebrousflask == null)
            {
                ...
                {
                    Name = "enchanted tenebrous flask",
                    Level = 1,
                    Weight = 10,
                    Model = 1610,
                    Object_Type = (int)eObjectType.GenericItem,
                    Id_nb = "enchantedtenebrousflask",
                    Price = 0,
                    IsPickable = false,
                    IsDropable = false,
                    Quality = 100,
            ...
            if (quarterfulltenebrousflask == null)
            {
                ...
                {
                    Name = "quarter full tenebrous flask",
                    Level = 1,
                    Weight = 250,
                    Model = 1610,
                    Object_Type = (int)eObjectType.GenericItem,
                    Id_nb = "fullflaskoftenebrousessence",
                    Price = 0,
                    IsPickable = false,
                    IsDropable = false,
                    Quality = 100,
            ...
            if (halffulltenebrousflask == null)
            {
                ...
                {
                    Name = "half full tenebrous flask",
                    Level = 1,
                    Weight = 250,
                    Model = 1610,
                    Object_Type = (int)eObjectType.GenericItem,
                    Id_nb = "halffulltenebrousflask",
                    Price = 0,
                    IsPickable = false,
                    IsDropable = false,
                    Quality = 100,
            ...
            if (threequarterfulltenebrousflask == null)
            {
                ...
                {
                    Name = "three quarter full tenebrous flask",
                    Level = 1,
                    Weight = 250,
                    Model = 1610,
                    Object_Type = (int)eObjectType.GenericItem,
                    Id_nb = "threequarterfulltenebrousflask",
                    Price = 0,
                    IsPickable = false,
                    IsDropable = false,
                    Quality = 100,
            ...
            if (fullflaskoftenebrousessence == null)
            {
                ...
                {
                    Name = "full flask of tenebrous essence",
                    Level = 1,
                    Weight = 250,
                    Model = 1610,
                    Object_Type = (int)eObjectType.GenericItem,

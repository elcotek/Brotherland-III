        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
			...
			*/
            ...
            if (letterToElvar == null)
            {
                ...
                {
                    Name = "Letter to Elvar",
                    Level = 0,
                    Weight = 10,
                    Model = 499,

                    Object_Type = (int)eObjectType.GenericItem,
                    Id_nb = "letter_to_elvar_tambor",
                    Price = 0,
                    IsPickable = false,
                    IsDropable = false,
            ...
            if (letterToYdenia == null)
            {
                ...
                {
                    Name = "Letter to Ydenia",
                    Level = 0,
                    Weight = 10,
                    Model = 499,

                    Object_Type = (int)eObjectType.GenericItem,
                    Id_nb = "letter_to_yderia_philpott",
                    Price = 0,
                    IsPickable = false,
                    IsDropable = false,
            ...
            if (silverRingOfHealth == null)
            {
                ...
                silverRingOfHealth = new ItemTemplate
                {
                    ...
                    Item_Type = (int)eEquipmentItems.L_RING,
                    Id_nb = "silver_ring_of_health",
                    ...
                    Bonus1 = 8,
                    Bonus2Type = (int)eProperty.Resist_Slash,
                    Bonus2 = 1,

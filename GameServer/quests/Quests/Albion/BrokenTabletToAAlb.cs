...
{
    public class BrokenTabletToAlb : BaseQuest
    {
        /// <summary>
        ...
        // Constructors
        public BrokenTabletToAlb()
            : base()
        {
        }

        public BrokenTabletToAlb(GamePlayer questingPlayer)
            : base(questingPlayer)
        {
        }

        public BrokenTabletToAlb(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public BrokenTabletToAlb(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            GameNPC[] npcs = WorldMgr.GetNPCsByName("Glycon", eRealm.Albion);
            ...
            if (npcs.Length == 0)
            {
                ...
                npcsGlycon.Realm = eRealm.Albion;
                npcsGlycon.CurrentRegionID = 73;
                npcsGlycon.Size = 50;
                npcsGlycon.Level = 46;
                npcsGlycon.X = 344202;
                npcsGlycon.Y = 559207;
            ...
            npcs = WorldMgr.GetNPCsByName("Alyciana", eRealm.Albion);
            ...
            if (npcs.Length == 0)
            {
                ...
                npcsAlyciana.Realm = eRealm.Albion;
                npcsAlyciana.CurrentRegionID = 73;
            ...
            if (npcs.Length == 0)
            {
                ...
                MelosBladeWarrior.CurrentRegionID = 73;
            ...
            if (npcs.Length == 0)
            {
                ...
                NaxosMarrowMage.CurrentRegionID = 73;
            ...
            if (npcs.Length == 0)
            {
                ...
                npcsBryseia.CurrentRegionID = 73;
                npcsBryseia.Size = 54;
            ...
            npcsGlycon.AddQuestToGive(typeof(BrokenTabletToAlb));
        ...
        public static void ScriptUnloaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            npcsGlycon.RemoveQuestToGive(typeof(BrokenTabletToAlb));
        }
        ...
        protected static void TalkToGlycon(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (npcsGlycon.CanGiveQuest(typeof(BrokenTabletToAlb), player) <= 0)
                return;

            //We also check if the player is already doing the quest
            BrokenTabletToAlb quest = player.IsDoingQuest(typeof(BrokenTabletToAlb)) as BrokenTabletToAlb;
            ...
            else if (e == GameLivingEvent.WhisperReceive)
            {
                ...
                if (quest == null)
                {
                    ...
                    {
                        case "Alyciana":
                            player.Out.SendQuestSubscribeCommand(npcsGlycon, QuestMgr.GetIDForQuestType(typeof(BrokenTabletToAlb)), "Will you help Alyciana [Quest Broken Tablet of Atlantis level 45-48]?");
                            break;
                    }
                }
                else
        ...
        protected static void TalkToAlyciana(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (player.IsDoingQuest(typeof(BrokenTabletToAlb)) == null)
                return;
        ...
        protected static void SubscribeQuest(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(BrokenTabletToAlb)))
                return;
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            else
            {
                ...
                if (!npcsGlycon.GiveQuest(typeof(BrokenTabletToAlb), player, 1))
                    return;
               ...
               */
                ...
                if (npcsAlyciana.CanGiveQuest(typeof(BrokenTabletToAlb), player) <= 0)
                    return;
                ...
                {
                    //Check if we can add the quest!
                    if (!npcsAlyciana.GiveQuest(typeof(BrokenTabletToAlb), player, 2))
                        return;
        ...
        public override void Notify(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (player == null || player.IsDoingQuest(typeof(BrokenTabletToAlb)) == null)
                return;

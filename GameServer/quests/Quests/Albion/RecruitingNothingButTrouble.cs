	...
	public class RecruitingNothingButTrouble : RewardQuest
	{
		...
		private void Init()
		{
			...
			if (RecruitsShortSword == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.RecruitingNothingButTrouble.Init.Text1")
                };
			...
			if (RecruitsDirk == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.RecruitingNothingButTrouble.Init.Text2")
                };
                if (log.IsWarnEnabled)
			...
			if (RecruitsMace == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.RecruitingNothingButTrouble.Init.Text3")
                };
                if (log.IsWarnEnabled)
			...
			if (RecruitsStaff == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.RecruitingNothingButTrouble.Init.Text4")
                };
                if (log.IsWarnEnabled)
            ...
            ItemTemplate rhedasword = new ItemTemplate
            {
                ...
                Model = 3,
                Extension = 1,
                Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.RecruitingNothingButTrouble.Init.Text5")
            };

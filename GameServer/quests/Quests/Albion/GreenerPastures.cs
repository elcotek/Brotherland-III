...
namespace DOL.GS.Quests.Albion
{
    ...
    public class GreenerPastures : BaseQuest
    {
        ...
        private static readonly GameLocation firstField = new GameLocation("First Field", 1, 568278, 504052, 2168);
        private static readonly GameLocation secondField = new GameLocation("Second Field", 1, 573718, 509044, 2192);
        private static readonly GameLocation thirdField = new GameLocation("Third Field", 1, 577336, 513324, 2169);

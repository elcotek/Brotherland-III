...
namespace DOL.GS.Quests.Albion
{
    ...
    public class RevengeTheOtherWhiteMeat : BaseQuest
    {
        ...
        private static readonly GameLocation wilburSpawnLocation = new GameLocation("Wilbur Location", 1, 500646, 491255, 2298);
            ...
            if (e == GameLivingEvent.EnemyKilled)
            {
                if (Step == 2)
                {
                    ...
                    if (gArgs.Target.Name == "Wilbur")
                    {
                        ...
                        pigHerderWyatt.PathTo(gArgs.Target.X - 90, gArgs.Target.Y + 90, gArgs.Target.Z, 200);
        ...
        protected void OnCloseToDeadWilbur(DOLEvent e, object n, EventArgs args)
        {
            ...
            if (pigHerderWyatt != null)
            {
                ...
                {
                    Callback = new RegionTimerCallback(OnCloseToDeadWilburCallBack)
                };
        ...
        public int OnCloseToDeadWilburCallBack(RegionTimer timer)
        {
            ...
            if (pigHerderWyatt != null)
            {
                ...
                pigHerderWyatt.PathTo(wilburSpawnLocation.X - 1000, wilburSpawnLocation.Y + 1500, wilburSpawnLocation.Z, 200);
            }
            return 0;
        }

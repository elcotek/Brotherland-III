...
namespace DOL.GS.Quests.Albion
{
    ...
    public class ImportantDelivery : BaseFrederickQuest
    {
        ...
        public override void FinishQuest()
        {
            ...
            m_questPlayer.GainExperience(GameLiving.eXPSource.Quest, 120, true);
            long money = Money.GetMoney(0, 0, 5, 50, Util.Random(50));

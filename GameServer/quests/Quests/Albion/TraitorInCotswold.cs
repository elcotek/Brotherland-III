...
namespace DOL.GS.Quests.Albion
{
    ...
    public class TraitorInCotswold : BaseFrederickQuest
    {
        ...
        private static readonly GameLocation felinEnd = new GameLocation("Lady Felin", 1, 558999, 514944, 2628, 2332);
        private static readonly GameLocation felinStart = new GameLocation("Lady Felin", 1, 558846, 516434, 2519, 2332);
			...
			*/
            ...
            if (recruitsBoots == null)
            {
                ...
                recruitsBoots = new ItemTemplate
                {
                    ...
                    Object_Type = (int)eObjectType.Studded,
                    Item_Type = (int)eEquipmentItems.FEET,
                    Id_nb = "recruits_studded_boots",
                    Price = Money.GetMoney(0, 0, 0, 10, 0),
                    IsPickable = true,
                    IsDropable = true,
                    Color = 9, // red leather

                    Bonus = 5, // default bonus
                ...
                if (item != null && item.Id_nb == necklaceOfDoppelganger.Id_nb)
                {
                    if (player.IsWithinRadius(felinEnd, 2500))
                    {
                        ...
                        if (!ladyFelin.IsAlive || ladyFelin.ObjectState != GameObject.eObjectState.Active)
                        {
                            ...
                            ladyFelin.AddToWorld();
                            ladyFelin.PathTo(felinEnd.X, felinEnd.Y, felinEnd.Z, ladyFelin.MaxSpeed);
                        }
                        quest.Step = 3;
                    }
                }

...
namespace DOL.GS.Quests.Albion
{
    ...
    public class IreFairyIre : BaseFrederickQuest
    {
        ...
        private static readonly ItemTemplate dustyOldMap = null;
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
			...
			*/
            ...
            if (npcs.Length == 0)
            {
                ...
                fairyDragonflyHandler.BodyType = 88;
            ...
            if (e == GameObjectEvent.Interact)
            {
                if (quest != null)
                {
                    ...
                    else if (quest.Step == 6)
                    {
                        ...
                        {
                            if (player != null && recruitsVest != null)
                            {
                                GiveItem(colm, player, recruitsVest);
                            }
                        }
                        else
                                if (player != null && recruitsQuiltedVest != null)
                        {

...
namespace DOL.GS.Quests.Albion
{
    ...
    public class Frontiers : BaseFrederickQuest
    {
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            dragonflyTicket = CreateTicketTo("ticket to Castle Sauvage", "hs_src_castlesauvage");
            horseTicket = CreateTicketTo("ticket to Camelot Hills", "HS_CastleSauvage_CamlotEst");
            ...
            if (npcs.Length == 0)
            {
                ...
                {
                    Model = 78,
                    Name = "Dragonfly Handler Colm",
                    GuildName = "Stable Master",
                    Realm = eRealm.Albion,
                    CurrentRegionID = 1,
                    Size = 51,
                    Level = 50
            ...
            if (translatedPlans == null)
            {
                ...
                {
                    Name = "Translated Ire Fairy Plans",
                    ...
                    Id_nb = "translated_ire_fairy_plans",
                    IsPickable = true,
                    IsDropable = false
                };
            ...
            if (recruitsLegs == null)
            {
                ...
                {
                    Name = "Recruit's Studded Legs",
                    Level = 7,

                    Weight = 42,
                    Model = 82, // Studded Legs

                    DPS_AF = 10, // Armour
                    SPD_ABS = 19, // Absorption

                    Object_Type = (int)eObjectType.Studded,
                    Item_Type = (int)eEquipmentItems.LEGS,
                    Id_nb = "recruits_studded_legs",
                    ...
                    Bonus1 = 10,
                    Bonus1Type = (int)eProperty.MaxHealth, // hit

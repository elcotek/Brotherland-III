    ...
    public class NoHopeForTheHopeful : RewardQuest
    {
        ...
        private void Init()
        {
            ...
            if (intelligentBracer == null)
            {
                ...
                intelligentBracer.Name = "intelligent Bracer";
            ...
            if (mightyBracer == null)
            {
                ...
                mightyBracer.Name = "mighty Bracer";
        ...
        private ItemTemplate CreateBracer()
        {
            ItemTemplate template = new ItemTemplate
            {
                ...
                CanDropAsLoot = false,
                IsTradable = true,
                Price = Money.GetMoney(0, 0, 0, 0, 22),
                MaxCount = 1,
                PackSize = 1,
                Realm = 1
            };

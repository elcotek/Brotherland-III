...
namespace DOL.GS.Quests.Albion
{
    ...
    public class GodelevasNeed : BaseQuest
    {
        ...
        private static readonly GameLocation cotswoldVillageBridge = new GameLocation("Bridge Location", 1, 557671, 512396, 1876);
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
			...
			*/
            ...
            if (fullWoodenBucket == null)
            {
                ...
                {
                    Name = "Full Wooden Bucket",
                    Level = 1,
                    Weight = 250,
                    Model = 1610,

                    Object_Type = (int)eObjectType.GenericItem,
                    Id_nb = "full_wooden_bucket",
                    Price = 0,
                    IsPickable = false,
                    IsDropable = false,
            ...
            if (reedBracer == null)
            {
                ...
                reedBracer = new ItemTemplate
                {
                    ...
                    Item_Type = (int)eEquipmentItems.L_BRACER,
                    Id_nb = "reed_bracer",

                    Price = Money.GetMoney(0, 0, 0, 0, 30),
                    IsPickable = true,
                    IsDropable = true,
                    ...
                    Bonus1 = 8,
                    Bonus2Type = (int)eProperty.Resist_Cold,
                    Bonus2 = 1,

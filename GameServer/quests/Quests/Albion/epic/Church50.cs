	...
	public class Church_50 : BaseQuest
	{
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			if (statue_of_arawn == null)
			{
                ...
                {
                    Id_nb = "statue_of_arawn",
                    Name = "Statue of Arawn",
                    Level = 8,
                    Item_Type = 29,
                    Model = 593,
                    IsDropable = false,
...
// end item
			...
			if (ClericEpicBoots == null)
			{
                ...
                i = new ItemTemplate
                {
                    Id_nb = "ClericEpicBoots",
                    Name = "Boots of Defiant Soul",
                    Level = 50,
                    Item_Type = 23,
                    Model = 717,
                    IsDropable = true,
...
//end item
			...
			if (ClericEpicHelm == null)
			{
                ...
                i = new ItemTemplate
                {
                    Id_nb = "ClericEpicHelm",
                    Name = "Coif of Defiant Soul",
                    Level = 50,
                    Item_Type = 21,
                    ...
                    Bonus1 = 4,
                    Bonus1Type = (int)eProperty.Focus_Enchantments,
...
//end item
			...
			if (ClericEpicGloves == null)
			{
                ...
                i = new ItemTemplate
                {
                    Id_nb = "ClericEpicGloves",
                    Name = "Gauntlets of Defiant Soul",
                    Level = 50,
                    Item_Type = 22,
                    Model = 716,
                    IsDropable = true,
                    ...
                    Bonus1 = 4,
                    Bonus1Type = (int)eProperty.Skill_Smiting,
			...
			if (ClericEpicVest == null)
			{
                ...
                i = new ItemTemplate
                {
                    Id_nb = "ClericEpicVest",
                    Name = "Habergeon of Defiant Soul",
                    Level = 50,
                    Item_Type = 25,
                    Model = 713,
                    IsDropable = true,
			...
			if (ClericEpicLegs == null)
			{
                ...
                i = new ItemTemplate
                {
                    Id_nb = "ClericEpicLegs",
                    Name = "Chaussess of Defiant Soul",
                    Level = 50,
                    Item_Type = 27,
                    Model = 714,
                    IsDropable = true,
                    ...
                    Bonus1 = 4,
                    Bonus1Type = (int)eProperty.Skill_Rejuvenation,
			...
			if (ClericEpicArms == null)
			{
                ...
                i = new ItemTemplate
                {
                    Id_nb = "ClericEpicArms",
                    Name = "Sleeves of Defiant Soul",
                    Level = 50,
                    Item_Type = 28,
                    Model = 715,
                    IsDropable = true,
			...
			if (PaladinEpicBoots == null)
			{
                ...
                i = new ItemTemplate
                {
                    Id_nb = "PaladinEpicBoots",
                    Name = "Sabaton of the Iron Will",
                    Level = 50,
                    Item_Type = 23,
                    Model = 697,
                    IsDropable = true,
...
//end item
			...
			if (PaladinEpicHelm == null)
			{
                ...
                i = new ItemTemplate
                {
                    Id_nb = "PaladinEpicHelm",
                    Name = "Hounskull of the Iron Will",
                    Level = 50,
                    Item_Type = 21,
                    Model = 1290, //NEED TO WORK ON..
                    IsDropable = true,
...
//end item
			...
			if (PaladinEpicGloves == null)
			{
                ...
                i = new ItemTemplate
                {
                    Id_nb = "PaladinEpicGloves",
                    Name = "Gauntlets of the Iron Will",
                    Level = 50,
                    Item_Type = 22,
                    Model = 696,
                    IsDropable = true,
			...
			if (PaladinEpicVest == null)
			{
                ...
                i = new ItemTemplate
                {
                    Id_nb = "PaladinEpicVest",
                    Name = "Curiass of the Iron Will",
                    Level = 50,
                    Item_Type = 25,
                    Model = 693,
                    IsDropable = true,
			...
			if (PaladinEpicLegs == null)
			{
                ...
                i = new ItemTemplate
                {
                    Id_nb = "PaladinEpicLegs",
                    Name = "Greaves of the Iron Will",
                    Level = 50,
                    Item_Type = 27,
                    Model = 694,
                    IsDropable = true,
			...
			if (PaladinEpicArms == null)
			{
                ...
                i = new ItemTemplate
                {
                    Id_nb = "PaladinEpicArms",
                    Name = "Spaulders of the Iron Will",
                    Level = 50,
                    Item_Type = 28,
                    Model = 695,
                    IsDropable = true,
		...
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
            ...
            if (Step == 1 && e == GameLivingEvent.EnemyKilled)
            {
                ...
                if (gArgs != null && gArgs.Target != null && Blythe != null)
                {
                    ...
                    if (gArgs.Target.Name.IndexOf(Blythe.Name) >= 0)
                    {

	...
	public class WhenBloodSpeaks : RewardQuest
	{
		...
		private void Init()
		{
			...
			if (RecruitsQuiltedPants == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.WhenBloodSpeaks.Init.Text1")
                };
			...
			if (RecruitsLeatherLeggings == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.WhenBloodSpeaks.Init.Text2")
                };
                if (log.IsWarnEnabled)
			...
			if (RecruitsStuddedLegs == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.WhenBloodSpeaks.Init.Text3")
                };
                if (log.IsWarnEnabled)
            ...
            ItemTemplate spriggarnBlood = new ItemTemplate
            {
                ...
                Model = 99,
                Extension = 1,
                Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.WhenBloodSpeaks.Init.Text4")
            };
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			if (npcs.Length == 0)
			{
                ...
                {
                    Model = 64,
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE, "Alb.WhenBloodSpeaks.ScriptLoaded.Text1")
                };
                if (log.IsWarnEnabled)

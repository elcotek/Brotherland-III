	...
	public class WhenGoodBrowniesGoBad : RewardQuest
	{
		...
		private void Init()
		{
			...
			if (lightredclothdye == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.WhenGoodBrowniesGoBad.Init.Text1")
                };
			...
			if (lightredleatherdye == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.WhenGoodBrowniesGoBad.Init.Text2")
                };
                if (log.IsWarnEnabled)
			...
			if (lightredenamel == null)
			{
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.WhenGoodBrowniesGoBad.Init.Text3")
                };
                if (log.IsWarnEnabled)
            ...
            ItemTemplate brownieBlood = new ItemTemplate
            {
                ...
                Model = 99,
                Extension = 1,
                Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.WhenGoodBrowniesGoBad.Init.Text4")
            };
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			if (npcs.Length == 0)
			{
                ...
                {
                    Model = 64,
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.WhenGoodBrowniesGoBad.ScriptLoaded.Text1")
                };
                if (log.IsWarnEnabled)

...
namespace DOL.GS.Quests.Albion
{
    public class TombWithAView : RewardQuest
    {
        ...
        private static readonly GameLocation Burial_Tomb = new GameLocation("Burial Tomb", 1, 562679, 517225, 2935);
        ...
        private void Init()
        {
            ...
            if (RecruitsQuiltedBoots == null)
            {
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.TombWithAView.Init.Text1")
                };
            ...
            if (RecruitsLeatherBoots == null)
            {
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.TombWithAView.Init.Text2")
                };
                if (log.IsWarnEnabled)
            ...
            if (RecruitsStuddedBoots == null)
            {
                ...
                {
                    Name = LanguageMgr.GetTranslation(ServerProperties.Properties.DB_LANGUAGE, "Alb.TombWithAView.Init.Text3")
                };
                if (log.IsWarnEnabled)

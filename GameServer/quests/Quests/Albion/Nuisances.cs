...
namespace DOL.GS.Quests.Albion
{
    ...
    public class Nuisances : BaseFrederickQuest
    {
        ...
        private static readonly GameLocation fairyLocation = new GameLocation("Ire Fairy", 1, 561200, 505951, 2405);
        ...
        protected virtual void CreateFairy()
        {
            ireFairy = new GameNPC
            {
                ...
                Size = 50,
                Level = 4,
                X = GameLocation.ConvertLocalXToGlobalX(12336, 0) + Util.Random(-150, 150),
                Y = GameLocation.ConvertLocalYToGlobalY(22623, 0) + Util.Random(-150, 150),
                Z = 2405,
                Heading = 226
            };

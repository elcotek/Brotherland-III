    ...
    public class Alliance
    {
        ...
        public void AddGuild(Guild myguild)
        {
            lock (Guilds.SyncRoot)
            {
                ...
                //Nur adden wenn die gilde nicht schon vorhanden ist!
                if (Guilds.Contains(myguild) == false)
                {
                    ...
                    SendMessageToAllianceMembers(myguild.Name + " is already in the alliance of " + m_dballiance.AllianceName, PacketHandler.eChatType.CT_System, PacketHandler.eChatLoc.CL_SystemWindow);
            }
        }

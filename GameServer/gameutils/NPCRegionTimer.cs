...
namespace DOL.GS
{
    ...
    ///This is the Crafttimer!!!!!!!!!!!
    /// <summary>
    /// This delegate is the callback function for RegionTimers
    /// </summary>
    public delegate int NPCTimerCallback(NPCRegionTimer callingTimer);

    /// <summary>
    /// Calls delegate on every tick
    /// </summary>
    public sealed class NPCRegionTimer : GameTimer
    {
        /// <summary>
        /// The Locking Object
        /// </summary>
        ...
        /// The timer callback
        /// </summary>
        private NPCTimerCallback m_callback;
        ...
        /// </summary>
        public NPCTimerCallback Callback
        {
        ...
        public NPCRegionTimer(GameObject timerOwner)
        ...
        public NPCRegionTimer(GameObject timerOwner, NPCTimerCallback callback)
            : this(timerOwner)
        {
            m_owner = timerOwner;
            m_callback = callback;
        ...
        public NPCRegionTimer(GameObject timerOwner, NPCTimerCallback callback, int delay)
        ...
        public NPCRegionTimer(TimeManager time)
            : base(time)
        {
        }
        ...
        {
            NPCTimerCallback callback = m_callback;
            object target = null;
            if (callback != null)
            {

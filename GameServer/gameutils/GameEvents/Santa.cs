			...
			switch(str)
			{
                ...
                case "Present":
                    if (t.BountyPoints >= 500)
                    {
                        ...
                        if (RandLottery == 1)
                        {
                            t.ReceiveItem(this, "present1", 0);
                            t.RemoveBountyPoints(500); SendReply(t, "Here is your present!");
                        }
                        else if (RandLottery == 2)
                        {
                            t.ReceiveItem(this, "present2", 0);
                            t.RemoveBountyPoints(500); SendReply(t, "Here is your present!");
                        }
                        else if (RandLottery == 3)
                        {
                            t.ReceiveItem(this, "present3", 0);
                            t.RemoveBountyPoints(500); SendReply(t, "Here is your present!");
                        }
                        else if (RandLottery == 4)
                        {
                            t.ReceiveItem(this, "present4", 0);
                            t.RemoveBountyPoints(500); SendReply(t, "Here is your present!");
                        }
                        else if (RandLottery == 5)
                        {
                            t.ReceiveItem(this, "present5", 0);
                            t.RemoveBountyPoints(500); SendReply(t, "Here is your present!");
                        }
                        else if (RandLottery == 6)
                        {
                            t.ReceiveItem(this, "present6", 0);
                            t.RemoveBountyPoints(500); SendReply(t, "Here is your present!");
                        }
                        else if (RandLottery == 7)
                        {
                            t.ReceiveItem(this, "present7", 0);
                            t.RemoveBountyPoints(500); SendReply(t, "Here is your present!");
                        }

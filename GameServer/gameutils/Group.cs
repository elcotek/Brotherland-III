...
namespace DOL.GS
{
    ...
    public class Group
    {
        ...
        public virtual bool AddMember(GameLiving living)
        {
            ...
            SendMessageToGroupMembers(LanguageMgr.GetTranslation(player.Client.Account.Language, "GamePlayer.Group.PlayerHasJoinedTheGroup", living.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
        ...
        public virtual bool RemoveMember(GameLiving living)
        {
            ...
            if (player != null)
            {
                ...
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "GamePlayer.Group.YouLeaveYourGroup"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            ...
            SendMessageToGroupMembers(LanguageMgr.GetTranslation(player.Client.Account.Language, "GamePlayer.Group.HaslLeftYourGroup", living.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            ...
            if (MemberCount > 1 && LivingLeader == living)
            {
                ...
                if (newLeader != null)
                {
                    ...
                    SendMessageToGroupMembers(LanguageMgr.GetTranslation(player.Client.Account.Language, "GamePlayer.Group.IsNewGroupleader", living.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                }
                else
                {
        ...
        public bool MakeLeader(GameLiving living)
        {
            ...
            if (allOk)
            {
                ...
                foreach (GamePlayer player in Leader.Group.GetMembersInTheGroup())
                {
                    if (player != Leader)
                    {
                        SendMessageToGroupMembers(LanguageMgr.GetTranslation(player.Client.Account.Language, "GamePlayer.Group.IsNewGroupleader", living.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);

...
namespace DOL.GS
{
    ...
    public class NpcTemplate : INpcTemplate
	{
        ...
        public NpcTemplate(DBNpcTemplate data)
		{
            ...
            m_npcIsFish = data.NPCIsFish;
            m_yellRange = data.YellRange;
            m_meleeAttackRange = data.MeleeAttackRange;
        }
		...
		public NpcTemplate(GameNPC mob)
		{
            ...
            m_npcIsFish = mob.NPCIsFish;
            m_yellRange = mob.YellRange;
            m_meleeAttackRange = mob.MeleeAttackRange;

...
namespace DOL.GS
{
    ...
    public class CardMgr
    {
        ...
        {    
            private readonly GameClient m_owner;
            private readonly ArrayList m_hand;
        ...
        private static readonly Hashtable m_dealerDecks = new Hashtable();
        private static readonly Hashtable m_playerHands = new Hashtable();

...
namespace DOL.GS.PlayerClass
{
	...
	public class ClassNightshade : ClassStalker
	{
        ...
        public override void OnLevelUp(GamePlayer player, int previousLevel)
        {
            ...
            //RA Ability ToA
            if (player.Level >= 50 && ServerProperties.Properties.ALLOW_OVERCAP)
            {
               // player.AddAbility(SkillBase.GetAbility(Abilities.ShadowStrike));
            }
        }
		...
		public override void OnSkillTrained(GamePlayer player, Specialization skill)
		{
			...
			switch(skill.KeyName)
			{
				case Specs.Stealth:
                    ...
                    if (skill.Level >= 35) player.AddAbility(SkillBase.GetAbility(Abilities.ShadowStrike));

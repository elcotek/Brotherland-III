...
namespace DOL.Events
{
    ...
    public class GameEventMgr
    {
		...
		/// </summary>
		protected static ConcurrentDictionary<object, DOLEventHandlerCollection> m_gameObjectEventCollections;
        ...
        public static int NumObjectHandlers
        {
            ...
            {
                int numHandlers = 0;
                ConcurrentDictionary<object, DOLEventHandlerCollection> cloneGameObjectEventCollections = new ConcurrentDictionary<object, DOLEventHandlerCollection>(m_gameObjectEventCollections);
        ...
        protected GameEventMgr()
        {
            ...
            m_gameObjectEventCollections = new ConcurrentDictionary<object, DOLEventHandlerCollection>();
        ...
        private static void AddHandler(object obj, DOLEvent e, DOLEventHandler del, bool unique)
        {
            ...
            if (Lock.TryEnterUpgradeableReadLock(LOCK_TIMEOUT))
            {
                try
                {
                    ...
                    if (!m_gameObjectEventCollections.TryGetValue(obj, out DOLEventHandlerCollection col))
                    {
                        ...
                        if (Lock.TryEnterWriteLock(LOCK_TIMEOUT))
                        {
                            try
                            {
                                m_gameObjectEventCollections.TryAdd(obj, col);
                            }
                            finally
                            {
                                Lock.ExitWriteLock();
        ...
        public static void RemoveAllHandlersForObject(object obj)
        {
            ...
            if (col != null)
            {
                ...
                if (Lock.TryEnterWriteLock(LOCK_TIMEOUT))
                {
                    try
                    {
                        m_gameObjectEventCollections.TryRemove(obj, out col);
                    }
                    finally
                    {
                        Lock.ExitWriteLock();

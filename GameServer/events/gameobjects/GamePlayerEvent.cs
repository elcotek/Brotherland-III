...
namespace DOL.Events
{
    ...
    public class GamePlayerEvent : GameLivingEvent
	{
        ...
        /// <summary>
		/// The AllOberlisksCaptured event is fired when All Oberlisks Captured, AllOberlisksCaptured or AllOberlisksCaptured properties changes.
		/// </summary>
		public static readonly GamePlayerEvent AllOberlisksCaptured = new GamePlayerEvent("GamePlayer.AllOberlisksCaptured");
        /// <summary>

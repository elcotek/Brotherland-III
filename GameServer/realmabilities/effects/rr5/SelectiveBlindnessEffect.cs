...
namespace DOL.GS.Effects
{
    ...
    public class SelectiveBlindnessEffect : TimedEffect
    {
        ...
        public override void Start(GameLiving target)
        {
            ...
            ((GamePlayer)target).Out.SendMessage("you are stay under the selective blindness effect and can't see this target!", eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        }

...
namespace DOL.GS.SkillHandler
{
	...
	public class RemedyAbility : IAbilityActionHandler
	{
        ...
        public const int REUSE_TIMER = 300;
        /// <summary>
		/// Action
		/// </summary>
        ...
        public void Execute(Ability ab, GamePlayer player)
		{
			...
			if (player != null)
			{
                RemedyEffect re = player.EffectList.GetOfType<RemedyEffect>();
                if (re != null)
                {
                   // player.Out.SendMessage("That ability is already active, wait until it expires and Timer is stop.", eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    return;
                }

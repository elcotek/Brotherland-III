...
namespace DOL.GS.RealmAbilities
{
    ...
    public class SearingPetAbility : RR5RealmAbility
    {
        ...
        public override void AddEffectsInfo(IList<string> list, GamePlayer player)
        {
            ...
            list.Add("");
            list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DelveInfo.Target", "Pet"));
            list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DelveInfo.Duration") + " 18 seconds");

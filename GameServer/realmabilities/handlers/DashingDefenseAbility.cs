...
namespace DOL.GS.RealmAbilities
{
    public class DashingDefenseAbility : TimedRealmAbility
    {
		...
		{
			list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DashingDefenseAbility.AddEffectsInfo.Info1"));
			list.Add("");
			list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DashingDefenseAbility.AddEffectsInfo.Info2"));
			list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DashingDefenseAbility.AddEffectsInfo.Info3"));

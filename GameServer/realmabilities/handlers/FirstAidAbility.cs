...
namespace DOL.GS.RealmAbilities
{
	...
	public class FirstAidAbility : TimedRealmAbility
	{
		...
		{
			list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "FirstAidAbility.AddEffectsInfo.Info1"));
			list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "FirstAidAbility.AddEffectsInfo.Info2"));
			list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "FirstAidAbility.AddEffectsInfo.Info3"));
			list.Add("");
			list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "FirstAidAbility.AddEffectsInfo.Info4"));
			list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "FirstAidAbility.AddEffectsInfo.Info5"));
			list.Add("");
			list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "FirstAidAbility.AddEffectsInfo.Info6"));
        }
	}
}
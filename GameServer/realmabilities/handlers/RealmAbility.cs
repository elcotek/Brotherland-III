...
namespace DOL.GS.RealmAbilities
{
	...
	public class RealmAbility : Ability
	{
		...
		/// </summary>
		/// <param name="w"></param>
		public virtual void AddDelve(DetailDisplayHandler.DelveWriter w, GamePlayer player)
		{
			w.Value("Name", Name);
	...
	public class TimedRealmAbility : RealmAbility
	{
        ...
        public virtual void AddEffectsInfo(IList<string> list, GamePlayer player)
        {

        }
       // public virtual void AddEffectsInfo(IList<string> list, player)
		//{
		//}
        ...
        public override void AddDelve(DetailDisplayHandler.DelveWriter w, GamePlayer player)
		{
			base.AddDelve(w, player);

...
namespace DOL.GS.RealmAbilities
{
    ...
    public class DecimationTrapAbility : TimedRealmAbility
    {
        ...
        public override void AddEffectsInfo(IList<string> list, GamePlayer player)
        {
            ...
            list.Add("");
            list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DelveInfo.Range", " 1500"));
            list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DelveInfo.Radius", " 350"));
            list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DelveInfo.Target", "Ground Target"));
            list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DelveInfo.Duration") + " 30 seconds");
            list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DelveInfo.CastingTime", " 2 seconds"));

...
namespace DOL.GS.Trainer
{
	...
	public class HiberniaMaulerTrainer : GameTrainer
	{
        ...
        public const string WEAPON_ID30 = "maulerhib_item30";
        public const string WEAPON_ID40 = "maulerhib_item40";
        public const string WEAPON_ID45 = "maulerhib_item45";
        ...
        public override bool Interact(GamePlayer player)
		{
			...
			{
				player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "MaulerHibTrainer.Interact.Text2", this.Name, player.Name), eChatType.CT_System, eChatLoc.CL_ChatWindow);
		...
		{
			return (player.Level >= 5 && player.IsCharcterClass(eCharacterClass.Guardian) && (player.Race == (int)eRace.Celt

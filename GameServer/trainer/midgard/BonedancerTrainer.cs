...
namespace DOL.GS.Trainer
{
	...
	public class BonedancerTrainer : GameTrainer
	{
        ...
        public const string WEAPON_ID30 = "Bonedancer_item30";
        public const string WEAPON_ID40 = "Bonedancer_item40";
        public const string WEAPON_ID45 = "Bonedancer_item45";
		...
		public override bool Interact(GamePlayer player)
		{
			...
			{
				player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "BonedancerTrainer.Interact.Text2", this.Name, player.Name), eChatType.CT_System, eChatLoc.CL_ChatWindow);

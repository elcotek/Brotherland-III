...
namespace DOL.GS.Trainer
{
	...
	public class WarlockTrainer : GameTrainer
	{
        ...
        public const string WEAPON_ID30 = "Warlock_item30";
        public const string WEAPON_ID40 = "Warlock_item40";
        public const string WEAPON_ID45 = "Warlock_item45";
		...
		{
			return (player.Level >= 5 && player.IsCharcterClass(eCharacterClass.Mystic) && (player.Race == (int)eRace.Frostalf || player.Race == (int)eRace.Norseman

...
namespace DOL.GS.Trainer
{
	...
	public class ShamanTrainer : GameTrainer
	{
        ...
        /// <summary>
        /// The shaman item template ID
        /// </summary>
        public const string Shaman_Item_ID = "shaman_amor_item";

        public const string WEAPON_ID30 = "Shaman_item30";
        public const string WEAPON_ID40 = "Shaman_item40";
        public const string WEAPON_ID45 = "Shaman_item45";
			...
			switch (text) {
				case "join the House of Ymir":
					...
					if (CanPromotePlayer(player)) {
                        ...
                        player.ReceiveItem(this, Shaman_Item_ID, 0);
                    }
					break;
			}
			return true;

...
namespace DOL.GS.Housing
{
	...
	public static class HousingConstants
	{
        ...
        private static readonly float[][] consignmentPositioning = new[]
                                                                      {
                                                                          null,
        ...
        private static readonly int[][][] relativeHookpointsCoords = new[]
                                                                        {
		                                                            		// NOTHING : Lot
		                                                            		null,
		                                                            		// ALB Cottage (model 1)
        ...
        public static int[][][] RelativeHookpointsCoords
        {
            get
            {
                return RelativeHookpointsCoords1;
            }
        }

        public static float[][] ConsignmentPositioning
        {
            get
            {
                return ConsignmentPositioning1;
            }
        }

        public static int[][][] RelativeHookpointsCoords1 => relativeHookpointsCoords;

        public static float[][] ConsignmentPositioning1 => consignmentPositioning;
    }
}
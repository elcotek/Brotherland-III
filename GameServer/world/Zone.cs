        ...
        internal List<GameObject> GetObjectsInRadius(eGameObjectType type, float x, float y, float z, ushort radius, List<GameObject> partialList)
        {
            ...
            for (int currentLine = minLine; currentLine <= maxLine; ++currentLine)
            {
                ...
                for (int currentColumn = minColumn; currentColumn <= maxColumn; ++currentColumn)
                {
                    ...
                    { // erlauben Sie hier schmutzige Lesevorgänge für eine effizientere und feinkörnige Sperrung später...
                      // die aktuelle Subzone enthält einige Objekte
                        ...
                        if (currentSubZoneIndex == referenceSubzoneIndex)
                        {
                            lock (startElement)
                            {
                                ...
                                // => Überprüfen Sie alle Abstände für alle Objekte in der Subzone
                        ...
                        else
                        {
                            ...
                            if (CheckMinDistance(xInZone, yInZone, xLeft, xRight, yTop, yBottom, sqRadius))
                            {
                                ...
                                {
                                    // Die aktuelle Subzone ist vollständig im Radius enthalten
                                    // => Fügen Sie alle Objekte der aktuellen Subzone hinzu
                                ...
                                else
                                {
                                    ...
                                    // => Fügen Sie nur die Objekte im richtigen Bereich hinzu
            ...
            //
            // Führen Sie die erforderlichen Relokalisierungen durch
            //

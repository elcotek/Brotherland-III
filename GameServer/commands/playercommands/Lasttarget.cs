...
namespace DOL.GS.Commands
{
	...
	public class LastTargetCommandHandler : AbstractCommandHandler, ICommandHandler
	{
		public void OnCommand(GameClient client, string[] args)
		{
			...
			if (args.Length == 2)
			{
				...
				if (targetClient != null)
				{
                    ...
                    //Own realm targets
                    if ((client.Player.IsWithinRadius(targetPlayer, WorldMgr.YELL_DISTANCE) == false) && GameServer.ServerRules.IsAllowedToAttack(client.Player, targetPlayer, false))
                    {
                    ...
                    //Enemy realm targets
                    if ((client.Player.IsWithinRadius(targetPlayer, WorldMgr.YELL_DISTANCE) == false || targetPlayer.IsStealthed || targetPlayer.TargetInView == false) && GameServer.ServerRules.IsAllowedToAttack(client.Player, targetPlayer, true))
					{
						client.Out.SendMessage("You don't see " + args[1] + " around here!", eChatType.CT_System, eChatLoc.CL_SystemWindow);
						return;
					}

    ...
    public class InviteCommandHandler : AbstractCommandHandler, ICommandHandler
    {
        public void OnCommand(GameClient client, string[] args)
        {
            if (client.Player.Group != null && client.Player.Group.Leader != client.Player)
            {
                ...
                client.Player.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "GamePlayer.Group.YouAreNotTheLeader"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return;
            }
            ...
            { // Inviting by target
                if (client.Player.TargetObject == null || client.Player.TargetObject == client.Player)
                {
                    ...
                    client.Player.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "GamePlayer.Group.NoValidPlayeTarget"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    return;
                }
            ...
            { // Inviting by name
                ...
                { // Invalid target or realm restriction
                    ...
                    client.Player.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "GamePlayer.NoPlayersOnlineWithName"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    return;
                }
                if (target == client.Player)
                {
                    //client.Out.SendMessage("You can't invite yourself.", eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    client.Player.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "GamePlayer.CantInviteYourself"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    return;
                }
            }
            ...
            if (target.Group != null)
            {
                ...
                client.Player.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "GamePlayer.PlayerStillInAGroup"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return;
            }
                ...
                target.IsStealthed)
            {
                ...
                client.Player.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "GamePlayer.CantFindPlayerAroundHere"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return;
            }
            ...
            else
            {
                ...
                client.Player.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "GamePlayer.Group.YouHaveInvited", target.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                ...
                target.Out.SendGroupInviteCommand(client.Player, LanguageMgr.GetTranslation(client.Account.Language, "GamePlayer.Group.HasInvitedYou", client.Player.Name, client.Player.GetPronoun(1, false)));
                //client.Player.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "GamePlayer.Group.HasInvitedYou", client.Player.Name, client.Player.GetPronoun(1, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                ...
                target.Out.SendMessage(LanguageMgr.GetTranslation(client.Account.Language, "GamePlayer.Group.HasInvitedYouToJoin", client.Player.Name, client.Player.GetPronoun(1, false)), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }
        }
    }
}
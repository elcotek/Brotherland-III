                ...
                case "loot":
                    {
                        ...
                        else if (args[2] == "treasurer" || args[2] == "treasure" || args[2] == "t" || args[2] == "T" || args[2] == "Treasurer" || args[2] == "Treasure")
                        {
								...
								//client.Out.SendMessage(LanguageMgr.GetTranslation(client, "Sorry, We have deactivated this function at the moment, because it seems there is a Money bug that we have to fix first. "), eChatType.CT_BattleGroup, eChatLoc.CL_SystemWindow);
								//return;
               ...
               case "lootlevel":
                    {
                        ...
                        {
                            mybattlegroup.SetBGLootTypeThreshold(Convert.ToUInt16(args[2]));
                ...
                case "treasurer":
                    {
						...
						if (args[2] == "normal")
                        {
							mybattlegroup.SetBGTreasurer(null);
							client.Out.SendMessage(LanguageMgr.GetTranslation(client, "Scripts.Players.Battlegroup.BattlegroupTreasurerOff"), eChatType.CT_BattleGroup, eChatLoc.CL_SystemWindow);
							return;
						}

	...
	public class CheckLosCommandHandler : AbstractCommandHandler, ICommandHandler
	{
		public async void OnCommand(GameClient client, string[] args)
		{
			...
			if (client.Player.TargetObject != null)
			{
				...
				Vector3 sourcePosition = new Vector3(client.Player.X, client.Player.Y, client.Player.Z);
				...
				text.Add($"Target: {target.Name} (OID: {target.ObjectID}, distance: {Vector3.Distance(targetPosition, sourcePosition)})");

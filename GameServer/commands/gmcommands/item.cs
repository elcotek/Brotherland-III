...
namespace DOL.GS.Commands
{
    [Cmd("&item",
          ...
          "'/item modelinc' Increment the object model by 1",
          "'/item modeldec' Decrement the object model by 1",
          "GMCommands.Item.Usage.Extension",
          "GMCommands.Item.Usage.Color",
          "'/item colorinc' Increment the object color by 1",
          "'/item colordec' Decrement the object model by 1",
          "GMCommands.Item.Usage.Effect",
          "'/item effectinc' Increment the object effect by 1",
          "'/item effectdec' Decrement the object effect by 1",
          ...
          "/item canuseevery <time in sec> <slot> stets the reuse time of a item",
          "/item repearcount <Count> <slot> - (200 is the default value) Set this items RepearCount",
          "/item classtype <ClassType> <slot> - Set this items ClassType",
          "/item packageid <PackageID> <slot> - Set this items PackageID",
          "/item levelrequierment <level> <slot> - Set the required level needed to use spells and procs on this item",
          ...
          "/item passivespell <id> <slot> - set the spell id for passive spells")]
                    ...
                    case "passivespell":
                        {
                            ...
                            item.PassiveSpell = Convert.ToUInt16(args[2]);
                            client.Out.SendInventoryItemsUpdate(new InventoryItem[] { item });
                            if (item.SlotPosition < (int)eInventorySlot.FirstBackpack)
                                client.Player.UpdatePlayerEquipment();
                            break;
                        }
                    #endregion
                    #region Model
                    ...
                    case "modelinc":
                        {
                            ...
                            try
                            {
                                if (model < 4249)
                                {
                                    ...
                                    if (item.SlotPosition < (int)eInventorySlot.FirstBackpack)
                                        client.Player.UpdatePlayerEquipment();
                                    DisplayMessage(client, "Item model changed to: " + item.Model);
                                }
                                else
                                {
                                    DisplayMessage(client, "Highest item model reached!");
                                }
                            }
                            catch (Exception)
                            {
                    ...
                    case "modeldec":
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    DisplayMessage(client, "item model cannot be < 1");
                                }
                            }
                            catch (Exception)
                            {
                    ...
                    case "colorinc":
                        {
                            ...
                            try
                            {
                                if (color < 144)
                                {
                                    ...
                                    if (item.SlotPosition < (int)eInventorySlot.FirstBackpack)
                                        client.Player.UpdatePlayerEquipment();
                                    DisplayMessage(client, "Item color changed to: " + item.Color);
                                }
                                else
                                {
                                    DisplayMessage(client, "Highest item color reached!");
                                }
                            }
                            catch (Exception)
                            {
                    ...
                    case "colordec":
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    DisplayMessage(client, "item color cannot be < 1");
                                }
                            }
                            catch (Exception)
                            {
                    ...
                    case "effectinc":
                        {
                            ...
                            try
                            {
                                if (effect < 4249)
                                {
                                    ...
                                    if (item.SlotPosition < (int)eInventorySlot.FirstBackpack)
                                        client.Player.UpdatePlayerEquipment();
                                    DisplayMessage(client, "Item effect changed to: " + item.Effect);
                                }
                                else
                                {
                                    DisplayMessage(client, "Highest item effect reached!");
                                }
                            }
                            catch (Exception)
                            {
                    ...
                    case "emblem":
                        {
                            ...
                            client.Out.SendInventoryItemsUpdate(new InventoryItem[] { item });
                            client.Out.SendMessage(string.Format("Emblem set to: {0}", item.Emblem), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            if (item.SlotPosition < (int)eInventorySlot.FirstBackpack)
                                client.Player.UpdatePlayerEquipment();
                            break;
                        }
                    ...
                    case "canuseevery":
                        {
                            ...
                            item.CanUseEvery = Convert.ToUInt16(args[2]);
                            client.Out.SendInventoryItemsUpdate(new InventoryItem[] { item });
                            client.Out.SendMessage(string.Format("CanUseEvery set to: {0}", item.CanUseEvery), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            break;
                        }
                    #endregion
                    #region Level
                    case "level":
                        {
                            ...
                            client.Out.SendInventoryItemsUpdate(new InventoryItem[] { item });
                            client.Out.SendMessage(string.Format("Item Level is now set to: {0}", item.Level), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            break;
                        }
                    #endregion Level
                    #region Price
                    ...
                    case "craftpriceset":
                        {
                            ...
                            item.CraftPriceSet = Convert.ToBoolean(args[2]);
                            client.Out.SendMessage(string.Format("CraftPriceSet set to: = {0}", item.CraftPriceSet), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            break;
                        }
                    #endregion CraftPriceSet
                    #region IsDropable
                    case "dropable":
                        {
                            int slot = (int)eInventorySlot.LastBackpack;
                            ...
                            client.Out.SendMessage(string.Format("Dropable set to: = {0}", item.IsDropable), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            break;
                        }
                    ...
                    case "pickable":
                        {
                            ...
                            client.Out.SendMessage(string.Format("Pickable set to: = {0}", item.IsPickable), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            break;
                        }
                    #endregion IsPickable
                    #region NotLosingDuration
                    case "notlosingduration":
                        {
                            int slot = (int)eInventorySlot.LastBackpack;
                            if (args.Length >= 4)
                            {
                            ...
                            client.Out.SendMessage(string.Format("Not Losing Duration set to: = {0}", item.IsNotLosingDur), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            break;
                        }
                    #endregion NotLosingDur
                    ...
                    case "indestructible":
                        {
                            ...
                            client.Out.SendMessage(string.Format("IsIndestructible set to: = {0}", item.IsIndestructible), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            break;
                        }
                    ...
                    case "tradable":
                        {
                            ...
                            client.Out.SendMessage(string.Format("tradable is now set to: {0}", item.IsTradable), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            break;
                        }
                    ...
                    case "levelrequierment":
                        {
                            ...
                            client.Out.SendInventoryItemsUpdate(new InventoryItem[] { item });
                            client.Out.SendMessage(string.Format("Level Requirement set to: {0}", item.LevelRequirement), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            break;
                        }
                    ...
                    case "bonuslevel":
                        {
                            ...
                            client.Out.SendInventoryItemsUpdate(new InventoryItem[] { item });
                            client.Out.SendMessage(string.Format("Bonus Level set to: {0}", item.BonusLevel), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            break;
                        }

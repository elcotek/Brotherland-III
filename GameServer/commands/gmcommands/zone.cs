			...
			try
			{
				...
				if (args[1].ToLower() == "info")
				{
                    var info = new List<string>
                    {
                        " ",
                        " NPCs in zone:",
                        " Alb: " + client.Player.CurrentZone.GetNPCsOfZone(eRealm.Albion).Count,
                        " Hib: " + client.Player.CurrentZone.GetNPCsOfZone(eRealm.Hibernia).Count,
                        " Mid: " + client.Player.CurrentZone.GetNPCsOfZone(eRealm.Midgard).Count,
                        " None: " + client.Player.CurrentZone.GetNPCsOfZone(eRealm.None).Count,
                        " ",
                        string.Format(" Objects in zone: {0}, Total allowed for region: {1}", client.Player.CurrentZone.TotalNumberOfObjects, ServerProperties.Properties.REGION_MAX_OBJECTS),
                        " ",
                        " Zone Description: " + client.Player.CurrentZone.Description,
                        " Zone Realm: " + GlobalConstants.RealmToName(client.Player.CurrentZone.GetRealm()),
                        " Zone ID: " + client.Player.CurrentZone.ID,
                        " Zone IsDungeon: " + client.Player.CurrentZone.IsDungeon,
                        " Zone SkinID: " + client.Player.CurrentZone.ZoneSkinID,
                        " Zone X: " + client.Player.CurrentZone.XOffset,
                        " Zone Y: " + client.Player.CurrentZone.YOffset,
                        " Zone Width: " + client.Player.CurrentZone.Width,
                        " Zone Height: " + client.Player.CurrentZone.Height,
                        " Zone DivingEnabled: " + client.Player.CurrentZone.IsDivingEnabled,
                        " Zone Waterlevel: " + client.Player.CurrentZone.Waterlevel
                    };

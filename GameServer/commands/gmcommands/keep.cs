				...
				case "towercreate":
					{
                        ...
                        if (!byte.TryParse(args[3], out byte baseLevel))
                        {
				...
				case "create":
					{
						...
						foreach (IDoor door in client.Player.GetDoorsInRadius(3000))
						{
                            ...
                            {
                                CurrentRegionID = (ushort)keep.Region,
                                Name = door.Name,

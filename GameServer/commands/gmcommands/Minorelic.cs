				...
				case "create":
                    {
                        ...
                        DBMinotaurRelic relic = new DBMinotaurRelic
                        {
                            ...
                            SpawnHeading = client.Player.Heading,
                            SpawnX = client.Player.X,
                            SpawnY = client.Player.Y,
                            SpawnZ = client.Player.Z,
                            SpawnRegion = client.Player.CurrentRegionID,

                            relicTarget = args[4].ToLower()
                        };
				...
				case "info":
					{
                        ...
                        {
                            "===========================",
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.RelicInfo"),
                            "===========================",
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.Name", relic.Name),
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.ID", relic.RelicID),
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.CurrentXP", relic.XP),
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.Level", relic.Level),
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.Effect", relic.Effect),
                            "===========================",
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.PositionInfo"),
                            "===========================",
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.SpawnX", relic.SpawnX),
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.SpawnY", relic.SpawnX),
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.SpawnZ", relic.SpawnZ),
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.SpawnHeading" + relic.SpawnHeading),
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.SpawnRegion", relic.SpawnRegion),
                            "===========================",
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.SpellInfo"),
                            "===========================",
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.SpellID", relic.RelicSpell),
                            LanguageMgr.GetTranslation(client, "GMCommands.MinoRelic.Info.SpellTarget", relic.RelicTarget)
                        };

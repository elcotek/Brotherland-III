...
namespace DOL.GS
{
    ...
    public enum eProperty : byte
    {
        ...
        MythicalDefense = 236,
        MythicalDPS = 237,
        MythicalSiegeDamageReduction = 238,

        // 236 - 246 used for Mythical Stat Cap
        MythicalStatCapBonus_First = 239,
        MythicalStrCapBonus = 239,
        MythicalDexCapBonus = 240,
        MythicalConCapBonus = 241,
        MythicalQuiCapBonus = 242,
        MythicalIntCapBonus = 243,
        MythicalPieCapBonus = 244,
        MythicalEmpCapBonus = 245,
        MythicalChaCapBonus = 246,
        //MythicalAcuCapBonus = 247,
        MythicalStatCapBonus_Last = 246,
    ...
    public static class GlobalConstants
    {
        ...
        public static bool IsExpansionEnabled(int expansion)
        {
            ...
            {
                if (int.TryParse(ex, out int exNum))
                {
                    if (exNum == expansion)
                    {
                        enabled = false;
        ...
        public static string RaceToTranslatedName(this GameClient client, int race, int gender)
        {
            ...
            return LanguageMgr.GetTranslation(client.Account.Language, translationID);
        }
            ...
            get
            {
                if (m_PvERezIllness == null)
                {
                    DBSpell spell = new DBSpell
                    {
                        ...
                        Range = 0,
                        Target = "Self",
                        Type = PvERessurectionIllnessSpellType,
                        Description = "The player's effectiveness is greatly reduced due to being recently resurrected."
                    };

...
namespace DOL.GS
{
    ...
    public class GameServerConfiguration : BaseServerConfiguration
    {
        ...
        /// The auto save interval in minutes
        /// </summary>
        protected int m_WorldTimerInterval;
        ...
        protected override void LoadFromConfig(ConfigElement root)
        {
            ...
            m_WorldTimerInterval = root["Server"]["DBAutoPvPEventInterval"].GetInt(m_WorldTimerInterval);
        ...
        protected override void SaveToConfig(ConfigElement root)
        {
            ...
            root["Server"]["DBWorldTimerInterval"].Set(m_WorldTimerInterval);
        ...
        public GameServerConfiguration()
            : base()
        {
            m_ServerName = "Brotherland II";
            m_ServerNameShort = "Brotherland";
        ...
        */
        ...
        {
            get { return m_WorldTimerInterval; }
            set { m_WorldTimerInterval = value; }
        }

            ...
            if (living is GamePlayer)
            {
                switch (property)
                {
                    case eProperty.Strength:
                        mythicalCapBonus = living.ItemBonus[(int)eProperty.MythicalStrCapBonus];
                        break;
                    case eProperty.Dexterity:
                        mythicalCapBonus = living.ItemBonus[(int)eProperty.MythicalDexCapBonus];

                        break;
                    case eProperty.Constitution:
                        mythicalCapBonus = living.ItemBonus[(int)eProperty.MythicalConCapBonus];

                        break;
                    case eProperty.Quickness:
                        mythicalCapBonus = living.ItemBonus[(int)eProperty.MythicalQuiCapBonus];

                        break;
                    case eProperty.Intelligence:
                        mythicalCapBonus = living.ItemBonus[(int)eProperty.MythicalIntCapBonus];

                        break;
                    case eProperty.Piety:
                        mythicalCapBonus = living.ItemBonus[(int)eProperty.MythicalPieCapBonus];

                        break;
                    case eProperty.Charisma:
                        mythicalCapBonus = living.ItemBonus[(int)eProperty.MythicalChaCapBonus];

                        break;
                    case eProperty.Empathy:
                        mythicalCapBonus = living.ItemBonus[(int)eProperty.MythicalEmpCapBonus];
                ...
                mythcap = Math.Min(8, mythicalCapBonus);
            }
                  

            return (int)(living.Level * 1.5 + mythcap);
        }

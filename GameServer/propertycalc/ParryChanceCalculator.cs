	...
	public class ParryChanceCalculator : PropertyCalculator
	{
		public override int CalcValue(GameLiving living, eProperty property)
		{
			...
			if (player != null)
			{
                ...
                int RangBonus = player.RealmLevel;
				...
				{					
                   ...
                   * */
                    ...
                    parrySpec = ((player.GetModifiedSpecLevel(Specs.Parry) - 1) + (RangBonus / 100 * 10) +  ((1 / 40 * ((player.Dexterity * 2) -100)))) * 5;
                ...
                //return parrySpec + Classbase + RangBonusbuff;
			}

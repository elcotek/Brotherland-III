...
namespace DOL.GS
{
    ...
    public class GameSiegeCatapult : GameSiegeWeapon
    {
        ...
        public override void DoDamage()
        {
            ...
            base.DoDamage();//anim must be called after damage
            ...
            foreach (GameLiving living in targets)
            {
                ...
                if (this is GameSiegeCatapult && living.IsWithinRadius(Owner, ServerProperties.Properties.Siege_Catapult_Maxrange) == false)
                {
                ...
                int damageAmount = Util.Random(100, 250);//test
                ...
                if (Owner.TargetObject is GameKeepComponent)
                 {
                     ...
                     damageAmount = ((damageAmount * ServerProperties.Properties.Siege_Catapult_Damage) / Owner.TargetObject.Level);
                 }

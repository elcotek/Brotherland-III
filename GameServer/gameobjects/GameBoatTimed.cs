...
{
    /// <summary>
    /// Holds a GameBoat item in the world that will disappear after some interval
    /// </summary>
    public class GameBoatTimed : GameBoat
    {
        /// <summary>
        /// How long this object can stay in the world without being removed
        /// </summary>
        protected uint m_removeDelay = 120000 * 120; //Currently 4h
        /// <summary>
        ...
        /// <summary>
        /// Creates a new GameBoat item that will disappear after X minutes
        /// </summary>
        public GameBoatTimed()
            : base()
        {
        }

        /// <summary>
        /// Creates a new GameBoat item that will disappear after the given
        /// tick-count
        /// </summary>
        /// <param name="vanishTicks">milliseconds after which the item will vanish</param>
        public GameBoatTimed(uint vanishTicks)
            : this()
        {
            if (vanishTicks > 0)
        ...
        /// <summary>
        /// The callback function that will remove this GameSiegeTrebuchet after some time
        /// </summary>
        protected class RemoveItemAction : RegionAction
        {
            ...
            public RemoveItemAction(GameBoatTimed item)
                : base(item)
            {
            }

            /// <summary>
            /// The callback function that will remove this GameBoat after some time
            /// </summary>
            protected override void OnTick()
            {
                GameBoatTimed item = (GameBoatTimed)m_actionSource;

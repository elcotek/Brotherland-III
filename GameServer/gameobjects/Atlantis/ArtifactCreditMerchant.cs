        ...
        public override bool ReceiveItem(GameLiving source, InventoryItem item)
        {
            ...
            if (player != null && item != null && item.Name.EndsWith("Credit"))
            {
                ...
                else
                {
                    ...
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "GameMerchant.BountyPointsRefunded", totalValue), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    //player.Out.SendMessage(totalValue + " Bounty Points refunded", eChatType.CT_ScreenCenterSmaller, eChatLoc.CL_SystemWindow);
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "GameMerchant.YouAlreadyHaveThisCredit", totalValue), eChatType.CT_System, eChatLoc.CL_SystemWindow);

...
namespace DOL.GS
{
    ...
    public abstract class CharacterClassBase : ICharacterClass
	{
		...
		public virtual string GetTitle(int level, GamePlayer player)
		{
			return "None";
		}

...
{
    /// <summary>
    /// Holds a GameSiegeCatapult item in the world that will disappear after some interval
    /// </summary>
    public class GameSiegeTimedCatapult : GameSiegeCatapult
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new GameSiegeCatapult item that will disappear after X minutes
        /// </summary>
        public GameSiegeTimedCatapult()
            : base()
        {
        }

        /// <summary>
        /// Creates a new GameSiegeCatapult item that will disappear after the given
        /// tick-count
        /// </summary>
        /// <param name="vanishTicks">milliseconds after which the item will vanish</param>
        public GameSiegeTimedCatapult(uint vanishTicks)
            : this()
        {
            if (vanishTicks > 0)
        ...
        /// <summary>
        /// The callback function that will remove this GameSiegeCatapult after some time
        /// </summary>
        protected class RemoveItemAction : RegionAction
        {
            ...
            public RemoveItemAction(GameSiegeTimedCatapult item)
                : base(item)
            {
            }
            ...
            {
                GameSiegeTimedCatapult item = (GameSiegeTimedCatapult)m_actionSource;

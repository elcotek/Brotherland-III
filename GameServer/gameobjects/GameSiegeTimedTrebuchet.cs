...
{
    /// <summary>
    /// Holds a GameSiegeTrebuchet item in the world that will disappear after some interval
    /// </summary>
    public class GameSiegeTimedTrebuchet : GameSiegeTrebuchet
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new GameSiegeTrebuchet item that will disappear after X minutes
        /// </summary>
        public GameSiegeTimedTrebuchet()
            : base()
        {
        }

        /// <summary>
        /// Creates a new GameSiegeTrebuchet item that will disappear after the given
        /// tick-count
        /// </summary>
        /// <param name="vanishTicks">milliseconds after which the item will vanish</param>
        public GameSiegeTimedTrebuchet(uint vanishTicks)
            : this()
        {
            if (vanishTicks > 0)
        ...
        protected class RemoveItemAction : RegionAction
        {
            ...
            public RemoveItemAction(GameSiegeTimedTrebuchet item)
                : base(item)
            {
            }
            ...
            {
                GameSiegeTimedTrebuchet item = (GameSiegeTimedTrebuchet)m_actionSource;

 ...
 */
    ...
    public class GameTuscarianGlacierIceMerchant : GameItemCurrencyMerchant
    {
        public GameTuscarianGlacierIceMerchant()
            : base()
        {
            m_moneyItem = WorldInventoryItem.CreateFromTemplate("tuscarian_glacier_ice");
        }
    }
    public class GameDragonScaleMerchant : GameItemCurrencyMerchant
    {
        public GameDragonScaleMerchant()
            : base()
        {
            m_moneyItem = WorldInventoryItem.CreateFromTemplate("dragon_scale");
        }
    }
    public class GameAtlanteanGlasMerchant : GameItemCurrencyMerchant
    {
        public GameAtlanteanGlasMerchant()
            : base()
        {
            m_moneyItem = WorldInventoryItem.CreateFromTemplate("atlantean_glas");
        }
    }
    public class GameCaerSidiSoulsMerchant : GameItemCurrencyMerchant
    {
        public GameCaerSidiSoulsMerchant()
            : base()
        {
            m_moneyItem = WorldInventoryItem.CreateFromTemplate("caer_sidi_souls");
        }
    }
    public class GameGalladoriaRootMerchant : GameItemCurrencyMerchant
    {
        public GameGalladoriaRootMerchant()
            : base()
        {
            m_moneyItem = WorldInventoryItem.CreateFromTemplate("galladoria_root");
        }
    }

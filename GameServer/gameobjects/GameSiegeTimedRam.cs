...
{
    /// <summary>
    /// Holds a GameSiegeRam item in the world that will disappear after some interval
    /// </summary>
    public class GameSiegeTimedRam : GameSiegeRam
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new GameSiegeRam item that will disappear after X minutes
        /// </summary>
        public GameSiegeTimedRam()
            : base()
        {
        }

        /// <summary>
        /// Creates a new GameSiegeRam item that will disappear after the given
        /// tick-count
        /// </summary>
        /// <param name="vanishTicks">milliseconds after which the item will vanish</param>
        public GameSiegeTimedRam(uint vanishTicks)
            : this()
        {
            if (vanishTicks > 0)
        ...
        /// <summary>
        /// The callback function that will remove this GameSiegeRam after some time
        /// </summary>
        protected class RemoveItemAction : RegionAction
        {
            ...
            public RemoveItemAction(GameSiegeTimedRam item)
                : base(item)
            {
            }
            ...
            {
                GameSiegeTimedRam item = (GameSiegeTimedRam)m_actionSource;

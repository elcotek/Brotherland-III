...
namespace DOL.GS
{
    ...
    public class EffectNPC : GameNPC
    {
        ...
        private long Price = Money.GetMoney(0, 0, 1, 0, 0);//M/P/G/S/C Amount of gold used for RemoveMoney
      
        private eEmote emote = eEmote.Raise;//The Emote the NPC does when Interacted
        ...
        public override bool Interact(GamePlayer player)
        {
            if (base.Interact(player))
            {
                ...
                {
                    emoteplayer.Out.SendEmoteAnimation(this, emote);
                }
                SendReply(player, "Greetings Traveller!\n\n" +
                                    "I can either change the effect, the speed or the color of your weapons, armors...\n" +
                                    "All i charge for it is a small donation of " + Money.GetString(Price) + " for my work.\n\n" +
        ...
        public override bool ReceiveItem(GameLiving source, InventoryItem item)
        {
            ...
            SendReply(t, "What service do you want to use ?\n" +
                        "Shall i add an [effect] to it, change the [speed] of it or do you want me to [dye] it ?.");

...
{
    public class AngoraMid : GameNPC
	{
		...
		public override bool Interact(GamePlayer player)
		{
            ...
            player.Out.SendMessage("Stop!" + player.Name + "!Where do you want to travel?You can choose the [Svasud Faste], [Angora]!", eChatType.CT_Say, eChatLoc.CL_PopupWindow);
			return true;
		}
                        ...
                        if (t.Group != null && t != null)
                            ...
                            foreach (GamePlayer grpMate in t.Group.GetPlayersInTheGroup())
                                if (grpMate.IsWithinRadius(this, 500) && grpMate.IsAlive)
                                    ...
                                    grpMate.MoveTo(163, 651460, 313758, 9432, 1004);
                                else

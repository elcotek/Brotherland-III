...
{
    public class HibKythera : GameNPC
    {
        ...
        public override bool WhisperReceive(GameLiving source, string str)
        {
            ...
            switch (str)
            {
                case "Kythera":
                    ...
                    // t.MoveTo(130, 417737, 556672, 4157, 3985);
                    GS.Spells.PortalSpell.SetDestinationHib(130, 417737, 556672, 4157, 3985, eRealm.Hibernia);

...
namespace DOL.GS
{
	public class BuffMerchant : GameMerchant
	{
		...
		private const int BUFFS_SPELL_DURATION = 0;
		...
		static double buffValue = 56;
		static double BaseAFbuffValue = 41;

		static double BaseSpecAFbuffValue = 25;
		static double BaseStrbuffValue = 42;
		
		static double BaseDexbuffValue = 41;
		static double BaseConbuffValue = 40;
		static double BaseAcuityValue = 41;
		static double HasteValue = 10;
		...
		public static Spell MerchBaseAFBuff
		{
			get
			{
				if (m_baseaf == null)
				{
					...
					spell.Icon = 1467 - conID;
					spell.Duration = BUFFS_SPELL_DURATION;
					spell.Value = BaseAFbuffValue; //Effective buff 58
		...
		public static Spell MerchStrBuff
		{
			get
			{
				if (m_basestr == null)
				{
					...
					spell.Icon = 1457 - conID;
					spell.Duration = BUFFS_SPELL_DURATION;
					spell.Value = BaseStrbuffValue; //effective buff 55
		...
		public static Spell MerchConBuff
		{
			get
			{
				if (m_basecon == null)
				{
					...
					spell.Icon = 1486 - conID;
					spell.Duration = BUFFS_SPELL_DURATION;
					spell.Value = BaseConbuffValue; //effective buff 55
		...
		public static Spell MerchDexBuff
		{
			get
			{
				if (m_basedex == null)
				{
					...
					spell.Icon = 1476 - conID;
					spell.Duration = BUFFS_SPELL_DURATION;
					spell.Value = BaseDexbuffValue; //effective buff 55
		...
		public static Spell MerchStrConBuff
		{
			get
			{
				if (m_strcon == null)
				{
					...
					spell.Icon = 1517 - conID;
					spell.Duration = BUFFS_SPELL_DURATION;
					spell.Value = buffValue; //effective buff 85
		...
		public static Spell MerchAcuityBuff
		{
			get
			{
				if (m_acuity == null)
				{
					...
					spell.Icon = 1538 - conID;
					spell.Duration = BUFFS_SPELL_DURATION;
					spell.Value = BaseAcuityValue; //effective buff 72;
		...
		public static Spell MerchSpecAFBuff
		{
			get
			{
				if (m_specaf == null)
				{
					...
					spell.Icon = 1506 - conID;
					spell.Duration = BUFFS_SPELL_DURATION;
					spell.Value = BaseSpecAFbuffValue; //effective buff 67
					spell.Name = "Armor of the Realm";
		...
		public static Spell casterMerchSpecAFBuff
		{
			get
			{
				if (m_casterspecaf == null)
				{
					...
					spell.Duration = BUFFS_SPELL_DURATION;
					spell.Value = BaseSpecAFbuffValue; //effective buff 67
					spell.Name = "Armor of the Realm (spec AF)";
					spell.Description = "Adds to the recipient's Armor Factor (AF), resulting in better protection against some forms of attack. It acts in addition to any armor the target is wearing.";
					spell.Range = WorldMgr.VISIBILITY_DISTANCE;
					spell.SpellID = 89014;
					spell.Target = "Realm";
		...
		public static Spell MerchHasteBuff
		{
			get
			{
				if (m_haste == null)
				{
					...
					spell.Icon = 407 - conID;
					spell.Duration = BUFFS_SPELL_DURATION;
					spell.Value = HasteValue;

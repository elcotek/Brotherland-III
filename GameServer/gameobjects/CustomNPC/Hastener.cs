    ...
    public class GameHastener : GameNPC
    {
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            else if (!player.CurrentRegion.IsRvR)//default message outside of RvR
            {
                ...
                */
                player.Out.SendMessage("Hello " + player.Name + " I am here to asist with travel across our fair lands." + " have a nice day adventurer!", eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            }
                    ...
                    switch (str.ToLower())
                    {
                        ...
                        case "strength":
                            if (player.CurrentRegion.IsCapitalCity)
                            {
                                ...
                                GameNPCHelper.CastSpellOnOwnerAndPets(this, player, SkillBase.GetSpellByID(GameHastener.STROFTHEREALMID), SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells), false);
                            }
                            break;
                        case "borderkeep":

...
namespace DOL.GS.Spells
{
	...
	public class SiegeArrow : BoltSpellHandler
	{
		...
		public override bool CheckBeginCast(GameLiving selectedTarget)
		{
			...
			{
				if (!(selectedTarget is GameKeepComponent || selectedTarget is Keeps.GameKeepDoor || selectedTarget is GameSiegeWeapon))
				{
		...
		{
			if (!(target is GameKeepComponent || target is Keeps.GameKeepDoor || target is GameSiegeWeapon))
			{

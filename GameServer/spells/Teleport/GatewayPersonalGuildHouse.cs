...
namespace DOL.GS.Spells
{
    ...
    [SpellHandlerAttribute("GatewayPersonalGuildHouse")]
    public class GatewayPersonalGuildHouse : SpellHandler
    {
        public GatewayPersonalGuildHouse(GameLiving caster, Spell spell, SpellLine spellLine)
        ...
        public override bool CheckBeginCast(GameLiving selectedTarget)
        {
            ...
            {
                player.Out.SendMessage("Sorry, You must first be in a guild to use the stone.", eChatType.CT_System, eChatLoc.CL_SystemWindow);
            ...
            {
                player.Out.SendMessage("Sorry, your guild owns no house yet.", eChatType.CT_System, eChatLoc.CL_SystemWindow);
        ...
        public override void ApplyEffectOnTarget(GameLiving target, double effectiveness)
        {
            ...
            {
                player.Out.SendMessage("Sorry, there was no guild house found!", eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }
            else
            {
                IGameLocation location = house.OutdoorJumpPoint(player);
                Teleport teleport = new Teleport();
                teleport.TeleportID = "Guild";

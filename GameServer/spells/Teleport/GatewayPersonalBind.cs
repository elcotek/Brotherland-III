	...
	public class GatewayPersonalBind : SpellHandler
	{
        ...
        public override void ApplyEffectOnTarget(GameLiving target, double effectiveness)
        {
            ...
            switch (character.BindRegion)
            {
                ...
                case 237:
                    {
                        player.Out.SendMessage("BG's not supportet by Personal bind stones, please create a new bindpoint!", DOL.GS.PacketHandler.eChatType.CT_Important, DOL.GS.PacketHandler.eChatLoc.CL_SystemWindow);
                        return;
                    }
            }

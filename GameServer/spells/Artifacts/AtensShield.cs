...
namespace DOL.GS.Spells
{
	...
	public class AtensShield : SummonItemSpellHandler
	{
			...
			: base(caster, spell, line)
		{
			...
			{
				//m_goldenTridentofFlame = GameServer.Database.SelectObject<ItemTemplate>("Id_nb='Golden_Trident_of_Flame1'") ?? Javelin;
                m_goldenTridentofFlame = GameServer.Database.FindObjectByKey<ItemTemplate>("Golden_Trident_of_Flame1") ?? Javelin;
			...
			{
                //m_goldenTridentofFlame = GameServer.Database.SelectObject<ItemTemplate>("Id_nb='Golden_Trident_of_Flame2'") ?? JavelinM;
                m_goldenTridentofFlame = GameServer.Database.FindObjectByKey<ItemTemplate>("Golden_Trident_of_Flame2") ?? JavelinM;
			...
			{
				//m_goldenTridentofFlame = GameServer.Database.SelectObject<ItemTemplate>("Id_nb='Golden_Trident_of_Flame3'") ?? JavelinH;
                m_goldenTridentofFlame = GameServer.Database.FindObjectByKey<ItemTemplate>("Golden_Trident_of_Flame3") ?? JavelinH;

...
namespace DOL.GS.Spells
{
    ...
    public class SummonMonster : SpellHandler
    {
        ...
        public override void OnEffectPulse(GameSpellEffect effect)
        {
            ...
            if (effect.Owner is GamePlayer)
            {
               // log.Error("Pulsing effect start");
                GamePlayer player = effect.Owner as GamePlayer;
        ...
        public override int OnEffectExpires(GameSpellEffect effect, bool noMessages)
        {
            ...
            int leftHealth = Convert.ToInt32(player.MaxHealth * 0.01);
            player.Health = leftHealth;
        ...
        public void EventRaised(DOLEvent e, object sender, EventArgs arguments)
        {
            ...
            GameSpellEffect MonsterDoT = SpellHandler.FindEffectOnTarget(player, "MonsterDoT");

            if (MonsterDoT != null)
            {
                MonsterDoT.Cancel(false);

            }

            GameSpellEffect MonsterDisease = SpellHandler.FindEffectOnTarget(player, "MonsterDisease");

            if (MonsterDisease != null)
            {
                MonsterDisease.Cancel(false);
    ...
    public class MonsterDoT : DoTSpellHandler
    {

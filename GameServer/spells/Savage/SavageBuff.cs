        ...
        public override IList<string> DelveInfo(GamePlayer player)
        {
         
            {
                ...
                if (Spell.LifeDrainReturn != 0)
                    ...
                    list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DelveInfo.Value", Spell.Value.ToString("0.###;0.###'%'")));
                ...
                if (Spell.Power != 0)
                    list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DelveInfo.HealthCost", Spell.Power.ToString("0;0'%'")));
                ...
                if (Spell.IsFocus)
                    list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DelveInfo.Focus"));
                if (Spell.IsCastFocus)
                    list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DelveInfo.Focus"));
                if (Spell.IsMoveFocus)
                    list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DelveInfo.Focus"));

...
namespace DOL.GS.Spells
{
    ...
    public class LifeTransferSpellHandler : SpellHandler
    {
        ...
        public virtual bool HealTarget(GameLiving target, int amount)
        {
            ...
            MessageToCaster("You heal " + target.GetName(0, false) + " for " + heal.ToString() + " hit points!", eChatType.CT_Spell);
            MessageToLiving(target, "You are healed by " + m_caster.GetName(0, false) + " for " + heal.ToString() + " hit points.", eChatType.CT_Spell);
            if (heal < amount)

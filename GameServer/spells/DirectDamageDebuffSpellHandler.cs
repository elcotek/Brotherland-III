        ...
        public override IList<string> DelveInfo(GamePlayer player)
        {

            {
				...
				*/
                ...
                {
                    list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "DirectDamageDebuffSpellHandler.DelveInfo.Function"));
                    list.Add(" "); //empty line
                    ...
                    if (Spell.Value != 0)
                        list.Add(String.Format(LanguageMgr.GetTranslation(player.Client.Account.Language, "DirectDamageDebuffSpellHandler.DelveInfo.Decrease", DebuffTypeName, Spell.Value)));

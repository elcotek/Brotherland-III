        ...
        private void OnAttack(DOLEvent e, object sender, EventArgs arguments)
        {
            ...
            if (ad.Damage > 0)
                if (ad.Target is GamePlayer)
                {
                    ...
                    (ad.Target as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((ad.Target as GamePlayer).Client.Account.Language, "SpellHandler.TheDamageReductionAbsorbsDamage", damageAbsorbed), eChatType.CT_Spell, eChatLoc.CL_SystemWindow);
                }
            ...
            if (ad.Attacker is GamePlayer)
            {
               // MessageToLiving(ad.Attacker, string.Format("A damage reduction absorbs {0} damage of your attack!", damageAbsorbed), eChatType.CT_Spell);
                (ad.Attacker as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((ad.Target as GamePlayer).Client.Account.Language, "SpellHandler.ADamageReductionAbsorbsDamage", damageAbsorbed), eChatType.CT_Spell, eChatLoc.CL_SystemWindow);
            }

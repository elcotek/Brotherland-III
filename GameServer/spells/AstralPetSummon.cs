...
namespace DOL.GS.Spells
{
    ...
    public class AstralPetSummon : SummonSpellHandler
    {
        ...
        /// <summary>
        ///ein actives Astrales pet gespawnt ?
        /// </summary>
        /// <param name="target"></param>
        public static bool IsAstralSummoned = false;
        ...
        public virtual void AutoSetStats()
        {
            ...
            pet.Strength = (short)(Properties.MOB_AUTOSET_STR_BASE + pet.Level * Properties.ASTRAL_AUTOSET_STR_MULTIPLIER * Properties.MOB_AUTOSET_STR_MULTIPLIER);

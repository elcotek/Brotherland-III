...
namespace DOL.GS
{
    ...
    public class Spell : Skill, ICustomParamsValuable
    {
        ...
        protected readonly bool m_iscastfocus = false;
        protected readonly bool m_ismovefocus = false;
        protected readonly bool m_minotaurspell = false;
        //Vampiiir
        protected readonly bool m_IsNotDexbased = false;
        // warlocks
        ...
        protected bool m_isProcSpell = false;
        protected bool m_isItemSpell = false;
        // params
        ...
        public bool IsNotDexbased
        {
            get { return m_IsNotDexbased; }
        }
        ...
        public bool IsCastFocus
        {
            get { return m_iscastfocus; }
        }

        public bool IsMoveFocus
        {
            get { return m_ismovefocus; }
        }
        ...
        /// <summary>
        /// This spell is for items and the damage will not increase by effectiveness
        /// </summary>
        public bool IsItemSpell
        {
            get { return m_isItemSpell; }
            set { m_isItemSpell = value; }
        }

        /// <summary>
        /// This spell is a Proc and the damage will not increase by effectiveness
        /// </summary>
        public bool IsProcSpell
        {
            get { return m_isProcSpell; }
            set { m_isProcSpell = value; }
        }
        /// <summary>
            ...
            : base(dbspell.Name, (ushort)dbspell.SpellID, requiredLevel)
        {
            ...
            m_ismovefocus = dbspell.IsMoveFocus;
            m_iscastfocus = dbspell.IsCastFocus;
            m_isfocus = dbspell.IsFocus;
            m_isItemSpell = dbspell.IsItemSpell;
            m_isProcSpell = dbspell.IsProcSpell;
            ...
            //Vampiir
            m_IsNotDexbased = dbspell.IsNotDexbased;
        }
            ...
            base(spell.Name, (ushort)spell.ID, spell.Level)
        {
            ...
            m_ismovefocus = spell.IsMoveFocus;
            m_iscastfocus = spell.IsCastFocus;
            ...
            m_IsNotDexbased = spell.IsNotDexbased;
        }
        ...
        public virtual void Delve(List<String> delve)
        {
            ...
            if (Range > 0)
                delve.Add(String.Format("Range: {0}", Range.ToString()));

            if (Duration > 0 && Duration < 65535)
                delve.Add(String.Format("Duration: {0}",
                    (Duration >= 60000)
                    ? String.Format("{0}:{1} min", ((int)(Duration / 60000), Duration % 60000).ToString())
                    : String.Format("{0} sec", (Duration / 1000).ToString())));

            delve.Add(String.Format("Casting time: {0}",
                (CastTime == 0) ? "instant" : String.Format("{0} sec", CastTime.ToString())));

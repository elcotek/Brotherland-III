...
namespace DOL.GS.Spells
{
    ...
    #region tinderbox
    [SpellHandlerAttribute("tinderbox")]
    public class tinderboxSpellHandler : FontSpellHandler
    {
        // constructor
        public tinderboxSpellHandler(GameLiving caster, Spell spell, SpellLine line)
            : base(caster, spell, line)
        {
            ...
            font.Flags = GameFont.eFlags.PEACE;
            font.X = caster.X;
            font.Y = caster.Y;
            font.Z = caster.Z;
            ...
            dbs.Name = spell.Name;
            dbs.Icon = 14804;
            dbs.ClientEffect = 14804;
            dbs.Damage = spell.Damage;
            dbs.DamageType = (int)spell.DamageType;
            dbs.Target = "Realm";
            dbs.Radius = 0;
            dbs.EffectGroup = 1029;
            dbs.Type = "Campfire";
    ...
    public class FOHSpellHandler : FontSpellHandler
    {
            ...
            : base(caster, spell, line)
        {
            ...
            dbs = new DBSpell();
            dbs.Name = spell.Name;
            dbs.Description = "Ward that regenerates health for up to 40 allies who rest within it.";
            dbs.Icon = 7245;
    ...
    public class FOPSpellHandler : FontSpellHandler
    {
            ...
            : base(caster, spell, line)
        {
            ...
            dbs = new DBSpell();
            dbs.Name = spell.Name;
            dbs.Description = "Ward that regenerates power for up to 40 allies who rest within it.";
            dbs.Icon = 7212;
    ...
    public class FORSpellHandler : FontSpellHandler
    {
            ...
            : base(caster, spell, line)
        {
            ...
            dbs = new DBSpell();
            dbs.Name = spell.Name;
            dbs.Description = "Mesmerisation spells cast on the target are reduced in duration by the given percentage.";
            dbs.Icon = 7214;
            dbs.ClientEffect = 7214;
            dbs.EffectGroup = 4612;
            dbs.Damage = spell.Damage;
            dbs.DamageType = (int)spell.DamageType;
            dbs.Target = "Realm";
            dbs.Radius = 0;
    ...
    public class FODSpellHandler : FontSpellHandler
    {
            ...
            : base(caster, spell, line)
        {
            ...
            dbs = new DBSpell();
            dbs.Name = spell.Name;
            dbs.Description = "Ward that drains power from enemies who stand within its radius.";
            dbs.Icon = 7310;
    ...
    public class PoTSpellHandler : SpellHandler
    {
        ...
        public override void OnDirectEffect(GameLiving target, double effectiveness)
        {
            ...
            if (target.CurrentRegion.IsRvR && target.DamageRvRMemory <= 0 && target.InCombat || target.CurrentRegion.IsRvR == false && target.InCombat)
            {
                return;
            }
           ...
           // MessageToLiving(target, Spell.Message1, eChatType.CT_Spell);
            (target as GamePlayer).Out.SendMessage(LanguageMgr.GetTranslation((target as GamePlayer).Client.Account.Language, "Perfecter.YouFeelCalmAndHealthy"), eChatType.CT_Spell, eChatLoc.CL_SystemWindow);
        }

...
{    
    ...
    public class CoweringBellowSpellHandler : FearSpellHandler
    {
        ...
        public override IList<GameLiving> SelectTargets(GameObject castTarget)
        {
            ...
            {
                if (npc != null && npc.Realm != target.Realm && npc is GameNPC && npc.Brain is ControlledNpcBrain && !(npc is NecromancerPet))

                    if ((npc.Brain as ControlledNpcBrain).Owner != null && (npc.Brain as ControlledNpcBrain).Owner is GamePlayer)
                    {
                        //  list.Add(npc);
                        if (npc.IsCasting)
                        {
                        ...
                        (npc.Brain as ControlledNpcBrain).FollowOwner();

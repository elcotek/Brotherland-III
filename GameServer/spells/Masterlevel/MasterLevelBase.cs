...
namespace DOL.GS.Spells
{
    ...
    public class MasterlevelHandling : SpellHandler
    {
        ...
        protected override int CalculateEffectDuration(GameLiving target, double effectiveness)
        {
            ...
            if (target is GamePet && Spell.SpellType == "SummonMastery")
            {
            ...
            else if (Spell.InstrumentRequirement != 0)
            {
    ...
    public class MLStyleHandler : MasterlevelHandling
    {
        ...
        [SpellHandlerAttribute("ChampionStyleHandler")]

        public class ChampionStyleHandler : MasterlevelHandling
        {
            public virtual string ChampionSpellLineName
            {
                get { return GlobalSpellsLines.Champion_Spells; }
            }
            public ChampionStyleHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line) { }
            ...
            public override IList<string> DelveInfo(GamePlayer player)
            {
                ...
                foreach (Spell champSpell in champSpells)
                {
                    ...
                    Style champStyle = SkillBase.GetStyleByID((int)champSpell.Value, player.CharacterClass.ID);
                    if (champStyle == null)
                    {
        ...
        public override void OnEffectPulse(GameSpellEffect effect)
        {
            ...
            foreach (GamePlayer player in font.GetPlayersInRadius(sRadius))
            {
                ...
                if (!Friendly
                    ...
                    && player.DamageRvRMemory > 0 || !player.InCombat || ApplyOnCombat)
                    heal.StartSpell((GameLiving)player);
                else if (Friendly && player.DamageRvRMemory > 0 || !player.InCombat || ApplyOnCombat)
                    heal.StartSpell((GameLiving)player);
            }
    ...
    public class SummonItemSpellHandler : MasterlevelHandling
    {
        ...
        public override void FinishSpellCast(GameLiving target)
        {
            ...
            base.FinishSpellCast((GameLiving)(target));
        }

...
namespace DOL.GS.Spells
{
    ...
    public class DazzlingArraySpellHandler : StormSpellHandler
    {
            ...
            : base(caster, spell, line)
        {
            ...
            dbs = new DBSpell();
            dbs.Name = spell.Name;
            dbs.Description = "Beneficial storm that makes it harder for enemies to hit allies within it.";
            dbs.Icon = 7210;
        ...
        public override void OnDirectEffect(GameLiving target, double effectiveness)
        {
            ...
            if (target is GameStorm)
            {
                ...
                if (targetStorm.Movable)
                {
                    ...
                    targetNPC.PathTo(targetNPC.X + (int)(range * Math.Cos(angle)), targetNPC.Y + (int)(range * Math.Sin(angle)), targetNPC.Z, targetNPC.MaxSpeed);
                }
            }
        }
    ...
    public class EnervatingGasSpellHandler : StormSpellHandler
    {
            ...
            : base(caster, spell, line)
        {
            ...
            dbs = new DBSpell();
            dbs.Name = spell.Name;
            dbs.Description = "Storm that drains fatigue from enemies who stand inside it.";
            dbs.Icon = 7273;
            dbs.ClientEffect = 7273;
            dbs.Damage = 10;//spell.Damage;
            dbs.DamageType = 0;// (int)spell.DamageType;
            dbs.Target = "Enemy";
            dbs.Radius = 0;
            dbs.Type = "StormEnduDrain";
            dbs.Value = 0;//spell.Value;
            dbs.Duration = 2;// spell.ResurrectHealth;
            dbs.Frequency = 0;// spell.ResurrectMana;
            dbs.Pulse = 0;
            dbs.PulsePower = 0;
            dbs.LifeDrainReturn = 0;//spell.LifeDrainReturn;
            dbs.Power = 0;
            dbs.CastTime = 0;
            dbs.Range = WorldMgr.VISIBILITY_DISTANCE;
            sRadius = 350;
    ...
    public class InebriatingFumesSpellHandler : StormSpellHandler
    {
            ...
            : base(caster, spell, line)
        {
            ...
            dbs = new DBSpell();
            dbs.Name = spell.Name;
            dbs.Description = "Storm that reduces coordination of enemies while they are inside it. The effect fades quickly once the enemy leaves the effect.";
            dbs.Icon = 7258;
    ...
    public class MentalSiphonSpellHandler : StormSpellHandler
    {
            ...
            : base(caster, spell, line)
        {
            ...
            dbs = new DBSpell();
            dbs.Name = spell.Name;
            dbs.Description = "Storm that drains power from enemies who stand inside it.";
            dbs.Icon = 7303;
    ...
    public class ChokingVaporsSpellHandler : StormSpellHandler
    {
            ...
            : base(caster, spell, line)
        {
            ...
            dbs = new DBSpell();
            dbs.Name = spell.Name;
            dbs.Description = "Storm that physically weakens enemies while they are inside it. The effect fades quickly once the enemy leaves the effect. 350 radius.";
            dbs.Icon = 7223;
    ...
    public class SenseDullingCloudSpellHandler : StormSpellHandler
    {
            ...
            : base(caster, spell, line)
        {
            ...
            dbs = new DBSpell();
            dbs.Name = spell.Name;
            dbs.Description = "Cloud Storm that mentally weakens enemies while they are inside it. The effect fades quickly once the enemy leaves the effect.";
            dbs.Icon = 7305;
    ...
    public class EnergyTempestSpellHandler : StormSpellHandler
    {
            ...
            : base(caster, spell, line)
        {
            ...
            dbs = new DBSpell();
            dbs.Name = spell.Name;
            dbs.Description = "Storm that wracks the enemy with essence damage.";
            dbs.Icon = 7216;

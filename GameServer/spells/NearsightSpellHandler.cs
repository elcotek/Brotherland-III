...
namespace DOL.GS.Spells
{
    ...
    public class NearsightSpellHandler : ImmunityEffectSpellHandler
    {
        ...
        public override void OnEffectStart(GameSpellEffect effect)
        {
            ...
            effect.Owner.StartInterruptTimer(3500, AttackData.eAttackType.Spell, Caster);
        ...
        public override IList<string> DelveInfo(GamePlayer player)
        {

            {
                ...
                list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "NearsightSpellHandler.DelveInfo.Function", (Spell.SpellType == "" ? "(not implemented)" : Spell.SpellType)));
                list.Add(" "); //empty line
                ...
                if (Spell.Value != 0)
                    list.Add(string.Format(LanguageMgr.GetTranslation(player.Client.Account.Language, "DelveInfo.Value", ((int)Spell.Value).ToString())) + "%");

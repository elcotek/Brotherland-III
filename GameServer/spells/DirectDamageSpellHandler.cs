...
namespace DOL.GS.Spells
{
    ...
    public class DirectDamageSpellHandler : SpellHandler
    {
        ...
        {
            // Null - Überprüfung für den Caster
            if (m_caster == null)
            {
                m_castFailed = true;
                return;
        ...
        {
            // Null-Überprüfung für das Ziel
            if (m_spellTarget == null) return 0;
        ...
        protected virtual void DealDamageCheckLOS(GameLiving player, ushort response, ushort targetOID)
        {
            ...
            // Null-Überprüfung für Spieler und Caster
        ...
        protected override void OnSpellResisted(GameLiving target)
        {
            if (target is GamePlayer)
            {
                ...
                // Null-Überprüfung vor dem Senden
                if (player != null)
                {
            ...
            {
                // Überprüfung ob target null ist
                if (target != null)
                {

...
namespace DOL.GS.Spells
{
    ...
    /// </summary>
    [SpellHandlerAttribute("WLBolt")]
    public class WLBoltSpellHandler : SpellHandler
    {
        ...
        protected class BoltOnTargetAction : RegionAction
        {
            ...
            /// The spell handler
            /// </summary>
            protected readonly WLBoltSpellHandler m_handler;
            ...
            public BoltOnTargetAction(GameLiving actionSource, GameLiving boltTarget, WLBoltSpellHandler spellHandler) : base(actionSource)
            {
                if (boltTarget == null)
            ...
            protected override void OnTick()
            {
                ...
                ad.Damage = (int)(ad.Damage * caster.Effectiveness * (ServerProperties.Properties.SPELL_WLBOLT_DAMAGE * 0.01));
        ...
        // constructor
        public WLBoltSpellHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line) { }
    }
}
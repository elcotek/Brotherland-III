	...
	public class VampiirSkillBonusDeBuff : SpellHandler
	{
        ...
        public override void OnEffectStart(GameSpellEffect effect)
        {
            ...
            if (effect.Owner is GamePlayer)
            {
                ...
                {
                    if (player.GetModifiedSpecLevel(SkillBase.GetPropertyName((eProperty)(i), player.Client.Account.Language)) != 0)
                    {
                        player.BaseBuffBonusCategory[i] = -player.GetModifiedSpecLevel(SkillBase.GetPropertyName((eProperty)(i), player.Client.Account.Language));
                    }

...
namespace DOL.GS.PlayerTitles
{
	...
	/// Example...
	/// </summary>
	public class OberliskTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Obelisk.GetTitle.Info");
		}
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Obelisk.GetTitle", player.Level);
		}
		...
		{
			get { return GamePlayerEvent.AllOberlisksCaptured; }
		}
		...
		{
           // player.LabyrinthObelisk.Length => 792;

            return player.HasAllOberlisks == true;
		}

...
namespace DOL.GS.Scripts
{
	...
	#endregion Hibernia
	#region Midgard
	public class MidgardRR4M : SimplePlayerTitle
	{
		public override string GetDescription(GamePlayer player) { return "Realm Rank"; }
		public override string GetValue(GamePlayer player) { return "Elding Vakten"; }
        public override bool IsSuitable(GamePlayer player) { return (player.Realm == eRealm.Midgard && player.RealmLevel >= 30 && player.RealmLevel < 40 && player.DBCharacter.Gender == 0); }
	}
    public class MidgardRR4F : SimplePlayerTitle
    {
        public override string GetDescription(GamePlayer player) { return "Realm Rank"; }
        public override string GetValue(GamePlayer player) { return "Elding Fru"; }
        public override bool IsSuitable(GamePlayer player) { return (player.Realm == eRealm.Midgard && player.RealmLevel >= 30 && player.RealmLevel < 40 && player.DBCharacter.Gender == 1); }
    }
    public class MidgardRR5M : SimplePlayerTitle
	{
		public override string GetDescription(GamePlayer player) { return "Realm Rank"; }
		public override string GetValue(GamePlayer player) { return "Stormur Vakten"; }
        public override bool IsSuitable(GamePlayer player) { return (player.Realm == eRealm.Midgard && player.RealmLevel >= 40 && player.RealmLevel < 50 && player.DBCharacter.Gender == 0); }
	}
    public class MidgardRR5F : SimplePlayerTitle
    {
        public override string GetDescription(GamePlayer player) { return "Realm Rank"; }
        public override string GetValue(GamePlayer player) { return "Stormur Fru"; }
        public override bool IsSuitable(GamePlayer player) { return (player.Realm == eRealm.Midgard && player.RealmLevel >= 40 && player.RealmLevel < 50 && player.DBCharacter.Gender == 1); }
    }
    public class MidgardRR6M : SimplePlayerTitle
	{
		public override string GetDescription(GamePlayer player) { return "Realm Rank"; }
		public override string GetValue(GamePlayer player) { return "Isen Herra"; }
        public override bool IsSuitable(GamePlayer player) { return (player.Realm == eRealm.Midgard && player.RealmLevel >= 50 && player.RealmLevel < 60 && player.DBCharacter.Gender == 0); }
	}
    public class MidgardRR6F : SimplePlayerTitle
    {
        public override string GetDescription(GamePlayer player) { return "Realm Rank"; }
        public override string GetValue(GamePlayer player) { return "Isen Fru"; }
        public override bool IsSuitable(GamePlayer player) { return (player.Realm == eRealm.Midgard && player.RealmLevel >= 50 && player.RealmLevel < 60 && player.DBCharacter.Gender == 1); }
    }
    
    public class MidgardRR7M : SimplePlayerTitle
	{
		public override string GetDescription(GamePlayer player) { return "Realm Rank"; }
		public override string GetValue(GamePlayer player) { return "Flammen Herra"; }
		public override bool IsSuitable(GamePlayer player) { return (player.Realm==eRealm.Midgard&&player.RealmLevel>=60&&player.RealmLevel<70 && player.DBCharacter.Gender == 0); }
	}
    public class MidgardRR7F : SimplePlayerTitle
    {
        public override string GetDescription(GamePlayer player) { return "Realm Rank"; }
        public override string GetValue(GamePlayer player) { return "Flammen Fru"; }
        public override bool IsSuitable(GamePlayer player) { return (player.Realm == eRealm.Midgard && player.RealmLevel >= 60 && player.RealmLevel < 70 && player.DBCharacter.Gender == 1); }
    }
    
    public class MidgardRR8M : SimplePlayerTitle
	{
		public override string GetDescription(GamePlayer player) { return "Realm Rank"; }
		public override string GetValue(GamePlayer player) { return "Elding Herra"; }
		public override bool IsSuitable(GamePlayer player) { return (player.Realm==eRealm.Midgard&&player.RealmLevel>=70&&player.RealmLevel<80 && player.DBCharacter.Gender == 0); }
	}
    public class MidgardRR8F : SimplePlayerTitle
    {
        public override string GetDescription(GamePlayer player) { return "Realm Rank"; }
        public override string GetValue(GamePlayer player) { return "Elding Fru"; }
        public override bool IsSuitable(GamePlayer player) { return (player.Realm == eRealm.Midgard && player.RealmLevel >= 70 && player.RealmLevel < 80 && player.DBCharacter.Gender == 1); }
    }
    
    public class MidgardRR9M : SimplePlayerTitle
	{
		public override string GetDescription(GamePlayer player) { return "Realm Rank"; }
		public override string GetValue(GamePlayer player) { return "Stormur Herra"; }
        public override bool IsSuitable(GamePlayer player) { return (player.Realm == eRealm.Midgard && player.RealmLevel >= 80 && player.RealmLevel < 90 && player.DBCharacter.Gender == 0); }
	}
    public class MidgardRR9F : SimplePlayerTitle
    {
        public override string GetDescription(GamePlayer player) { return "Realm Rank"; }
        public override string GetValue(GamePlayer player) { return "Stormur Fru"; }
        public override bool IsSuitable(GamePlayer player) { return (player.Realm == eRealm.Midgard && player.RealmLevel >= 80 && player.RealmLevel < 90 && player.DBCharacter.Gender == 1); }
    }

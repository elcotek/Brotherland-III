...
namespace DOL.AI.Brain
{
    ...
    /// </summary>
    public class BossMeleeBrain : BossPetBrain
    {
        /// <summary>
        ...
        public BossMeleeBrain(GameLiving owner) : base(owner) { }
                ...
                foreach (Ability ab in Body.Abilities.Values)
                {
                    switch (ab.KeyName)
                    {
                        case Abilities.ChargeAbility:
                            if (!Body.IsWithinRadius(Body.TargetObject, 500) && Body.InCombat == false)
                            {

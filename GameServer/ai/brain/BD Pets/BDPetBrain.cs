...
namespace DOL.AI.Brain
{
    public abstract class BDPetBrain : ControlledNpcBrain
    {
        ...
        public BDPetBrain(GameLiving Owner)
            : base(Owner)
        {
            IsMainPet = false;
        }
        ...
        public override void Think()
        {
            ...
            if (playerowner != null && Body != null && playerowner.ObjectState == GameObject.eObjectState.Active && Body.IsAlive && Body.ObjectState == GameObject.eObjectState.Active)
            {
                update(playerowner);
            }

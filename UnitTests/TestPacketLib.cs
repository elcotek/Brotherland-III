...
namespace DOL.Tests
{
   ...
   public class TestPacketLib : IPacketLib
   {
       ...
       public Action<TestPacketLib, AbstractGameKeep> SendKeepInfoMethod { get; set; }
       public void SendKeepInfo(AbstractGameKeep keep)
       {
           if (SendKeepInfoMethod != null) SendKeepInfoMethod(this, keep);
       }
       public Action<TestPacketLib, AbstractGameKeep> SendKeepRealmUpdateMethod { get; set; }
       ...
       public Action<TestPacketLib, AbstractGameKeep> SendKeepRemoveMethod { get; set; }
       public void SendKeepRemove(AbstractGameKeep keep)
       {
           if (SendKeepRemoveMethod != null) SendKeepRemoveMethod(this, keep);
       }
       public Action<TestPacketLib, GameKeepComponent> SendKeepComponentInfoMethod { get; set; }
       ...
       public Action<TestPacketLib, GameKeepComponent> SendKeepComponentDetailUpdateMethod { get; set; }
       ...
       public Action<TestPacketLib, GameKeepComponent> SendKeepComponentRemoveMethod { get; set; }
       public void SendKeepComponentRemove(GameKeepComponent keepComponent)
       {
           if (SendKeepComponentRemoveMethod != null) SendKeepComponentRemoveMethod(this, keepComponent);
       }
       public Action<TestPacketLib, AbstractGameKeep, byte> SendKeepClaimMethod { get; set; }
       public void SendKeepClaim(AbstractGameKeep keep, byte flag)
       {
           if (SendKeepClaimMethod != null) SendKeepClaimMethod(this, keep, flag);
       }
       public Action<TestPacketLib, AbstractGameKeep, bool> SendKeepComponentUpdateMethod { get; set; }
       ...
       public Action<TestPacketLib, GameKeepComponent> SendKeepComponentInteractMethod { get; set; }
       ...
       public Action<TestPacketLib, GameKeepComponent, int> SendKeepComponentHookPointMethod { get; set; }
       ...
       public Action<TestPacketLib, GameKeepComponent, int> SendClearKeepComponentHookPointMethod { get; set; }
       ...
       public Action<TestPacketLib, ICollection<AbstractGameKeep>> SendWarmapUpdateMethod { get; set; }

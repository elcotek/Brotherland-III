...
namespace DOL.Database
{
	...
	public class Mob : DataObject
	{
        ...
        private string m_mobstyleid;
        private bool m_isstyleallowed;
        private bool m_npcIsFish;
        private int m_yellRange;
        private int m_meleeAttackRange;
        private bool m_npcIsSeeingAll;
		private int m_ControlledCount;
		...
		public Mob()
		{
			...
			m_gender = 0;
            m_mobstyleid = null;
            m_isstyleallowed = false;
            m_yellRange = 1000;
            m_meleeAttackRange = 0;
            m_npcIsFish = false;
            m_npcIsSeeingAll = false;
			m_ControlledCount = 0;
		...
		/// </summary>
		[DataElement(AllowDbNull = true)]
		public bool IsStyleAllowed
		{
			get { return m_isstyleallowed; }
			set
			{
				m_isstyleallowed = value;
				Dirty = true;
			}
		
		}
        /// <summary>
        /// if this NPC is an fish ?
        /// </summary>
        [DataElement(AllowDbNull = true)]
        ...
        /// <summary>
        /// Is the NPC can see all 360 Radius
        /// </summary>
        [DataElement(AllowDbNull = true)]

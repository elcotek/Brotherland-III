...
namespace DOL
{
    namespace Database
    {
        ...
        public class DOLCharacters : DataObject
        {
            ...
            private DateTime m_dailyRewardTime;
            ...
            private int m_pointsset;        //Start Stats set by Player (0 = noset)
            private int m_race;
            ...
            private string m_abilities = string.Empty;  // comma separated string of ability keynames and levels eg "sprint,0,evade,1"
            private string m_specs = string.Empty;          // comma separated string of spec keynames and levels like "earth_magic,5,slash,10"
            private string m_spellLines = string.Empty;     // serialized string of spell lines and levels like "Spirit Animation|5;Vivification|7"
            private string m_realmAbilities = string.Empty; // for later use
            ...
            private bool m_hasFreeStartArmor;
            private bool m_hasFreeStartArmor40;
            private bool m_hasFreeStartWeapons;
            private bool m_hasFreeStartWeapons40;
            private bool m_hasStartWeapon30;
            private bool m_hasStartWeapon40;
            private bool m_hasStartWeapon45;
            private bool m_hasML10;
            private bool m_hasAllOberlisk;
            private bool m_hasChampionWeapons;
            private bool m_showGuildLogins;
            private bool m_dailyreward;
            private int m_xpstonecount = 0;
            private int m_barrelForPowerElixirCount = 0;
            private int m_barrelForHealingElixirCount = 0;
            ...
            public DOLCharacters()
            {
                ...
                m_dailyRewardTime = DateTime.Now;
                m_concentration = 100;
                m_exp = 0;
                m_bntyPts = 0;
                m_realmPts = 0;
                ...
                m_noHelp = false;
                m_hasFreeStartArmor = false;
                m_hasFreeStartWeapons = false;
                m_hasML10 = false;
                m_hasAllOberlisk = false;
                m_hasChampionWeapons = false;
            ...
            /// <summary>
            ///  The last time this character have recived a daily Reward
            /// </summary>
            [DataElement(AllowDbNull = true)]
            public DateTime LastDailyRewardTime
            {
                get
                {
                    return m_dailyRewardTime;
                }
                set
                {
                    Dirty = true;
                    if (m_dailyRewardTime == null)
                    {
                        m_dailyRewardTime = DateTime.Now;
                    }
                    m_dailyRewardTime = value;
                }
            }
            ...
            /// <summary>
            /// Gets/sets stat points set after charcter creation ? (1 = true)
            /// </summary>
            [DataElement(AllowDbNull = false)]
            ...
            public int BindHouseNumber
            {
                get
                {
                    return m_bindhouseNumber;
                }
                set
                {
                    Dirty = true;
                    m_bindhouseNumber = value;
                }
            }
            ...
            {
                get { return m_xpstonecount; }
                set
                {
                    Dirty = true;
                    m_xpstonecount = value;
                }
            }


            /// <summary>
            /// Barrel For Power Elixir Count
            /// </summary>
            [DataElement(AllowDbNull = true)]
            public int BarrelForPowerElixirCount
            {
                get { return m_barrelForPowerElixirCount; }
                set
                {
                    Dirty = true;
                    m_barrelForPowerElixirCount = value;
                }
            }

            /// <summary>
            ///  Barrel For Healing Elixir Count
            /// </summary>
            [DataElement(AllowDbNull = true)]
            public int BarrelForHealingElixirCount
            {
                get { return m_barrelForHealingElixirCount; }
                set
                {
                    Dirty = true;
                    m_barrelForHealingElixirCount = value;
                }
            }
            ...
            {
                get { return m_hasFreeStartArmor; }
                set { Dirty = true; m_hasFreeStartArmor = value; }
            }

            [DataElement(AllowDbNull = true)]
            public bool HasFreeStartArmor40
            {
                get { return m_hasFreeStartArmor40; }
                set { Dirty = true; m_hasFreeStartArmor40 = value; }
            }

            [DataElement(AllowDbNull = true)]
            public bool HasFreeStartWeapons
            {
                get { return m_hasFreeStartWeapons; }
                set { Dirty = true; m_hasFreeStartWeapons = value; }
            }

            [DataElement(AllowDbNull = true)]
            public bool HasFreeStartWeapons40
            {
                get { return m_hasFreeStartWeapons40; }
                set { Dirty = true; m_hasFreeStartWeapons40 = value; }
            }

            [DataElement(AllowDbNull = true)]
            public bool HasStartWeapon30
            {
                get { return m_hasStartWeapon30; }
                set { Dirty = true; m_hasStartWeapon30 = value; }
            }

            [DataElement(AllowDbNull = true)]
            public bool HasStartWeapon40
            {
                get { return m_hasStartWeapon40; }
                set { Dirty = true; m_hasStartWeapon40 = value; }
            }

            [DataElement(AllowDbNull = true)]
            public bool HasStartWeapon45
            {
                get { return m_hasStartWeapon45; }
                set { Dirty = true; m_hasStartWeapon45 = value; }
            }

            [DataElement(AllowDbNull = true)]
            public bool HasML10
            {
                get { return m_hasML10; }
                set { Dirty = true; m_hasML10 = value; }
            }

            [DataElement(AllowDbNull = true)]
            public bool HasAllOberlisks
            {
                get { return m_hasAllOberlisk; }
                set { Dirty = true; m_hasAllOberlisk = value; }
            }

            [DataElement(AllowDbNull = true)]
            public bool HasChampionWeapons
            {
                get { return m_hasChampionWeapons; }
                set { Dirty = true; m_hasChampionWeapons = value; }
            }
            ...
            /// </summary>
            [DataElement(AllowDbNull = true)]
            public string LabyrinthObelisk
            {
                get
                {
                    return m_LabObelisk;

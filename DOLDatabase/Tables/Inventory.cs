...
namespace DOL.Database
{
    ...
    public class InventoryItem : DataObject
    {
        ...
        protected int m_repearcount;
        [DataElement(AllowDbNull = false)]
        public virtual int RepearCount
        {
            get { return m_repearcount; }
            set { Dirty = true; m_repearcount = value; }
        }
        ...
        public virtual ItemTemplate Template
        {
            get
            {
                if (m_item == null)
                {
                    ...
                    {
                        log.ErrorFormat("Template null for player {0} Inventory.  Can't find template {1}{2} for item in slot {3}!", OwnerID, (ITemplate_Id ?? ""), (UTemplate_Id ?? ""), m_slot_pos);
        ...
        protected InventoryItem(ItemTemplate template)
            : base()
        {
            m_ownerID = null;
            Template = template;
            ...
            m_repearcount = template.RepearCount;
        ...
        /// </summary>
        /// <param name="itemTemplate"></param>
        protected InventoryItem(ItemUnique template)
            : base()
        {
            m_ownerID = null;
        ...
        /// <returns></returns>
        public long GetPreis(ItemTemplate item)
        {
            long preis = 0;
            if (item.Level > 0 && item.Price < item.Level * 100)
            {
                preis = item.Level * 1000;
                return preis;
            }
        ...
        public virtual long RepairCost
        {
            ...
            get
            {
                return ((Template.MaxCondition - Condition) * GetPreis(Template)) / Template.MaxCondition;
            }
        }
        ...
        public virtual bool CraftPriceSet
        {
            get { return Template.CraftPriceSet; }
            set { Template.CraftPriceSet = value; }
        }
        // properties

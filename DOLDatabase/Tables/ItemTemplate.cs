...
namespace DOL.Database
{
		...
		
	{
        ...
        protected long m_CraftPrice;//set by system
									// properties
		protected bool m_craftPriceSet;
		...
		public ItemTemplate(ItemTemplate template)
		{
            ...
            RepearCount = template.RepearCount;
		...
		[DataElement(AllowDbNull = true)]
		public bool CraftPriceSet
		{
			get { return m_craftPriceSet; }
			set
			{
				Dirty = true;
				m_craftPriceSet = value;
			}
		}
